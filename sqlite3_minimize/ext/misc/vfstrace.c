...
int vfstraceOpen(
  ...
  if( p->pReal->pMethods ){
    ...
    memcpy(pNew->xRead_signature, xRead_signatures[xRead_vfstraceRead_enum],
           sizeof(pNew->xRead_signature));
    memcpy(pNew->xWrite_signature,
           xWrite_signatures[xWrite_vfstraceWrite_enum],
           sizeof(pNew->xWrite_signature));
    memcpy(pNew->xTruncate_signature,
           xTruncate_signatures[xTruncate_vfstraceTruncate_enum],
           sizeof(pNew->xTruncate_signature));
    memcpy(pNew->xSync_signature, xSync_signatures[xSync_vfstraceSync_enum],
           sizeof(pNew->xSync_signature));
    memcpy(pNew->xFileSize_signature,
           xFileSize_signatures[xFileSize_vfstraceFileSize_enum],
           sizeof(pNew->xFileSize_signature));
    pNew->xLock = vfstraceLock;
    memcpy(pNew->xUnlock_signature,
           xUnlock_signatures[xUnlock_vfstraceUnlock_enum],
           sizeof(pNew->xUnlock_signature));
    memcpy(pNew->xCheckReservedLock_signature,
           xCheckReservedLock_signatures[xCheckReservedLock_vfstraceCheckReservedLock_enum],
           sizeof(pNew->xCheckReservedLock_signature));
    memcpy(pNew->xFileControl_signature,
           xFileControl_signatures[xFileControl_vfstraceFileControl_enum],
           sizeof(pNew->xFileControl_signature));
    memcpy(pNew->xSectorSize_signature,
           xSectorSize_signatures[xSectorSize_vfstraceSectorSize_enum],
           sizeof(pNew->xSectorSize_signature));
    memcpy(pNew->xDeviceCharacteristics_signature,
           xDeviceCharacteristics_signatures[xDeviceCharacteristics_vfstraceDeviceCharacteristics_enum],
           sizeof(pNew->xDeviceCharacteristics_signature));
    if( pNew->iVersion>=2 ){
...
int vfstrace_register(
  ...
  memcpy(pNew->xRandomness_signature,
         xRandomness_signatures[xRandomness_vfstraceRandomness_enum],
         sizeof(pNew->xRandomness_signature));
  memcpy(pNew->xSleep_signature, xSleep_signatures[xSleep_vfstraceSleep_enum],
         sizeof(pNew->xSleep_signature));
  memcpy(pNew->xCurrentTime_signature,
         xCurrentTime_signatures[xCurrentTime_vfstraceCurrentTime_enum],
         sizeof(pNew->xCurrentTime_signature));

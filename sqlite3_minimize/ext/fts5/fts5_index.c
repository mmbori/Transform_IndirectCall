...
static void fts5SegIterNextFrom(
  ...
  do{
    if( bMove && p->rc==SQLITE_OK ) {
      if (memcmp(pIter->xNext_signature, xNext_signatures[xNext_fts5ExprNodeNext_AND_enum], sizeof(pIter->xNext_signature)) == 0) {
        fts5ExprNodeNext_AND(p, pIter, 0);
      }
      if (memcmp(pIter->xNext_signature, xNext_signatures[xNext_fts5ExprNodeNext_NOT_enum], sizeof(pIter->xNext_signature)) == 0) {
        fts5ExprNodeNext_NOT(p, pIter, 0);
      }
      if (memcmp(pIter->xNext_signature, xNext_signatures[xNext_fts5ExprNodeNext_OR_enum], sizeof(pIter->xNext_signature)) == 0) {
        fts5ExprNodeNext_OR(p, pIter, 0);
      }
      if (memcmp(pIter->xNext_signature, xNext_signatures[xNext_fts5ExprNodeNext_STRING_enum], sizeof(pIter->xNext_signature)) == 0) {
        fts5ExprNodeNext_STRING(p, pIter, 0);
      }
      if (memcmp(pIter->xNext_signature, xNext_signatures[xNext_fts5ExprNodeNext_TERM_enum], sizeof(pIter->xNext_signature)) == 0) {
        fts5ExprNodeNext_TERM(p, pIter, 0);
      }
      if (memcmp(pIter->xNext_signature, xNext_signatures[xNext_fts5SegIterNext_enum], sizeof(pIter->xNext_signature)) == 0) {
        fts5SegIterNext(p, pIter, 0);
      }
      if (memcmp(pIter->xNext_signature, xNext_signatures[xNext_fts5SegIterNext_None_enum], sizeof(pIter->xNext_signature)) == 0) {
        fts5SegIterNext_None(p, pIter, 0);
      }
      if (memcmp(pIter->xNext_signature, xNext_signatures[xNext_fts5SegIterNext_Reverse_enum], sizeof(pIter->xNext_signature)) == 0) {
        fts5SegIterNext_Reverse(p, pIter, 0);
      }
    }
    if( pIter->pLeaf==0 ) break;
...
static void fts5MultiIterAdvanced(
  ...
  for(i=(pIter->nSeg+iChanged)/2; i>=iMinset && p->rc==SQLITE_OK; i=i/2){
    ...
    if( (iEq = fts5MultiIterDoCompare(pIter, i)) ){
      ...
      assert( p->rc==SQLITE_OK );
      if (memcmp(pSeg->xNext_signature, xNext_signatures[xNext_fts5ExprNodeNext_AND_enum], sizeof(pSeg->xNext_signature)) == 0) {
        fts5ExprNodeNext_AND(p, pSeg, 0);
      }
      if (memcmp(pSeg->xNext_signature, xNext_signatures[xNext_fts5ExprNodeNext_NOT_enum], sizeof(pSeg->xNext_signature)) == 0) {
        fts5ExprNodeNext_NOT(p, pSeg, 0);
      }
      if (memcmp(pSeg->xNext_signature, xNext_signatures[xNext_fts5ExprNodeNext_OR_enum], sizeof(pSeg->xNext_signature)) == 0) {
        fts5ExprNodeNext_OR(p, pSeg, 0);
      }
      if (memcmp(pSeg->xNext_signature, xNext_signatures[xNext_fts5ExprNodeNext_STRING_enum], sizeof(pSeg->xNext_signature)) == 0) {
        fts5ExprNodeNext_STRING(p, pSeg, 0);
      }
      if (memcmp(pSeg->xNext_signature, xNext_signatures[xNext_fts5ExprNodeNext_TERM_enum], sizeof(pSeg->xNext_signature)) == 0) {
        fts5ExprNodeNext_TERM(p, pSeg, 0);
      }
      if (memcmp(pSeg->xNext_signature, xNext_signatures[xNext_fts5SegIterNext_enum], sizeof(pSeg->xNext_signature)) == 0) {
        fts5SegIterNext(p, pSeg, 0);
      }
      if (memcmp(pSeg->xNext_signature, xNext_signatures[xNext_fts5SegIterNext_None_enum], sizeof(pSeg->xNext_signature)) == 0) {
        fts5SegIterNext_None(p, pSeg, 0);
      }
      if (memcmp(pSeg->xNext_signature, xNext_signatures[xNext_fts5SegIterNext_Reverse_enum], sizeof(pSeg->xNext_signature)) == 0) {
        fts5SegIterNext_Reverse(p, pSeg, 0);
      }
      i = pIter->nSeg + iEq;
    }
  }
...
static void fts5MultiIterNext(
  ...
  while( p->rc==SQLITE_OK ){
    ...
    if( bUseFrom && pSeg->pDlidx ){
      ...
      if (memcmp(pSeg->xNext_signature, xNext_signatures[xNext_fts5ExprNodeNext_AND_enum], sizeof(pSeg->xNext_signature)) == 0) {
        fts5ExprNodeNext_AND(p, pSeg, &bNewTerm);
      }
      if (memcmp(pSeg->xNext_signature, xNext_signatures[xNext_fts5ExprNodeNext_NOT_enum], sizeof(pSeg->xNext_signature)) == 0) {
        fts5ExprNodeNext_NOT(p, pSeg, &bNewTerm);
      }
      if (memcmp(pSeg->xNext_signature, xNext_signatures[xNext_fts5ExprNodeNext_OR_enum], sizeof(pSeg->xNext_signature)) == 0) {
        fts5ExprNodeNext_OR(p, pSeg, &bNewTerm);
      }
      if (memcmp(pSeg->xNext_signature, xNext_signatures[xNext_fts5ExprNodeNext_STRING_enum], sizeof(pSeg->xNext_signature)) == 0) {
        fts5ExprNodeNext_STRING(p, pSeg, &bNewTerm);
      }
      if (memcmp(pSeg->xNext_signature, xNext_signatures[xNext_fts5ExprNodeNext_TERM_enum], sizeof(pSeg->xNext_signature)) == 0) {
        fts5ExprNodeNext_TERM(p, pSeg, &bNewTerm);
      }
      if (memcmp(pSeg->xNext_signature, xNext_signatures[xNext_fts5SegIterNext_enum], sizeof(pSeg->xNext_signature)) == 0) {
        fts5SegIterNext(p, pSeg, &bNewTerm);
      }
      if (memcmp(pSeg->xNext_signature, xNext_signatures[xNext_fts5SegIterNext_None_enum], sizeof(pSeg->xNext_signature)) == 0) {
        fts5SegIterNext_None(p, pSeg, &bNewTerm);
      }
      if (memcmp(pSeg->xNext_signature, xNext_signatures[xNext_fts5SegIterNext_Reverse_enum], sizeof(pSeg->xNext_signature)) == 0) {
        fts5SegIterNext_Reverse(p, pSeg, &bNewTerm);
      }
    }
    ...
    if( (pIter->bSkipEmpty==0 || pSeg->nPos) 
      ...
      if (memcmp(pIter->xSetOutputs_signature, xSetOutputs_signatures[xSetOutputs_fts5IterSetOutputs_Col_enum], sizeof(pIter->xSetOutputs_signature)) == 0) {
        fts5IterSetOutputs_Col(pIter, pSeg);
      }
      if (memcmp(pIter->xSetOutputs_signature, xSetOutputs_signatures[xSetOutputs_fts5IterSetOutputs_Col100_enum], sizeof(pIter->xSetOutputs_signature)) == 0) {
        fts5IterSetOutputs_Col100(pIter, pSeg);
      }
      if (memcmp(pIter->xSetOutputs_signature, xSetOutputs_signatures[xSetOutputs_fts5IterSetOutputs_Full_enum], sizeof(pIter->xSetOutputs_signature)) == 0) {
        fts5IterSetOutputs_Full(pIter, pSeg);
      }
      if (memcmp(pIter->xSetOutputs_signature, xSetOutputs_signatures[xSetOutputs_fts5IterSetOutputs_Nocolset_enum], sizeof(pIter->xSetOutputs_signature)) == 0) {
        fts5IterSetOutputs_Nocolset(pIter, pSeg);
      }
      if (memcmp(pIter->xSetOutputs_signature, xSetOutputs_signatures[xSetOutputs_fts5IterSetOutputs_None_enum], sizeof(pIter->xSetOutputs_signature)) == 0) {
        fts5IterSetOutputs_None(pIter, pSeg);
      }
      if (memcmp(pIter->xSetOutputs_signature, xSetOutputs_signatures[xSetOutputs_fts5IterSetOutputs_Noop_enum], sizeof(pIter->xSetOutputs_signature)) == 0) {
        fts5IterSetOutputs_Noop(pIter, pSeg);
      }
      if (memcmp(pIter->xSetOutputs_signature, xSetOutputs_signatures[xSetOutputs_fts5IterSetOutputs_ZeroColset_enum], sizeof(pIter->xSetOutputs_signature)) == 0) {
        fts5IterSetOutputs_ZeroColset(pIter, pSeg);
      }
      return;
    }
    bUseFrom = 0;
...
static int fts5VisitEntries(
  ...
  for( /* no-op */ ;
    ...
    if (memcmp(p1->xSetOutputs_signature, xSetOutputs_signatures[xSetOutputs_fts5IterSetOutputs_Col_enum], sizeof(p1->xSetOutputs_signature)) == 0) {
      fts5IterSetOutputs_Col(p1, pSeg);
    }
    if (memcmp(p1->xSetOutputs_signature, xSetOutputs_signatures[xSetOutputs_fts5IterSetOutputs_Col100_enum], sizeof(p1->xSetOutputs_signature)) == 0) {
      fts5IterSetOutputs_Col100(p1, pSeg);
    }
    if (memcmp(p1->xSetOutputs_signature, xSetOutputs_signatures[xSetOutputs_fts5IterSetOutputs_Full_enum], sizeof(p1->xSetOutputs_signature)) == 0) {
      fts5IterSetOutputs_Full(p1, pSeg);
    }
    if (memcmp(p1->xSetOutputs_signature, xSetOutputs_signatures[xSetOutputs_fts5IterSetOutputs_Nocolset_enum], sizeof(p1->xSetOutputs_signature)) == 0) {
      fts5IterSetOutputs_Nocolset(p1, pSeg);
    }
    if (memcmp(p1->xSetOutputs_signature, xSetOutputs_signatures[xSetOutputs_fts5IterSetOutputs_None_enum], sizeof(p1->xSetOutputs_signature)) == 0) {
      fts5IterSetOutputs_None(p1, pSeg);
    }
    if (memcmp(p1->xSetOutputs_signature, xSetOutputs_signatures[xSetOutputs_fts5IterSetOutputs_Noop_enum], sizeof(p1->xSetOutputs_signature)) == 0) {
      fts5IterSetOutputs_Noop(p1, pSeg);
    }
    if (memcmp(p1->xSetOutputs_signature, xSetOutputs_signatures[xSetOutputs_fts5IterSetOutputs_ZeroColset_enum], sizeof(p1->xSetOutputs_signature)) == 0) {
      fts5IterSetOutputs_ZeroColset(p1, pSeg);
    }
    if( p->rc ) break;
  ...
  if( p1->base.nData>0 ){
    if( p1->base.iRowid<=pSetup->iLastRowid && pSetup->doclist.n>0 ){
      ...
      for(i=0; p->rc==SQLITE_OK && pSetup->doclist.n; i++){
        ...
        if( iStore==i1+nMerge ){
          if (memcmp(pSetup->xMerge_signature, xMerge_signatures[xMerge_fts5MergePrefixLists_enum], sizeof(pSetup->xMerge_signature)) == 0) {
            fts5MergePrefixLists(p, &pSetup->doclist, nMerge,
                                 &pSetup->aBuf[i1]);
          }
          if (memcmp(pSetup->xMerge_signature, xMerge_signatures[xMerge_fts5MergeRowidLists_enum], sizeof(pSetup->xMerge_signature)) == 0) {
            fts5MergeRowidLists(p, &pSetup->doclist, nMerge,
                                &pSetup->aBuf[i1]);
          }
          for(iStore=i1; iStore<i1+nMerge; iStore++){
    ...
    if (memcmp(pSetup->xAppend_signature, xAppend_signatures[xAppend_fts5AppendPoslist_enum], sizeof(pSetup->xAppend_signature)) == 0) {
      fts5AppendPoslist(p, (u64)p1->base.iRowid - (u64)pSetup->iLastRowid, p1,
                        &pSetup->doclist);
    }
    if (memcmp(pSetup->xAppend_signature, xAppend_signatures[xAppend_fts5AppendRowid_enum], sizeof(pSetup->xAppend_signature)) == 0) {
      fts5AppendRowid(p, (u64)p1->base.iRowid - (u64)pSetup->iLastRowid, p1,
                      &pSetup->doclist);
    }
  ...
  if( p->rc==SQLITE_OK ){
    ...
    ** main term index here.  */
    ...
    for(i=0; i<s.nBuf; i+=s.nMerge){
      int iFree;
      if( p->rc==SQLITE_OK ){
        if (memcmp(s.xMerge_signature, xMerge_signatures[xMerge_fts5MergePrefixLists_enum], sizeof(s.xMerge_signature)) == 0) {
          fts5MergePrefixLists(p, &s.doclist, s.nMerge, &s.aBuf[i]);
        }
        if (memcmp(s.xMerge_signature, xMerge_signatures[xMerge_fts5MergeRowidLists_enum], sizeof(s.xMerge_signature)) == 0) {
          fts5MergeRowidLists(p, &s.doclist, s.nMerge, &s.aBuf[i]);
        }
      }
    ...
    if( bTokendata && iIdx==0 ){
      ...
      if( pRet==0 ){
        ...
        if( p->rc==SQLITE_OK ){
          ...
          if( pSeg->pLeaf ) {
            if (memcmp(pRet->xSetOutputs_signature, xSetOutputs_signatures[xSetOutputs_fts5IterSetOutputs_Col_enum], sizeof(pRet->xSetOutputs_signature)) == 0) {
              fts5IterSetOutputs_Col(pRet, pSeg);
            }
            if (memcmp(pRet->xSetOutputs_signature, xSetOutputs_signatures[xSetOutputs_fts5IterSetOutputs_Col100_enum], sizeof(pRet->xSetOutputs_signature)) == 0) {
              fts5IterSetOutputs_Col100(pRet, pSeg);
            }
            if (memcmp(pRet->xSetOutputs_signature, xSetOutputs_signatures[xSetOutputs_fts5IterSetOutputs_Full_enum], sizeof(pRet->xSetOutputs_signature)) == 0) {
              fts5IterSetOutputs_Full(pRet, pSeg);
            }
            if (memcmp(pRet->xSetOutputs_signature, xSetOutputs_signatures[xSetOutputs_fts5IterSetOutputs_Nocolset_enum], sizeof(pRet->xSetOutputs_signature)) == 0) {
              fts5IterSetOutputs_Nocolset(pRet, pSeg);
            }
            if (memcmp(pRet->xSetOutputs_signature, xSetOutputs_signatures[xSetOutputs_fts5IterSetOutputs_None_enum], sizeof(pRet->xSetOutputs_signature)) == 0) {
              fts5IterSetOutputs_None(pRet, pSeg);
            }
            if (memcmp(pRet->xSetOutputs_signature, xSetOutputs_signatures[xSetOutputs_fts5IterSetOutputs_Noop_enum], sizeof(pRet->xSetOutputs_signature)) == 0) {
              fts5IterSetOutputs_Noop(pRet, pSeg);
            }
            if (memcmp(pRet->xSetOutputs_signature, xSetOutputs_signatures[xSetOutputs_fts5IterSetOutputs_ZeroColset_enum], sizeof(pRet->xSetOutputs_signature)) == 0) {
              fts5IterSetOutputs_ZeroColset(pRet, pSeg);
            }
          }
        }
      }

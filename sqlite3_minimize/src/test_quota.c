...
static int quotaOpen(
  ...
  */
  if( (flags & (SQLITE_OPEN_MAIN_DB|SQLITE_OPEN_WAL))==0 ){
    if (memcmp(pOrigVfs->xOpen_signature, xOpen_signatures[xOpen_quotaOpen_enum], sizeof(pOrigVfs->xOpen_signature)) == 0) {
      return quotaOpen(pOrigVfs, zName, pConn, flags, pOutFlags);
    }
  ...
  */
  ...
  if( pGroup==0 ){
    if (memcmp(pOrigVfs->xOpen_signature, xOpen_signatures[xOpen_quotaOpen_enum], sizeof(pOrigVfs->xOpen_signature)) == 0) {
      rc = quotaOpen(pOrigVfs, zName, pConn, flags, pOutFlags);
    }
    // if (memcmp(pOrigVfs->xOpen_signature, xOpen_signatures[xOpen_vfstraceOpen_enum], sizeof(pOrigVfs->xOpen_signature)) == 0) {
    ...
    */
    ...
    if (memcmp(pOrigVfs->xOpen_signature, xOpen_signatures[xOpen_quotaOpen_enum], sizeof(pOrigVfs->xOpen_signature)) == 0) {
      rc = quotaOpen(pOrigVfs, zName, pSubOpen, flags, pOutFlags);
    }
    // if (memcmp(pOrigVfs->xOpen_signature, xOpen_signatures[xOpen_vfstraceOpen_enum], sizeof(pOrigVfs->xOpen_signature)) == 0) {
    ...
    if( rc==SQLITE_OK ){
      ...
      if( pFile==0 ){
        quotaLeave();
        if (memcmp(pSubOpen->pMethods->xClose_signature, xClose_signatures[xClose_quotaClose_enum], sizeof(pSubOpen->pMethods->xClose_signature)) == 0) {
          quotaClose(pSubOpen);
        }
...
static int quotaRead(
  ...
  sqlite3_file *pSubOpen = quotaSubOpen(pConn);
  if (memcmp(pSubOpen->pMethods->xRead_signature, xRead_signatures[xRead_quotaRead_enum], sizeof(pSubOpen->pMethods->xRead_signature)) == 0) {
    return quotaRead(pSubOpen, pBuf, iAmt, iOfst);
  }
...
static int quotaWrite(
  ...
  if (memcmp(pSubOpen->pMethods->xWrite_signature, xWrite_signatures[xWrite_quotaWrite_enum], sizeof(pSubOpen->pMethods->xWrite_signature)) == 0) {
    return quotaWrite(pSubOpen, pBuf, iAmt, iOfst);
  }
...
static int quotaSync(sqlite3_file *pConn, int flags){
  sqlite3_file *pSubOpen = quotaSubOpen(pConn);
  if (memcmp(pSubOpen->pMethods->xSync_signature, xSync_signatures[xSync_quotaSync_enum], sizeof(pSubOpen->pMethods->xSync_signature)) == 0) {
    return quotaSync(pSubOpen, flags);
  }
...
static int quotaFileSize(sqlite3_file *pConn, sqlite3_int64 *pSize){
  ...
  if (memcmp(pSubOpen->pMethods->xFileSize_signature, xFileSize_signatures[xFileSize_quotaFileSize_enum], sizeof(pSubOpen->pMethods->xFileSize_signature)) == 0) {
    rc = quotaFileSize(pSubOpen, &sz);
  }
...
static int quotaLock(sqlite3_file *pConn, int lock){
  sqlite3_file *pSubOpen = quotaSubOpen(pConn);
  if (memcmp(pSubOpen->pMethods->xLock_signature, xLock_signatures[xLock_quotaLock_enum], sizeof(pSubOpen->pMethods->xLock_signature)) == 0) {
    return quotaLock(pSubOpen, lock);
  }
...
static int quotaUnlock(sqlite3_file *pConn, int lock){
  sqlite3_file *pSubOpen = quotaSubOpen(pConn);
  if (memcmp(pSubOpen->pMethods->xUnlock_signature, xUnlock_signatures[xUnlock_quotaUnlock_enum], sizeof(pSubOpen->pMethods->xUnlock_signature)) == 0) {
    return quotaUnlock(pSubOpen, lock);
  }
...
static int quotaCheckReservedLock(sqlite3_file *pConn, int *pResOut){
  sqlite3_file *pSubOpen = quotaSubOpen(pConn);
  if (memcmp(pSubOpen->pMethods->xCheckReservedLock_signature, xCheckReservedLock_signatures[xCheckReservedLock_quotaCheckReservedLock_enum], sizeof(pSubOpen->pMethods->xCheckReservedLock_signature)) == 0) {
    return quotaCheckReservedLock(pSubOpen, pResOut);
  }
...
static int quotaSectorSize(sqlite3_file *pConn){
  sqlite3_file *pSubOpen = quotaSubOpen(pConn);
  if (memcmp(pSubOpen->pMethods->xSectorSize_signature, xSectorSize_signatures[xSectorSize_quotaSectorSize_enum], sizeof(pSubOpen->pMethods->xSectorSize_signature)) == 0) {
    return quotaSectorSize(pSubOpen);
  }
...
static int quotaDeviceCharacteristics(sqlite3_file *pConn){
  sqlite3_file *pSubOpen = quotaSubOpen(pConn);
  if (memcmp(pSubOpen->pMethods->xDeviceCharacteristics_signature, xDeviceCharacteristics_signatures[xDeviceCharacteristics_quotaDeviceCharacteristics_enum], sizeof(pSubOpen->pMethods->xDeviceCharacteristics_signature)) == 0) {
    return quotaDeviceCharacteristics(pSubOpen);
  }
...
static int quotaShmMap(
  ...
  sqlite3_file *pSubOpen = quotaSubOpen(pConn);
  if (memcmp(pSubOpen->pMethods->xShmMap_signature, xShmMap_signatures[xShmMap_quotaShmMap_enum], sizeof(pSubOpen->pMethods->xShmMap_signature)) == 0) {
    return quotaShmMap(pSubOpen, iRegion, szRegion, bExtend, pp);
  }
}
...
static int quotaShmLock(
  ...
  sqlite3_file *pSubOpen = quotaSubOpen(pConn);
  if (memcmp(pSubOpen->pMethods->xShmLock_signature, xShmLock_signatures[xShmLock_quotaShmLock_enum], sizeof(pSubOpen->pMethods->xShmLock_signature)) == 0) {
    return quotaShmLock(pSubOpen, ofst, n, flags);
  }
}
...
static void quotaShmBarrier(sqlite3_file *pConn){
  sqlite3_file *pSubOpen = quotaSubOpen(pConn);
  if (memcmp(pSubOpen->pMethods->xShmBarrier_signature, xShmBarrier_signatures[xShmBarrier_quotaShmBarrier_enum], sizeof(pSubOpen->pMethods->xShmBarrier_signature)) == 0) {
    quotaShmBarrier(pSubOpen);
  }
}
...
static int quotaShmUnmap(sqlite3_file *pConn, int deleteFlag){
  sqlite3_file *pSubOpen = quotaSubOpen(pConn);
  if (memcmp(pSubOpen->pMethods->xShmUnmap_signature, xShmUnmap_signatures[xShmUnmap_quotaShmUnmap_enum], sizeof(pSubOpen->pMethods->xShmUnmap_signature)) == 0) {
    return quotaShmUnmap(pSubOpen, deleteFlag);
  }
}
...
int sqlite3_quota_file(const char *zFilename){
  ...
  if( rc==SQLITE_OK ){
    ...
    if( rc==SQLITE_OK ){
      if (memcmp(fd->pMethods->xFileSize_signature, xFileSize_signatures[xFileSize_quotaFileSize_enum], sizeof(fd->pMethods->xFileSize_signature)) == 0) {
      ...
      if (memcmp(fd->pMethods->xClose_signature, xClose_signatures[xClose_quotaClose_enum], sizeof(fd->pMethods->xClose_signature)) == 0) {
        quotaClose(fd);
      }

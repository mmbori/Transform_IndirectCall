...
void sqlite3RenameExprUnmap(Parse *pParse, Expr *pExpr){
  ...
  memcpy(sWalker.xExprCallback_signature,
         xExprCallback_signatures[xExprCallback_renameUnmapExprCb_enum],
         sizeof(sWalker.xExprCallback_signature));
  memcpy(sWalker.xSelectCallback_signature,
         xSelectCallback_signatures[xSelectCallback_renameUnmapSelectCb_enum],
         sizeof(sWalker.xSelectCallback_signature));
...
static void renameColumnFunc(
  ...
  memcpy(sWalker.xExprCallback_signature,
         xExprCallback_signatures[xExprCallback_renameColumnExprCb_enum],
         sizeof(sWalker.xExprCallback_signature));
  memcpy(sWalker.xSelectCallback_signature,
         xSelectCallback_signatures[xSelectCallback_renameColumnSelectCb_enum],
         sizeof(sWalker.xSelectCallback_signature));
...
static void renameTableFunc(
  ...
  if( zInput && zOld && zNew ){
    ...
    sWalker.pParse = &sParse;
    memcpy(sWalker.xExprCallback_signature,
           xExprCallback_signatures[xExprCallback_renameTableExprCb_enum],
           sizeof(sWalker.xExprCallback_signature));
    memcpy(sWalker.xSelectCallback_signature,
           xSelectCallback_signatures[xSelectCallback_renameTableSelectCb_enum],
           sizeof(sWalker.xSelectCallback_signature));
    sWalker.u.pRename = &sCtx;
...
static void renameQuotefixFunc(
  ...
  if( zDb && zInput ){
    ...
    if( rc==SQLITE_OK ){
      ...
      sWalker.pParse = &sParse;
      memcpy(sWalker.xExprCallback_signature,
             xExprCallback_signatures[xExprCallback_renameQuotefixExprCb_enum],
             sizeof(sWalker.xExprCallback_signature));
      memcpy(sWalker.xSelectCallback_signature,
             xSelectCallback_signatures[xSelectCallback_renameColumnSelectCb_enum],
             sizeof(sWalker.xSelectCallback_signature));

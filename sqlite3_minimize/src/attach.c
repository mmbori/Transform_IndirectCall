...
void sqlite3FixInit(
  ...
  memcpy(pFix->w.xExprCallback_signature,
         xExprCallback_signatures[xExprCallback_fixExprCb_enum],
         sizeof(pFix->w.xExprCallback_signature));
  memcpy(pFix->w.xSelectCallback_signature,
         xSelectCallback_signatures[xSelectCallback_fixSelectCb_enum],
         sizeof(pFix->w.xSelectCallback_signature));
  memcpy(pFix->w.xSelectCallback2_signature,
         xSelectCallback2_signatures[xSelectCallback2_sqlite3WalkWinDefnDummyCallback_enum],
         sizeof(pFix->w.xSelectCallback2_signature));

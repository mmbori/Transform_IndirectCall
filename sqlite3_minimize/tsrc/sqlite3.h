...
#define SQLITE_SOURCE_ID      "2025-09-09 10:28:06 0f31711591c56f3896fb6f092752fb82c4ea646bf8e5838dfbe55302994ealt1"
...
*/
#ifndef STRUCT_SQLITE3_FILE
#define STRUCT_SQLITE3_FILE
...
** database corruption.
*/
#ifndef STRUCT_SQLITE_IO_METHOD
#define STRUCT_SQLITE_IO_METHOD
...
struct sqlite3_io_methods {
  ...
  int xClose_signature[4];

  int xRead_signature[4];

  int xWrite_signature[4];

  int xTruncate_signature[4];

  int xSync_signature[4];

  int xFileSize_signature[4];

  int xLock_signature[4];

  int xUnlock_signature[4];

  int xCheckReservedLock_signature[4];

  int xFileControl_signature[4];

  int xSectorSize_signature[4];

  int xDeviceCharacteristics_signature[4];

  int xShmMap_signature[4];

  int xShmLock_signature[4];

  int xShmBarrier_signature[4];

  int xShmUnmap_signature[4];
};
#endif
...
*/
#ifndef STRUCT_SQLITE3_VFS
#define STRUCT_SQLITE3_VFS
...
struct sqlite3_vfs {
  ...
  */
  ...
  int xOpen_signature[4];

  int xAccess_signature[4];

  int xFullPathname_signature[4];

  int xDlError_signature[4];

  int xDlClose_signature[4];

  int xRandomness_signature[4];

  int xSleep_signature[4];

  int xCurrentTime_signature[4];

  int xGetLastError_signature[4];

  int xCurrentTimeInt64_signature[4];
};
#endif
...
** call to xShutdown().
*/
#ifndef STRUCT_SQLITE3_MEM_METHOD
#define STRUCT_SQLITE3_MEM_METHOD
...
*/
#ifndef STRUCT_SQLITE3_MODULE
#define STRUCT_SQLITE3_MODULE
struct sqlite3_module {
  ...
  ** Those below are for version 4 and greater. */
  ...
  int xCreate_signature[4];
  int xConnect_signature[4];
  int xBestIndex_signature[4];
  int xDisconnect_signature[4];
  int xDestroy_signature[4];
  int xOpen_signature[4];
  int xClose_signature[4];
  int xFilter_signature[4];
  int xNext_signature[4];
  int xEof_signature[4];
  int xColumn_signature[4];
  int xRowid_signature[4];
  int xUpdate_signature[4];
  int xBegin_signature[4];
  int xSyncsignature[4];
  int xCommit_signature[4];
  int xRollback_signature[4];
  int xFindFunction_signature[4];
  int xRename_signature[4];
  int xSavepoint_signature[4];
  int xRelease_signature[4];
  int xRollbackTo_signature[4];
  int xShadowName_signature[4];
  int xIntegrity_signature[4];
};
#endif
...
** 3009000.
*/
#ifndef STRUCT_SQLITE3_INDEX_INFO
#define STRUCT_SQLITE3_INDEX_INFO
...
*/
#ifndef STRUCT_SQLITE3_VTAB
#define STRUCT_SQLITE3_VTAB
struct sqlite3_vtab {
...
*/
#ifndef STRUCT_SQLITE3_VTAB_CURSOR
#define STRUCT_SQLITE3_VTAB_CURSOR
...
** prior to returning.
*/
#ifndef STRUCT_SQLITE3_MUTEX_METHODS
#define STRUCT_SQLITE3_MUTEX_METHODS
...
** See [sqlite3_pcache_methods2] for additional information.
*/
#ifndef STRUCT_SQLITE3_PCACHE_PAGE
#define STRUCT_SQLITE3_PCACHE_PAGE
...
** do their best.
*/
#ifndef STRUCT_SQLITE3_PCACHE_METHODS2
#define STRUCT_SQLITE3_PCACHE_METHODS2
...
struct sqlite3_pcache_methods2 {
  ...
  int xInit_signature[4];
  int xShutdown_signature[4];
  int xCreate_signature[4];
  int xCachesize_signature[4];
  int xPagecount_signature[4];
  int xFetch_signature[4];
  int xUnpin_signature[4];
  int xRekey_signature[4];
  int xTruncate_signature[4];
  int xDestroy_signature[4];
  int xShrink_signature[4];
};
#endif
...
*/
#ifndef STRUCT_SQLITE3_PCACHE_METHODS
#define STRUCT_SQLITE3_PCACHE_METHODS
...
*/
#ifndef STRUCT_SQLITE3_SNAPSHOT
#define STRUCT_SQLITE3_SNAPSHOT
...
struct sqlite3_rtree_geometry {
  ...
  /* Function pointer signature arrays */

  int xDelUser_signature[4];
};

...
struct SessionHook {
  ...
  int xOld_signature[4];

  int xNew_signature[4];

  int xCount_signature[4];

  int xDepth_signature[4];
...
static void sessionPreupdateHooks(
  ...
  memcpy(pSession->hook.xOld_signature,
         xOld_signatures[xOld_sessionPreupdateOld_enum],
         sizeof(pSession->hook.xOld_signature));
  memcpy(pSession->hook.xNew_signature,
         xNew_signatures[xNew_sessionPreupdateNew_enum],
         sizeof(pSession->hook.xNew_signature));
  memcpy(pSession->hook.xCount_signature,
         xCount_signatures[xCount_sessionPreupdateCount_enum],
         sizeof(pSession->hook.xCount_signature));
  memcpy(pSession->hook.xDepth_signature,
         xDepth_signatures[xDepth_sessionPreupdateDepth_enum],
         sizeof(pSession->hook.xDepth_signature));
}
...
static void sessionDiffHooks(
  ...
  memcpy(pSession->hook.xOld_signature,
         xOld_signatures[xOld_sessionDiffOld_enum],
         sizeof(pSession->hook.xOld_signature));
  memcpy(pSession->hook.xNew_signature,
         xNew_signatures[xNew_sessionDiffNew_enum],
         sizeof(pSession->hook.xNew_signature));
  memcpy(pSession->hook.xCount_signature,
         xCount_signatures[xCount_sessionDiffCount_enum],
         sizeof(pSession->hook.xCount_signature));
  memcpy(pSession->hook.xDepth_signature,
         xDepth_signatures[xDepth_sessionDiffDepth_enum],
         sizeof(pSession->hook.xDepth_signature));
}

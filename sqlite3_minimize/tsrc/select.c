...
static void recomputeColumnsUsed(
  ...
  memcpy(w.xExprCallback_signature,
         xExprCallback_signatures[xExprCallback_recomputeColumnsUsedExpr_enum],
...
static void renumberCursors(
  ...
  w.u.aiCol = aCsrMap;
  memcpy(w.xExprCallback_signature,
         xExprCallback_signatures[xExprCallback_renumberCursorsCb_enum],
         sizeof(w.xExprCallback_signature));
  memcpy(w.xSelectCallback_signature,
         xSelectCallback_signatures[xSelectCallback_sqlite3SelectWalkNoop_enum],
         sizeof(w.xSelectCallback_signature));
...
** is SQLITE_AFF_BLOB.
*/
int propagateConstantExprRewriteOne(
  WhereConst *pConst,
  Expr *pExpr,
  int bIgnoreAffBlob
){
...
static int propagateConstants(
  ...
  do{
    ...
    if( x.nConst ){
      ...
      w.pParse = pParse;
      memcpy(w.xExprCallback_signature,
             xExprCallback_signatures[xExprCallback_propagateConstantExprRewrite_enum],
             sizeof(w.xExprCallback_signature));
      memcpy(w.xSelectCallback_signature,
             xSelectCallback_signatures[xSelectCallback_sqlite3SelectWalkNoop_enum],
             sizeof(w.xSelectCallback_signature));
...
static void sqlite3SelectExpand(Parse *pParse, Select *pSelect){
  ...
  if( OK_IF_ALWAYS_TRUE(pParse->hasCompound) ){
    memcpy(w.xSelectCallback_signature,
           xSelectCallback_signatures[xSelectCallback_convertCompoundSelectToSubquery_enum],
           sizeof(w.xSelectCallback_signature));
    w.xSelectCallback2 = 0;
    sqlite3WalkSelect(&w, pSelect);
  }
  memcpy(w.xSelectCallback_signature,
         xSelectCallback_signatures[xSelectCallback_selectExpander_enum],
         sizeof(w.xSelectCallback_signature));
  memcpy(w.xSelectCallback2_signature,
         xSelectCallback2_signatures[xSelectCallback2_sqlite3SelectPopWith_enum],
...
static void sqlite3SelectAddTypeInfo(Parse *pParse, Select *pSelect){
  ...
  memcpy(w.xSelectCallback_signature,
         ...
         sizeof(w.xSelectCallback_signature));
  memcpy(w.xSelectCallback2_signature,
         xSelectCallback2_signatures[xSelectCallback2_selectAddSubqueryTypeInfo_enum],
         sizeof(w.xSelectCallback2_signature));
  memcpy(w.xExprCallback_signature,
         xExprCallback_signatures[xExprCallback_sqlite3ExprWalkNoop_enum],
         sizeof(w.xExprCallback_signature));
...
static void aggregateConvertIndexedExprRefToColumn(AggInfo *pAggInfo){
  ...
  memset(&w, 0, sizeof(w));
  memcpy(w.xExprCallback_signature,
         xExprCallback_signatures[xExprCallback_aggregateIdxEprRefToColCallback_enum],
         sizeof(w.xExprCallback_signature));
  for(i=0; i<pAggInfo->nFunc; i++){
...
static void havingToWhere(Parse *pParse, Select *p){
  ...
  memcpy(sWalker.xExprCallback_signature,
         xExprCallback_signatures[xExprCallback_havingToWhereExprCb_enum],
         sizeof(sWalker.xExprCallback_signature));
  sWalker.u.pSelect = p;
...
static void selectCheckOnClauses(Parse *pParse, Select *pSelect){
  ...
  w.pParse = pParse;
  memcpy(w.xExprCallback_signature,
         xExprCallback_signatures[xExprCallback_selectCheckOnClausesExpr_enum],
         sizeof(w.xExprCallback_signature));
  memcpy(w.xSelectCallback_signature,
         xSelectCallback_signatures[xSelectCallback_selectCheckOnClausesSelect_enum],
         sizeof(w.xSelectCallback_signature));

...
*/
#ifndef STRUCT_WALKER
#define STRUCT_WALKER
struct Walker {
  ...
  int xExprCallback_signature[4];

  int xSelectCallback_signature[4];

  int xSelectCallback2_signature[4];
};
#endif
...
** explicit.
*/
#ifndef STRUCT_DBFIXER
#define STRUCT_DBFIXER
struct DbFixer {
...
*/
#ifndef STRUCT_CTEUSE
#define STRUCT_CTEUSE
struct CteUse {
...
*/
#ifndef STRUCT_DBCLIENTDATA
#define STRUCT_DBCLIENTDATA
struct DbClientData {
...
*/
#ifndef STRUCT_TREEVIEW
#define STRUCT_TREEVIEW
struct TreeView {
...
*/
#ifndef STRUCT_WINDOW
#define STRUCT_WINDOW
struct Window {
...
*/
#ifndef STRUCT_PRINTARGUMENTS
#define STRUCT_PRINTARGUMENTS
...
*/
#ifndef STRUCT_FPDECODE
#define STRUCT_FPDECODE
struct FpDecode {
  char sign;           /* '+' or '-' */

...
int sqlite3WalkSelect(Walker *pWalker, Select *p){
  ...
  do{
    ...
    if( pWalker->xSelectCallback2 ){
      ...
      // if (memcmp(pWalker->xSelectCallback2_signature, xSelectCallback2_signatures[xSelectCallback2_sqlite3SelectWalkAssert2_enum], sizeof(pWalker->xSelectCallback2_signature)) == 0) {
      //   sqlite3SelectWalkAssert2(pWalker, p);
      // }

...
static void incrAggFunctionDepth(Expr *pExpr, int N){
  if( N>0 ){
    ...
    memcpy(w.xExprCallback_signature,
           xExprCallback_signatures[xExprCallback_incrAggDepth_enum],
...
static void windowRemoveExprFromSelect(Select *pSelect, Expr *pExpr){
  if( pSelect->pWin ){
    ...
    memcpy(sWalker.xExprCallback_signature,
           xExprCallback_signatures[xExprCallback_resolveRemoveWindowsCb_enum],
...
int sqlite3ResolveExprNames(
  ...
  w.pParse = pNC->pParse;
  memcpy(w.xExprCallback_signature,
         xExprCallback_signatures[xExprCallback_resolveExprStep_enum],
         sizeof(w.xExprCallback_signature));
...
int sqlite3ResolveExprListNames(
  ...
  memcpy(w.xSelectCallback_signature,
         xSelectCallback_signatures[xSelectCallback_resolveSelectStep_enum],

...
handler_t plugins_call_handle_uri_clean(request_st * const r) {
	return plugins_call_fn_req_data(r, PLUGIN_FUNC_HANDLE_URI_CLEAN);
}

handler_t plugins_call_handle_docroot(request_st * const r) {
	return plugins_call_fn_req_data(r, PLUGIN_FUNC_HANDLE_DOCROOT);
}
...
handler_t plugins_call_handle_subrequest_start(request_st * const r) {
	return plugins_call_fn_req_data(r, PLUGIN_FUNC_HANDLE_SUBREQUEST_START);
}

handler_t plugins_call_handle_response_start(request_st * const r) {
	return plugins_call_fn_req_data(r, PLUGIN_FUNC_HANDLE_RESPONSE_START);
}

handler_t plugins_call_handle_request_done(request_st * const r) {
	return plugins_call_fn_req_data(r, PLUGIN_FUNC_HANDLE_REQUEST_DONE);
}

handler_t plugins_call_handle_request_reset(request_st * const r) {
	return plugins_call_fn_req_data(r, PLUGIN_FUNC_HANDLE_REQUEST_RESET);
}

handler_t plugins_call_handle_request_env(request_st * const r) {
	return plugins_call_fn_req_data(r, PLUGIN_FUNC_HANDLE_REQUEST_ENV);
}
...
handler_t plugins_call_handle_connection_accept(connection *con) {
	return plugins_call_fn_con_data(con, PLUGIN_FUNC_HANDLE_CONNECTION_ACCEPT);
}
...
handler_t plugins_call_handle_connection_close(connection *con) {
	return plugins_call_fn_con_data(con, PLUGIN_FUNC_HANDLE_CONNECTION_CLOSE);
}

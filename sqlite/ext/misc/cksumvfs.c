...
,
  .xOpen_signature = xOpen_signatures[xOpen_cksmOpen_enum],
  .xDelete_signature = xDelete_signatures[xDelete_cksmDelete_enum],
  .xAccess_signature = xAccess_signatures[xAccess_cksmAccess_enum],
  .xFullPathname_signature = xFullPathname_signatures[xFullPathname_cksmFullPathname_enum],
  .xDlOpen_signature = xDlOpen_signatures[xDlOpen_cksmDlOpen_enum],
  .xDlError_signature = xDlError_signatures[xDlError_cksmDlError_enum],
  .xDlSym_signature = xDlSym_signatures[xDlSym_cksmDlSym_enum],
  .xDlClose_signature = xDlClose_signatures[xDlClose_cksmDlClose_enum],
  .xRandomness_signature = xRandomness_signatures[xRandomness_cksmRandomness_enum],
  .xSleep_signature = xSleep_signatures[xSleep_cksmSleep_enum],
  .xCurrentTime_signature = xCurrentTime_signatures[xCurrentTime_cksmCurrentTime_enum],
  .xGetLastError_signature = xGetLastError_signatures[xGetLastError_cksmGetLastError_enum],
  .xCurrentTimeInt64_signature = xCurrentTimeInt64_signatures[xCurrentTimeInt64_cksmCurrentTimeInt64_enum],
  .xSetSystemCall_signature = xSetSystemCall_signatures[xSetSystemCall_cksmSetSystemCall_enum],
  .xGetSystemCall_signature = xGetSystemCall_signatures[xGetSystemCall_cksmGetSystemCall_enum],
  .xNextSystemCall_signature = xNextSystemCall_signatures[xNextSystemCall_cksmNextSystemCall_enum]
};
...
,
  .xClose_signature = xClose_signatures[xClose_cksmClose_enum],
  .xRead_signature = xRead_signatures[xRead_cksmRead_enum],
  .xWrite_signature = xWrite_signatures[xWrite_cksmWrite_enum],
  .xTruncate_signature = xTruncate_signatures[xTruncate_cksmTruncate_enum],
  .xSync_signature = xSync_signatures[xSync_cksmSync_enum],
  .xFileSize_signature = xFileSize_signatures[xFileSize_cksmFileSize_enum],
  .xLock_signature = xLock_signatures[xLock_cksmLock_enum],
  .xUnlock_signature = xUnlock_signatures[xUnlock_cksmUnlock_enum],
  .xCheckReservedLock_signature = xCheckReservedLock_signatures[xCheckReservedLock_cksmCheckReservedLock_enum],
  .xFileControl_signature = xFileControl_signatures[xFileControl_cksmFileControl_enum],
  .xSectorSize_signature = xSectorSize_signatures[xSectorSize_cksmSectorSize_enum],
  .xDeviceCharacteristics_signature = xDeviceCharacteristics_signatures[xDeviceCharacteristics_cksmDeviceCharacteristics_enum],
  .xShmMap_signature = xShmMap_signatures[xShmMap_cksmShmMap_enum],
  .xShmLock_signature = xShmLock_signatures[xShmLock_cksmShmLock_enum],
  .xShmBarrier_signature = xShmBarrier_signatures[xShmBarrier_cksmShmBarrier_enum],
  .xShmUnmap_signature = xShmUnmap_signatures[xShmUnmap_cksmShmUnmap_enum],
  .xFetch_signature = xFetch_signatures[xFetch_cksmFetch_enum],
  .xUnfetch_signature = xUnfetch_signatures[xUnfetch_cksmUnfetch_enum]
};

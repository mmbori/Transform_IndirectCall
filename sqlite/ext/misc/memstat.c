...
static sqlite3_module memstatModule = {
  ...
  0                          /* xIntegrity */
,
  .xConnect_signature = xConnect_signatures[xConnect_memstatConnect_enum],
  .xBestIndex_signature = xBestIndex_signatures[xBestIndex_memstatBestIndex_enum],
  .xDisconnect_signature = xDisconnect_signatures[xDisconnect_memstatDisconnect_enum],
  .xOpen_signature = xOpen_signatures[xOpen_memstatOpen_enum],
  .xClose_signature = xClose_signatures[xClose_memstatClose_enum],
  .xFilter_signature = xFilter_signatures[xFilter_memstatFilter_enum],
  .xNext_signature = xNext_signatures[xNext_memstatNext_enum],
  .xEof_signature = xEof_signatures[xEof_memstatEof_enum],
  .xColumn_signature = xColumn_signatures[xColumn_memstatColumn_enum],
  .xRowid_signature = xRowid_signatures[xRowid_memstatRowid_enum]
};

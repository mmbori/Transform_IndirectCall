...
static sqlite3_module templatevtabModule = {
  ...
  /* xIntegrity  */ 0
,
  .xConnect_signature = xConnect_signatures[xConnect_templatevtabConnect_enum],
  .xBestIndex_signature = xBestIndex_signatures[xBestIndex_templatevtabBestIndex_enum],
  .xDisconnect_signature = xDisconnect_signatures[xDisconnect_templatevtabDisconnect_enum],
  .xOpen_signature = xOpen_signatures[xOpen_templatevtabOpen_enum],
  .xClose_signature = xClose_signatures[xClose_templatevtabClose_enum],
  .xFilter_signature = xFilter_signatures[xFilter_templatevtabFilter_enum],
  .xNext_signature = xNext_signatures[xNext_templatevtabNext_enum],
  .xEof_signature = xEof_signatures[xEof_templatevtabEof_enum],
  .xColumn_signature = xColumn_signatures[xColumn_templatevtabColumn_enum],
  .xRowid_signature = xRowid_signatures[xRowid_templatevtabRowid_enum]
};

...
,
  .xClose_signature = xClose_signatures[xClose_vstatClose_enum],
  .xRead_signature = xRead_signatures[xRead_vstatRead_enum],
  .xWrite_signature = xWrite_signatures[xWrite_vstatWrite_enum],
  .xTruncate_signature = xTruncate_signatures[xTruncate_vstatTruncate_enum],
  .xSync_signature = xSync_signatures[xSync_vstatSync_enum],
  .xFileSize_signature = xFileSize_signatures[xFileSize_vstatFileSize_enum],
  .xLock_signature = xLock_signatures[xLock_vstatLock_enum],
  .xUnlock_signature = xUnlock_signatures[xUnlock_vstatUnlock_enum],
  .xCheckReservedLock_signature = xCheckReservedLock_signatures[xCheckReservedLock_vstatCheckReservedLock_enum],
  .xFileControl_signature = xFileControl_signatures[xFileControl_vstatFileControl_enum],
  .xSectorSize_signature = xSectorSize_signatures[xSectorSize_vstatSectorSize_enum],
  .xDeviceCharacteristics_signature = xDeviceCharacteristics_signatures[xDeviceCharacteristics_vstatDeviceCharacteristics_enum],
  .xShmMap_signature = xShmMap_signatures[xShmMap_vstatShmMap_enum],
  .xShmLock_signature = xShmLock_signatures[xShmLock_vstatShmLock_enum],
  .xShmBarrier_signature = xShmBarrier_signatures[xShmBarrier_vstatShmBarrier_enum],
  .xShmUnmap_signature = xShmUnmap_signatures[xShmUnmap_vstatShmUnmap_enum],
  .xFetch_signature = xFetch_signatures[xFetch_vstatFetch_enum],
  .xUnfetch_signature = xUnfetch_signatures[xUnfetch_vstatUnfetch_enum]
};
...
static sqlite3_module VfsStatModule = {
  ...
  0                          /* xIntegrity */
,
  .xConnect_signature = xConnect_signatures[xConnect_vstattabConnect_enum],
  .xBestIndex_signature = xBestIndex_signatures[xBestIndex_vstattabBestIndex_enum],
  .xDisconnect_signature = xDisconnect_signatures[xDisconnect_vstattabDisconnect_enum],
  .xOpen_signature = xOpen_signatures[xOpen_vstattabOpen_enum],
  .xClose_signature = xClose_signatures[xClose_vstattabClose_enum],
  .xFilter_signature = xFilter_signatures[xFilter_vstattabFilter_enum],
  .xNext_signature = xNext_signatures[xNext_vstattabNext_enum],
  .xEof_signature = xEof_signatures[xEof_vstattabEof_enum],
  .xColumn_signature = xColumn_signatures[xColumn_vstattabColumn_enum],
  .xRowid_signature = xRowid_signatures[xRowid_vstattabRowid_enum],
  .xUpdate_signature = xUpdate_signatures[xUpdate_vstattabUpdate_enum]
};

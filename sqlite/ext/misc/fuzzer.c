...
static sqlite3_module fuzzerModule = {
  ...
  0                            /* xIntegrity */
,
  .xCreate_signature = xCreate_signatures[xCreate_fuzzerConnect_enum],
  .xConnect_signature = xConnect_signatures[xConnect_fuzzerConnect_enum],
  .xBestIndex_signature = xBestIndex_signatures[xBestIndex_fuzzerBestIndex_enum],
  .xDisconnect_signature = xDisconnect_signatures[xDisconnect_fuzzerDisconnect_enum],
  .xDestroy_signature = xDestroy_signatures[xDestroy_fuzzerDisconnect_enum],
  .xOpen_signature = xOpen_signatures[xOpen_fuzzerOpen_enum],
  .xClose_signature = xClose_signatures[xClose_fuzzerClose_enum],
  .xFilter_signature = xFilter_signatures[xFilter_fuzzerFilter_enum],
  .xNext_signature = xNext_signatures[xNext_fuzzerNext_enum],
  .xEof_signature = xEof_signatures[xEof_fuzzerEof_enum],
  .xColumn_signature = xColumn_signatures[xColumn_fuzzerColumn_enum],
  .xRowid_signature = xRowid_signatures[xRowid_fuzzerRowid_enum]
};

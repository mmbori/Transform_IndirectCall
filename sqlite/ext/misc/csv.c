...
static sqlite3_module CsvModule = {
  ...
  0                        /* xIntegrity */
,
  .xCreate_signature = xCreate_signatures[xCreate_csvtabCreate_enum],
  .xConnect_signature = xConnect_signatures[xConnect_csvtabConnect_enum],
  .xBestIndex_signature = xBestIndex_signatures[xBestIndex_csvtabBestIndex_enum],
  .xDisconnect_signature = xDisconnect_signatures[xDisconnect_csvtabDisconnect_enum],
  .xDestroy_signature = xDestroy_signatures[xDestroy_csvtabDisconnect_enum],
  .xOpen_signature = xOpen_signatures[xOpen_csvtabOpen_enum],
  .xClose_signature = xClose_signatures[xClose_csvtabClose_enum],
  .xFilter_signature = xFilter_signatures[xFilter_csvtabFilter_enum],
  .xNext_signature = xNext_signatures[xNext_csvtabNext_enum],
  .xEof_signature = xEof_signatures[xEof_csvtabEof_enum],
  .xColumn_signature = xColumn_signatures[xColumn_csvtabColumn_enum],
  .xRowid_signature = xRowid_signatures[xRowid_csvtabRowid_enum]
};
...
,
  ...
  .xColumn_signature = xColumn_signatures[xColumn_csvtabColumn_enum],
  .xRowid_signature = xRowid_signatures[xRowid_csvtabRowid_enum],
  .xUpdate_signature = xUpdate_signatures[xUpdate_csvtabUpdate_enum]
};
#endif /* SQLITE_TEST */

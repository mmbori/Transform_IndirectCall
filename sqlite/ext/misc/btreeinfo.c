...
int sqlite3BinfoRegister(sqlite3 *db){
  static sqlite3_module binfo_module = {
    ...
    0                            /* xIntegrity */
  ,
  .xConnect_signature = xConnect_signatures[xConnect_binfoConnect_enum],
  .xBestIndex_signature = xBestIndex_signatures[xBestIndex_binfoBestIndex_enum],
  .xDisconnect_signature = xDisconnect_signatures[xDisconnect_binfoDisconnect_enum],
  .xOpen_signature = xOpen_signatures[xOpen_binfoOpen_enum],
  .xClose_signature = xClose_signatures[xClose_binfoClose_enum],
  .xFilter_signature = xFilter_signatures[xFilter_binfoFilter_enum],
  .xNext_signature = xNext_signatures[xNext_binfoNext_enum],
  .xEof_signature = xEof_signatures[xEof_binfoEof_enum],
  .xColumn_signature = xColumn_signatures[xColumn_binfoColumn_enum],
  .xRowid_signature = xRowid_signatures[xRowid_binfoRowid_enum]
};

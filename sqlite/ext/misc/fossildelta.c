...
static sqlite3_module deltaparsevtabModule = {
  ...
  /* xIntegrity  */ 0
,
  .xConnect_signature = xConnect_signatures[xConnect_deltaparsevtabConnect_enum],
  .xBestIndex_signature = xBestIndex_signatures[xBestIndex_deltaparsevtabBestIndex_enum],
  .xDisconnect_signature = xDisconnect_signatures[xDisconnect_deltaparsevtabDisconnect_enum],
  .xOpen_signature = xOpen_signatures[xOpen_deltaparsevtabOpen_enum],
  .xClose_signature = xClose_signatures[xClose_deltaparsevtabClose_enum],
  .xFilter_signature = xFilter_signatures[xFilter_deltaparsevtabFilter_enum],
  .xNext_signature = xNext_signatures[xNext_deltaparsevtabNext_enum],
  .xEof_signature = xEof_signatures[xEof_deltaparsevtabEof_enum],
  .xColumn_signature = xColumn_signatures[xColumn_deltaparsevtabColumn_enum],
  .xRowid_signature = xRowid_signatures[xRowid_deltaparsevtabRowid_enum]
};

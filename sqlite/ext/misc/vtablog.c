...
,
  .xCreate_signature = xCreate_signatures[xCreate_vtablogCreate_enum],
  .xConnect_signature = xConnect_signatures[xConnect_vtablogConnect_enum],
  .xBestIndex_signature = xBestIndex_signatures[xBestIndex_vtablogBestIndex_enum],
  .xDisconnect_signature = xDisconnect_signatures[xDisconnect_vtablogDisconnect_enum],
  .xDestroy_signature = xDestroy_signatures[xDestroy_vtablogDestroy_enum],
  .xOpen_signature = xOpen_signatures[xOpen_vtablogOpen_enum],
  .xClose_signature = xClose_signatures[xClose_vtablogClose_enum],
  .xFilter_signature = xFilter_signatures[xFilter_vtablogFilter_enum],
  .xNext_signature = xNext_signatures[xNext_vtablogNext_enum],
  .xEof_signature = xEof_signatures[xEof_vtablogEof_enum],
  .xColumn_signature = xColumn_signatures[xColumn_vtablogColumn_enum],
  .xRowid_signature = xRowid_signatures[xRowid_vtablogRowid_enum],
  .xUpdate_signature = xUpdate_signatures[xUpdate_vtablogUpdate_enum],
  .xBegin_signature = xBegin_signatures[xBegin_vtablogBegin_enum],
  .xSync_signature = xSync_signatures[xSync_vtablogSync_enum],
  .xCommit_signature = xCommit_signatures[xCommit_vtablogCommit_enum],
  .xRollback_signature = xRollback_signatures[xRollback_vtablogRollback_enum],
  .xFindFunction_signature = xFindFunction_signatures[xFindFunction_vtablogFindMethod_enum],
  .xRename_signature = xRename_signatures[xRename_vtablogRename_enum],
  .xSavepoint_signature = xSavepoint_signatures[xSavepoint_vtablogSavepoint_enum],
  .xRelease_signature = xRelease_signatures[xRelease_vtablogRelease_enum],
  .xRollbackTo_signature = xRollbackTo_signatures[xRollbackTo_vtablogRollbackTo_enum],
  .xShadowName_signature = xShadowName_signatures[xShadowName_vtablogShadowName_enum],
  .xIntegrity_signature = xIntegrity_signatures[xIntegrity_vtablogIntegrity_enum]
};

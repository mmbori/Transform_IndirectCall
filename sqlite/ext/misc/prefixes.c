...
static sqlite3_module prefixesModule = {
  ...
  /* xIntegrity  */ 0
,
  .xConnect_signature = xConnect_signatures[xConnect_prefixesConnect_enum],
  .xBestIndex_signature = xBestIndex_signatures[xBestIndex_prefixesBestIndex_enum],
  .xDisconnect_signature = xDisconnect_signatures[xDisconnect_prefixesDisconnect_enum],
  .xOpen_signature = xOpen_signatures[xOpen_prefixesOpen_enum],
  .xClose_signature = xClose_signatures[xClose_prefixesClose_enum],
  .xFilter_signature = xFilter_signatures[xFilter_prefixesFilter_enum],
  .xNext_signature = xNext_signatures[xNext_prefixesNext_enum],
  .xEof_signature = xEof_signatures[xEof_prefixesEof_enum],
  .xColumn_signature = xColumn_signatures[xColumn_prefixesColumn_enum],
  .xRowid_signature = xRowid_signatures[xRowid_prefixesRowid_enum]
};

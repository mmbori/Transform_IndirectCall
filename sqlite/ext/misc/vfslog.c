...
,
  ...
  .xRead_signature = xRead_signatures[xRead_vlogRead_enum],
  .xWrite_signature = xWrite_signatures[xWrite_vlogWrite_enum],
  .xTruncate_signature = xTruncate_signatures[xTruncate_vlogTruncate_enum],
  .xSync_signature = xSync_signatures[xSync_vlogSync_enum],
  .xFileSize_signature = xFileSize_signatures[xFileSize_vlogFileSize_enum],
  .xLock_signature = xLock_signatures[xLock_vlogLock_enum],
  .xUnlock_signature = xUnlock_signatures[xUnlock_vlogUnlock_enum],
  .xCheckReservedLock_signature = xCheckReservedLock_signatures[xCheckReservedLock_vlogCheckReservedLock_enum],
  .xFileControl_signature = xFileControl_signatures[xFileControl_vlogFileControl_enum],
  .xSectorSize_signature = xSectorSize_signatures[xSectorSize_vlogSectorSize_enum],
  .xDeviceCharacteristics_signature = xDeviceCharacteristics_signatures[xDeviceCharacteristics_vlogDeviceCharacteristics_enum]
};
...
** Close an vlog-file.
*/
int vlogClose(sqlite3_file *pFile){
...
*/
int vlogTruncate(sqlite3_file *pFile, sqlite_int64 size){
  int rc;
  sqlite3_uint64 tStart, tElapse;
  VLogFile *p = (VLogFile *)pFile;
  tStart = vlog_time();
...
** Sync an vlog-file.
*/
int vlogSync(sqlite3_file *pFile, int flags){
  int rc;
  sqlite3_uint64 tStart, tElapse;
  VLogFile *p = (VLogFile *)pFile;
  tStart = vlog_time();
...
*/
int vlogFileSize(sqlite3_file *pFile, sqlite_int64 *pSize){
  int rc;
  sqlite3_uint64 tStart, tElapse;
  VLogFile *p = (VLogFile *)pFile;
  tStart = vlog_time();
...
** Lock an vlog-file.
*/
int vlogLock(sqlite3_file *pFile, int eLock){
  int rc;
  sqlite3_uint64 tStart, tElapse;
  VLogFile *p = (VLogFile *)pFile;
  tStart = vlog_time();
...
** Unlock an vlog-file.
*/
int vlogUnlock(sqlite3_file *pFile, int eLock){
  int rc;
...
*/
int vlogCheckReservedLock(sqlite3_file *pFile, int *pResOut){
  int rc;
  sqlite3_uint64 tStart, tElapse;
  VLogFile *p = (VLogFile *)pFile;
  tStart = vlog_time();
...
*/
int vlogFileControl(sqlite3_file *pFile, int op, void *pArg){
  VLogFile *p = (VLogFile *)pFile;
  sqlite3_uint64 tStart, tElapse;
  int rc;
  tStart = vlog_time();
...
*/
int vlogSectorSize(sqlite3_file *pFile){
  int rc;
  sqlite3_uint64 tStart, tElapse;
  VLogFile *p = (VLogFile *)pFile;
  tStart = vlog_time();
...
*/
int vlogDeviceCharacteristics(sqlite3_file *pFile){
  int rc;
  sqlite3_uint64 tStart, tElapse;
  VLogFile *p = (VLogFile *)pFile;
  tStart = vlog_time();

...
static sqlite3_module amatchModule = {
  ...
  0                       /* xIntegrity */
,
  .xCreate_signature = xCreate_signatures[xCreate_amatchConnect_enum],
  .xConnect_signature = xConnect_signatures[xConnect_amatchConnect_enum],
  .xBestIndex_signature = xBestIndex_signatures[xBestIndex_amatchBestIndex_enum],
  .xDisconnect_signature = xDisconnect_signatures[xDisconnect_amatchDisconnect_enum],
  .xDestroy_signature = xDestroy_signatures[xDestroy_amatchDisconnect_enum],
  .xOpen_signature = xOpen_signatures[xOpen_amatchOpen_enum],
  .xClose_signature = xClose_signatures[xClose_amatchClose_enum],
  .xFilter_signature = xFilter_signatures[xFilter_amatchFilter_enum],
  .xNext_signature = xNext_signatures[xNext_amatchNext_enum],
  .xEof_signature = xEof_signatures[xEof_amatchEof_enum],
  .xColumn_signature = xColumn_signatures[xColumn_amatchColumn_enum],
  .xRowid_signature = xRowid_signatures[xRowid_amatchRowid_enum],
  .xUpdate_signature = xUpdate_signatures[xUpdate_amatchUpdate_enum]
};

...
static sqlite3_module spellfix1Module = {
  ...
  0                        /* xIntegrity */
,
  .xCreate_signature = xCreate_signatures[xCreate_spellfix1Create_enum],
  .xConnect_signature = xConnect_signatures[xConnect_spellfix1Connect_enum],
  .xBestIndex_signature = xBestIndex_signatures[xBestIndex_spellfix1BestIndex_enum],
  .xDisconnect_signature = xDisconnect_signatures[xDisconnect_spellfix1Disconnect_enum],
  .xDestroy_signature = xDestroy_signatures[xDestroy_spellfix1Destroy_enum],
  .xOpen_signature = xOpen_signatures[xOpen_spellfix1Open_enum],
  .xClose_signature = xClose_signatures[xClose_spellfix1Close_enum],
  .xFilter_signature = xFilter_signatures[xFilter_spellfix1Filter_enum],
  .xNext_signature = xNext_signatures[xNext_spellfix1Next_enum],
  .xEof_signature = xEof_signatures[xEof_spellfix1Eof_enum],
  .xColumn_signature = xColumn_signatures[xColumn_spellfix1Column_enum],
  .xRowid_signature = xRowid_signatures[xRowid_spellfix1Rowid_enum],
  .xUpdate_signature = xUpdate_signatures[xUpdate_spellfix1Update_enum],
  .xRename_signature = xRename_signatures[xRename_spellfix1Rename_enum]
};

...
static sqlite3_module qpvtabModule = {
  ...
  /* xIntegrity  */ 0
,
  .xConnect_signature = xConnect_signatures[xConnect_qpvtabConnect_enum],
  .xBestIndex_signature = xBestIndex_signatures[xBestIndex_qpvtabBestIndex_enum],
  .xDisconnect_signature = xDisconnect_signatures[xDisconnect_qpvtabDisconnect_enum],
  .xOpen_signature = xOpen_signatures[xOpen_qpvtabOpen_enum],
  .xClose_signature = xClose_signatures[xClose_qpvtabClose_enum],
  .xFilter_signature = xFilter_signatures[xFilter_qpvtabFilter_enum],
  .xNext_signature = xNext_signatures[xNext_qpvtabNext_enum],
  .xEof_signature = xEof_signatures[xEof_qpvtabEof_enum],
  .xColumn_signature = xColumn_signatures[xColumn_qpvtabColumn_enum],
  .xRowid_signature = xRowid_signatures[xRowid_qpvtabRowid_enum]
};

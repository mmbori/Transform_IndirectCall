...
static sqlite3_module closureModule = {
  ...
  0                       /* xIntegrity */
,
  .xCreate_signature = xCreate_signatures[xCreate_closureConnect_enum],
  .xConnect_signature = xConnect_signatures[xConnect_closureConnect_enum],
  .xBestIndex_signature = xBestIndex_signatures[xBestIndex_closureBestIndex_enum],
  .xDisconnect_signature = xDisconnect_signatures[xDisconnect_closureDisconnect_enum],
  .xDestroy_signature = xDestroy_signatures[xDestroy_closureDisconnect_enum],
  .xOpen_signature = xOpen_signatures[xOpen_closureOpen_enum],
  .xClose_signature = xClose_signatures[xClose_closureClose_enum],
  .xFilter_signature = xFilter_signatures[xFilter_closureFilter_enum],
  .xNext_signature = xNext_signatures[xNext_closureNext_enum],
  .xEof_signature = xEof_signatures[xEof_closureEof_enum],
  .xColumn_signature = xColumn_signatures[xColumn_closureColumn_enum],
  .xRowid_signature = xRowid_signatures[xRowid_closureRowid_enum]
};

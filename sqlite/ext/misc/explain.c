...
static sqlite3_module explainModule = {
  ...
  0                          /* xIntegrity */
,
  .xConnect_signature = xConnect_signatures[xConnect_explainConnect_enum],
  .xBestIndex_signature = xBestIndex_signatures[xBestIndex_explainBestIndex_enum],
  .xDisconnect_signature = xDisconnect_signatures[xDisconnect_explainDisconnect_enum],
  .xOpen_signature = xOpen_signatures[xOpen_explainOpen_enum],
  .xClose_signature = xClose_signatures[xClose_explainClose_enum],
  .xFilter_signature = xFilter_signatures[xFilter_explainFilter_enum],
  .xNext_signature = xNext_signatures[xNext_explainNext_enum],
  .xEof_signature = xEof_signatures[xEof_explainEof_enum],
  .xColumn_signature = xColumn_signatures[xColumn_explainColumn_enum],
  .xRowid_signature = xRowid_signatures[xRowid_explainRowid_enum]
};

...
static int createUnionVtab(sqlite3 *db){
  static sqlite3_module unionModule = {
    ...
    0                             /* xIntegrity */
  ,
  .xCreate_signature = xCreate_signatures[xCreate_unionConnect_enum],
  .xConnect_signature = xConnect_signatures[xConnect_unionConnect_enum],
  .xBestIndex_signature = xBestIndex_signatures[xBestIndex_unionBestIndex_enum],
  .xDisconnect_signature = xDisconnect_signatures[xDisconnect_unionDisconnect_enum],
  .xDestroy_signature = xDestroy_signatures[xDestroy_unionDisconnect_enum],
  .xOpen_signature = xOpen_signatures[xOpen_unionOpen_enum],
  .xClose_signature = xClose_signatures[xClose_unionClose_enum],
  .xFilter_signature = xFilter_signatures[xFilter_unionFilter_enum],
  .xNext_signature = xNext_signatures[xNext_unionNext_enum],
  .xEof_signature = xEof_signatures[xEof_unionEof_enum],
  .xColumn_signature = xColumn_signatures[xColumn_unionColumn_enum],
  .xRowid_signature = xRowid_signatures[xRowid_unionRowid_enum]
};
  int rc;

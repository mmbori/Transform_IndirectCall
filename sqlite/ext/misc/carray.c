...
*/
int carrayDisconnect(sqlite3_vtab *pVtab){
  sqlite3_free(pVtab);
  return SQLITE_OK;
}
...
*/
int carrayClose(sqlite3_vtab_cursor *cur){
  sqlite3_free(cur);
  return SQLITE_OK;
}
...
static sqlite3_module carrayModule = {
  ...
  0                          /* xIntegrity */
,
  .xConnect_signature = xConnect_signatures[xConnect_carrayConnect_enum],
  .xBestIndex_signature = xBestIndex_signatures[xBestIndex_carrayBestIndex_enum],
  .xDisconnect_signature = xDisconnect_signatures[xDisconnect_carrayDisconnect_enum],
  .xOpen_signature = xOpen_signatures[xOpen_carrayOpen_enum],
  .xClose_signature = xClose_signatures[xClose_carrayClose_enum],
  .xFilter_signature = xFilter_signatures[xFilter_carrayFilter_enum],
  .xNext_signature = xNext_signatures[xNext_carrayNext_enum],
  .xEof_signature = xEof_signatures[xEof_carrayEof_enum],
  .xColumn_signature = xColumn_signatures[xColumn_carrayColumn_enum],
  .xRowid_signature = xRowid_signatures[xRowid_carrayRowid_enum]
};
...
SQLITE_API int sqlite3_carray_bind(
  ...
  if( xDestroy==SQLITE_TRANSIENT ){
    ...
    pNew->xDel_signature = xDel_signatures[xDel_sqlite3_free_enum];
  }else{
    pNew->aData = aData;
    pNew->xDel = xDestroy;
  }

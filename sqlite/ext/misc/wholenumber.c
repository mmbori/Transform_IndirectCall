...
static sqlite3_module wholenumberModule = {
  ...
  0                          /* xIntegrity */
,
  .xCreate_signature = xCreate_signatures[xCreate_wholenumberConnect_enum],
  .xConnect_signature = xConnect_signatures[xConnect_wholenumberConnect_enum],
  .xBestIndex_signature = xBestIndex_signatures[xBestIndex_wholenumberBestIndex_enum],
  .xDisconnect_signature = xDisconnect_signatures[xDisconnect_wholenumberDisconnect_enum],
  .xDestroy_signature = xDestroy_signatures[xDestroy_wholenumberDisconnect_enum],
  .xOpen_signature = xOpen_signatures[xOpen_wholenumberOpen_enum],
  .xClose_signature = xClose_signatures[xClose_wholenumberClose_enum],
  .xFilter_signature = xFilter_signatures[xFilter_wholenumberFilter_enum],
  .xNext_signature = xNext_signatures[xNext_wholenumberNext_enum],
  .xEof_signature = xEof_signatures[xEof_wholenumberEof_enum],
  .xColumn_signature = xColumn_signatures[xColumn_wholenumberColumn_enum],
  .xRowid_signature = xRowid_signatures[xRowid_wholenumberRowid_enum]
};

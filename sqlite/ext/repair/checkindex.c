...
*/
int cidxDisconnect(sqlite3_vtab *pVtab){
...
*/
int cidxBestIndex(sqlite3_vtab *tab, sqlite3_index_info *pInfo){
  int iIdxName = -1;
  int iAfterKey = -1;
  int i;
...
*/
int cidxClose(sqlite3_vtab_cursor *pCursor){
...
static int ciInit(sqlite3 *db){
  static sqlite3_module cidx_module = {
    ...
    0                             /* xIntegrity */
  ,
  .xConnect_signature = xConnect_signatures[xConnect_cidxConnect_enum],
  .xBestIndex_signature = xBestIndex_signatures[xBestIndex_cidxBestIndex_enum],
  .xDisconnect_signature = xDisconnect_signatures[xDisconnect_cidxDisconnect_enum],
  .xOpen_signature = xOpen_signatures[xOpen_cidxOpen_enum],
  .xClose_signature = xClose_signatures[xClose_cidxClose_enum],
  .xFilter_signature = xFilter_signatures[xFilter_cidxFilter_enum],
  .xNext_signature = xNext_signatures[xNext_cidxNext_enum],
  .xEof_signature = xEof_signatures[xEof_cidxEof_enum],
  .xColumn_signature = xColumn_signatures[xColumn_cidxColumn_enum],
  .xRowid_signature = xRowid_signatures[xRowid_cidxRowid_enum]
};

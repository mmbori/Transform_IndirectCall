...
int sqlite3Fts3InitTerm(sqlite3 *db){
  static const sqlite3_module fts3term_module = {
     ...
     0                            /* xIntegrity    */
  ,
  .xCreate_signature = xCreate_signatures[xCreate_fts3termConnectMethod_enum],
  .xConnect_signature = xConnect_signatures[xConnect_fts3termConnectMethod_enum],
  .xBestIndex_signature = xBestIndex_signatures[xBestIndex_fts3termBestIndexMethod_enum],
  .xDisconnect_signature = xDisconnect_signatures[xDisconnect_fts3termDisconnectMethod_enum],
  .xDestroy_signature = xDestroy_signatures[xDestroy_fts3termDisconnectMethod_enum],
  .xOpen_signature = xOpen_signatures[xOpen_fts3termOpenMethod_enum],
  .xClose_signature = xClose_signatures[xClose_fts3termCloseMethod_enum],
  .xFilter_signature = xFilter_signatures[xFilter_fts3termFilterMethod_enum],
  .xNext_signature = xNext_signatures[xNext_fts3termNextMethod_enum],
  .xEof_signature = xEof_signatures[xEof_fts3termEofMethod_enum],
  .xColumn_signature = xColumn_signatures[xColumn_fts3termColumnMethod_enum],
  .xRowid_signature = xRowid_signatures[xRowid_fts3termRowidMethod_enum]
};
  int rc;                         /* Return code */

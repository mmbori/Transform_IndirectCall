...
exprtest_out:
  if( pTokenizer ){
    if (memcmp(pTokenizer->pModule->xDestroy_signature, xDestroy_signatures[xDestroy_0_enum], sizeof(pTokenizer->pModule->xDestroy_signature)) == 0) {
      ...
      if (memcmp(pTokenizer->pModule->xDestroy_signature, xDestroy_signatures[xDestroy_expertDisconnect_enum], sizeof(pTokenizer->pModule->xDestroy_signature)) == 0) {
        rc = expertDisconnect(pTokenizer);
      }
    else
      ...
      if (memcmp(pTokenizer->pModule->xDestroy_signature, xDestroy_signatures[xDestroy_fts3DestroyMethod_enum], sizeof(pTokenizer->pModule->xDestroy_signature)) == 0) {
        rc = fts3DestroyMethod(pTokenizer);
      }
    else
      if (memcmp(pTokenizer->pModule->xDestroy_signature, xDestroy_signatures[xDestroy_fts3auxDisconnectMethod_enum], sizeof(pTokenizer->pModule->xDestroy_signature)) == 0) {
        rc = fts3auxDisconnectMethod(pTokenizer);
      }
    else
      ...
      if (memcmp(pTokenizer->pModule->xDestroy_signature, xDestroy_signatures[xDestroy_pcachetraceDestroy_enum], sizeof(pTokenizer->pModule->xDestroy_signature)) == 0) {
        rc = pcachetraceDestroy(pTokenizer);
      }
    else
      if (memcmp(pTokenizer->pModule->xDestroy_signature, xDestroy_signatures[xDestroy_porterDestroy_enum], sizeof(pTokenizer->pModule->xDestroy_signature)) == 0) {
        rc = porterDestroy(pTokenizer);
      }
    else
      ...
      if (memcmp(pTokenizer->pModule->xDestroy_signature, xDestroy_signatures[xDestroy_zipfileDisconnect_enum], sizeof(pTokenizer->pModule->xDestroy_signature)) == 0) {
        rc = zipfileDisconnect(pTokenizer);
      }
  }
  sqlite3_free(azCol);
}

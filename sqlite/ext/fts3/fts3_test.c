...
static int SQLITE_TCLAPI fts3_test_tokenizer_cmd(
  ...
  ,
  .xCreate_signature = xCreate_signatures[xCreate_testTokenizerCreate_enum],
  .xDestroy_signature = xDestroy_signatures[xDestroy_testTokenizerDestroy_enum],
  .xOpen_signature = xOpen_signatures[xOpen_testTokenizerOpen_enum],
  .xClose_signature = xClose_signatures[xClose_testTokenizerClose_enum],
  .xNext_signature = xNext_signatures[xNext_testTokenizerNext_enum],
  .xLanguageid_signature = xLanguageid_signatures[xLanguageid_testTokenizerLanguage_enum]
};

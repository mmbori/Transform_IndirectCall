...
static sqlite3_module echoModule = {
  ...
  0                          /* xIntegrity */
,
  .xCreate_signature = xCreate_signatures[xCreate_echoCreate_enum],
  .xConnect_signature = xConnect_signatures[xConnect_echoConnect_enum],
  .xBestIndex_signature = xBestIndex_signatures[xBestIndex_echoBestIndex_enum],
  .xDisconnect_signature = xDisconnect_signatures[xDisconnect_echoDisconnect_enum],
  .xDestroy_signature = xDestroy_signatures[xDestroy_echoDestroy_enum],
  .xOpen_signature = xOpen_signatures[xOpen_echoOpen_enum],
  .xClose_signature = xClose_signatures[xClose_echoClose_enum],
  .xFilter_signature = xFilter_signatures[xFilter_echoFilter_enum],
  .xNext_signature = xNext_signatures[xNext_echoNext_enum],
  .xEof_signature = xEof_signatures[xEof_echoEof_enum],
  .xColumn_signature = xColumn_signatures[xColumn_echoColumn_enum],
  .xRowid_signature = xRowid_signatures[xRowid_echoRowid_enum],
  .xUpdate_signature = xUpdate_signatures[xUpdate_echoUpdate_enum],
  .xBegin_signature = xBegin_signatures[xBegin_echoBegin_enum],
  .xSync_signature = xSync_signatures[xSync_echoSync_enum],
  .xCommit_signature = xCommit_signatures[xCommit_echoCommit_enum],
  .xRollback_signature = xRollback_signatures[xRollback_echoRollback_enum],
  .xFindFunction_signature = xFindFunction_signatures[xFindFunction_echoFindFunction_enum],
  .xRename_signature = xRename_signatures[xRename_echoRename_enum]
};
...
,
  ...
  .xFindFunction_signature = xFindFunction_signatures[xFindFunction_echoFindFunction_enum],
  .xRename_signature = xRename_signatures[xRename_echoRename_enum],
  .xSavepoint_signature = xSavepoint_signatures[xSavepoint_echoSavepoint_enum],
  .xRelease_signature = xRelease_signatures[xRelease_echoRelease_enum],
  .xRollbackTo_signature = xRollbackTo_signatures[xRollbackTo_echoRollbackTo_enum]
};

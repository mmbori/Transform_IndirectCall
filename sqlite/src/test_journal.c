...
*/
int jtClose(sqlite3_file*);
int jtRead(sqlite3_file*, void*, int iAmt, sqlite3_int64 iOfst);
int jtWrite(sqlite3_file*,const void*,int iAmt, sqlite3_int64 iOfst);
int jtTruncate(sqlite3_file*, sqlite3_int64 size);
int jtSync(sqlite3_file*, int flags);
int jtFileSize(sqlite3_file*, sqlite3_int64 *pSize);
int jtLock(sqlite3_file*, int);
int jtUnlock(sqlite3_file*, int);
int jtCheckReservedLock(sqlite3_file*, int *);
int jtFileControl(sqlite3_file*, int op, void *pArg);
int jtSectorSize(sqlite3_file*);
int jtDeviceCharacteristics(sqlite3_file*);

/*
** Method declarations for jt_vfs.
*/
int jtOpen(sqlite3_vfs*, const char *, sqlite3_file*, int , int *);
int jtDelete(sqlite3_vfs*, const char *zName, int syncDir);
int jtAccess(sqlite3_vfs*, const char *zName, int flags, int *);
int jtFullPathname(sqlite3_vfs*, const char *zName, int, char *zOut);
void *jtDlOpen(sqlite3_vfs*, const char *zFilename);
void jtDlError(sqlite3_vfs*, int nByte, char *zErrMsg);
void (*jtDlSym(sqlite3_vfs*,void*, const char *zSymbol))(void);
void jtDlClose(sqlite3_vfs*, void*);
int jtRandomness(sqlite3_vfs*, int nByte, char *zOut);
int jtSleep(sqlite3_vfs*, int microseconds);
int jtCurrentTime(sqlite3_vfs*, double*);
int jtCurrentTimeInt64(sqlite3_vfs*, sqlite3_int64*);
int jtGetLastError(sqlite3_vfs*, int, char*);
...
,
  .xOpen_signature = xOpen_signatures[xOpen_jtOpen_enum],
  .xDelete_signature = xDelete_signatures[xDelete_jtDelete_enum],
  .xAccess_signature = xAccess_signatures[xAccess_jtAccess_enum],
  .xFullPathname_signature = xFullPathname_signatures[xFullPathname_jtFullPathname_enum],
  .xDlOpen_signature = xDlOpen_signatures[xDlOpen_jtDlOpen_enum],
  .xDlError_signature = xDlError_signatures[xDlError_jtDlError_enum],
  .xDlSym_signature = xDlSym_signatures[xDlSym_jtDlSym_enum],
  .xDlClose_signature = xDlClose_signatures[xDlClose_jtDlClose_enum],
  .xRandomness_signature = xRandomness_signatures[xRandomness_jtRandomness_enum],
  .xSleep_signature = xSleep_signatures[xSleep_jtSleep_enum],
  .xCurrentTime_signature = xCurrentTime_signatures[xCurrentTime_jtCurrentTime_enum],
  .xGetLastError_signature = xGetLastError_signatures[xGetLastError_jtGetLastError_enum],
  .xCurrentTimeInt64_signature = xCurrentTimeInt64_signatures[xCurrentTimeInt64_jtCurrentTimeInt64_enum]
};
...
,
  .xClose_signature = xClose_signatures[xClose_jtClose_enum],
  .xRead_signature = xRead_signatures[xRead_jtRead_enum],
  .xWrite_signature = xWrite_signatures[xWrite_jtWrite_enum],
  .xTruncate_signature = xTruncate_signatures[xTruncate_jtTruncate_enum],
  .xSync_signature = xSync_signatures[xSync_jtSync_enum],
  .xFileSize_signature = xFileSize_signatures[xFileSize_jtFileSize_enum],
  .xLock_signature = xLock_signatures[xLock_jtLock_enum],
  .xUnlock_signature = xUnlock_signatures[xUnlock_jtUnlock_enum],
  .xCheckReservedLock_signature = xCheckReservedLock_signatures[xCheckReservedLock_jtCheckReservedLock_enum],
  .xFileControl_signature = xFileControl_signatures[xFileControl_jtFileControl_enum],
  .xSectorSize_signature = xSectorSize_signatures[xSectorSize_jtSectorSize_enum],
  .xDeviceCharacteristics_signature = xDeviceCharacteristics_signatures[xDeviceCharacteristics_jtDeviceCharacteristics_enum]
};
...
** Close an jt-file.
*/
int jtClose(sqlite3_file *pFile){
  jt_file **pp;
...
*/
int openTransaction(jt_file *pMain, jt_file *pJournal){
  unsigned char *aData;
...
** Truncate an jt-file.
*/
int jtTruncate(sqlite3_file *pFile, sqlite_int64 size){
  jt_file *p = (jt_file *)pFile;
...
** Sync an jt-file.
*/
int jtSync(sqlite3_file *pFile, int flags){
  jt_file *p = (jt_file *)pFile;
...
*/
int jtFileSize(sqlite3_file *pFile, sqlite_int64 *pSize){
  jt_file *p = (jt_file *)pFile;
...
** Lock an jt-file.
*/
int jtLock(sqlite3_file *pFile, int eLock){
  int rc;
  jt_file *p = (jt_file *)pFile;
...
** Unlock an jt-file.
*/
int jtUnlock(sqlite3_file *pFile, int eLock){
  int rc;
  jt_file *p = (jt_file *)pFile;
...
*/
int jtCheckReservedLock(sqlite3_file *pFile, int *pResOut){
  jt_file *p = (jt_file *)pFile;
...
*/
int jtFileControl(sqlite3_file *pFile, int op, void *pArg){
  jt_file *p = (jt_file *)pFile;
  if (memcmp(p->pReal->pMethods->xFileControl_signature, xFileControl_signatures[xFileControl_0_enum], sizeof(p->pReal->pMethods->xFileControl_signature)) == 0) {
    ...
    if (memcmp(p->pReal->pMethods->xFileControl_signature, xFileControl_signatures[xFileControl_apndFileControl_enum], sizeof(p->pReal->pMethods->xFileControl_signature)) == 0) {
      return apndFileControl(p->pReal, op, pArg);
    }
  else
    if (memcmp(p->pReal->pMethods->xFileControl_signature, xFileControl_signatures[xFileControl_memdbFileControl_enum], sizeof(p->pReal->pMethods->xFileControl_signature)) == 0) {
      return memdbFileControl(p->pReal, op, pArg);
    }
  else
    if (memcmp(p->pReal->pMethods->xFileControl_signature, xFileControl_signatures[xFileControl_recoverVfsFileControl_enum], sizeof(p->pReal->pMethods->xFileControl_signature)) == 0) {
      return recoverVfsFileControl(p->pReal, op, pArg);
    }
  else
    if (memcmp(p->pReal->pMethods->xFileControl_signature, xFileControl_signatures[xFileControl_vfstraceFileControl_enum], sizeof(p->pReal->pMethods->xFileControl_signature)) == 0) {
      return vfstraceFileControl(p->pReal, op, pArg);
    }
  else
    if (memcmp(p->pReal->pMethods->xFileControl_signature, xFileControl_signatures[xFileControl_unixFileControl_enum], sizeof(p->pReal->pMethods->xFileControl_signature)) == 0) {
      return unixFileControl(p->pReal, op, pArg);
    }
}
...
*/
int jtSectorSize(sqlite3_file *pFile){
  jt_file *p = (jt_file *)pFile;
...
*/
int jtDeviceCharacteristics(sqlite3_file *pFile){
  jt_file *p = (jt_file *)pFile;
...
** returning.
*/
int jtDelete(sqlite3_vfs *pVfs, const char *zPath, int dirSync){
...
*/
void *jtDlOpen(sqlite3_vfs *pVfs, const char *zPath){
  if (memcmp(g.pVfs->xDlOpen_signature, xDlOpen_signatures[xDlOpen_apndDlOpen_enum], sizeof(g.pVfs->xDlOpen_signature)) == 0) {
    return apndDlOpen(g.pVfs, zPath);
  }
  else
    if (memcmp(g.pVfs->xDlOpen_signature, xDlOpen_signatures[xDlOpen_memdbDlOpen_enum], sizeof(g.pVfs->xDlOpen_signature)) == 0) {
      return memdbDlOpen(g.pVfs, zPath);
    }
  else
    if (memcmp(g.pVfs->xDlOpen_signature, xDlOpen_signatures[xDlOpen_unixDlOpen_enum], sizeof(g.pVfs->xDlOpen_signature)) == 0) {
      return unixDlOpen(g.pVfs, zPath);
    }
}
...
*/
void jtDlError(sqlite3_vfs *pVfs, int nByte, char *zErrMsg){
  if (memcmp(g.pVfs->xDlError_signature, xDlError_signatures[xDlError_0_enum], sizeof(g.pVfs->xDlError_signature)) == 0) {
    0;
  }
  else
    if (memcmp(g.pVfs->xDlError_signature, xDlError_signatures[xDlError_apndDlError_enum], sizeof(g.pVfs->xDlError_signature)) == 0) {
      apndDlError(g.pVfs, nByte, zErrMsg);
    }
  else
    if (memcmp(g.pVfs->xDlError_signature, xDlError_signatures[xDlError_memdbDlError_enum], sizeof(g.pVfs->xDlError_signature)) == 0) {
      memdbDlError(g.pVfs, nByte, zErrMsg);
    }
  else
    if (memcmp(g.pVfs->xDlError_signature, xDlError_signatures[xDlError_unixDlError_enum], sizeof(g.pVfs->xDlError_signature)) == 0) {
      unixDlError(g.pVfs, nByte, zErrMsg);
    }
}
...
*/
void (*jtDlSym(sqlite3_vfs *pVfs, void *p, const char *zSym))(void){
...
*/
void jtDlClose(sqlite3_vfs *pVfs, void *pHandle){
  if (memcmp(g.pVfs->xDlClose_signature, xDlClose_signatures[xDlClose_0_enum], sizeof(g.pVfs->xDlClose_signature)) == 0) {
    0;
  }
  else
    if (memcmp(g.pVfs->xDlClose_signature, xDlClose_signatures[xDlClose_apndDlClose_enum], sizeof(g.pVfs->xDlClose_signature)) == 0) {
      apndDlClose(g.pVfs, pHandle);
    }
  else
    if (memcmp(g.pVfs->xDlClose_signature, xDlClose_signatures[xDlClose_memdbDlClose_enum], sizeof(g.pVfs->xDlClose_signature)) == 0) {
      memdbDlClose(g.pVfs, pHandle);
    }
  else
    if (memcmp(g.pVfs->xDlClose_signature, xDlClose_signatures[xDlClose_unixDlClose_enum], sizeof(g.pVfs->xDlClose_signature)) == 0) {
      unixDlClose(g.pVfs, pHandle);
    }
}
...
** random data.
*/
int jtRandomness(sqlite3_vfs *pVfs, int nByte, char *zBufOut){
...
** actually slept.
*/
int jtSleep(sqlite3_vfs *pVfs, int nMicro){
...
*/
int jtCurrentTime(sqlite3_vfs *pVfs, double *pTimeOut){
...
** Return the current time as a Julian Day number in *pTimeOut.
*/
int jtCurrentTimeInt64(sqlite3_vfs *pVfs, sqlite3_int64 *pTimeOut){
  if (memcmp(g.pVfs->xCurrentTimeInt64_signature, xCurrentTimeInt64_signatures[xCurrentTimeInt64_0_enum], sizeof(g.pVfs->xCurrentTimeInt64_signature)) == 0) {
    return 0;
  }
  else
    if (memcmp(g.pVfs->xCurrentTimeInt64_signature, xCurrentTimeInt64_signatures[xCurrentTimeInt64_apndCurrentTimeInt64_enum], sizeof(g.pVfs->xCurrentTimeInt64_signature)) == 0) {
      return apndCurrentTimeInt64(g.pVfs, pTimeOut);
    }
  else
    if (memcmp(g.pVfs->xCurrentTimeInt64_signature, xCurrentTimeInt64_signatures[xCurrentTimeInt64_memdbCurrentTimeInt64_enum], sizeof(g.pVfs->xCurrentTimeInt64_signature)) == 0) {
      return memdbCurrentTimeInt64(g.pVfs, pTimeOut);
    }
  else
    if (memcmp(g.pVfs->xCurrentTimeInt64_signature, xCurrentTimeInt64_signatures[xCurrentTimeInt64_unixCurrentTimeInt64_enum], sizeof(g.pVfs->xCurrentTimeInt64_signature)) == 0) {
      return unixCurrentTimeInt64(g.pVfs, pTimeOut);
    }
}

int jtGetLastError(sqlite3_vfs *pVfs, int n, char *z){
  if (memcmp(g.pVfs->xGetLastError_signature, xGetLastError_signatures[xGetLastError_0_enum], sizeof(g.pVfs->xGetLastError_signature)) == 0) {
    return 0;
  }
  else
    if (memcmp(g.pVfs->xGetLastError_signature, xGetLastError_signatures[xGetLastError_apndGetLastError_enum], sizeof(g.pVfs->xGetLastError_signature)) == 0) {
      return apndGetLastError(g.pVfs, n, z);
    }
  else
    if (memcmp(g.pVfs->xGetLastError_signature, xGetLastError_signatures[xGetLastError_memdbGetLastError_enum], sizeof(g.pVfs->xGetLastError_signature)) == 0) {
      return memdbGetLastError(g.pVfs, n, z);
    }
  else
    if (memcmp(g.pVfs->xGetLastError_signature, xGetLastError_signatures[xGetLastError_unixGetLastError_enum], sizeof(g.pVfs->xGetLastError_signature)) == 0) {
      return unixGetLastError(g.pVfs, n, z);
    }
}
...
int jt_register(char *zWrap, int isDefault){
  ...
  if( g.pVfs->iVersion==1 ){
    ...
    jt_vfs.xCurrentTimeInt64_signature = xCurrentTimeInt64_signatures[xCurrentTimeInt64_0_enum];
  }

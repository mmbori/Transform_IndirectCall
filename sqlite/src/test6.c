...
int cfShmLock(sqlite3_file *pFile, int ofst, int n, int flags){
  ...
  if (memcmp(pReal->pMethods->xShmLock_signature, xShmLock_signatures[xShmLock_0_enum], sizeof(pReal->pMethods->xShmLock_signature)) == 0) {
    return 0;
  }
  else
    if (memcmp(pReal->pMethods->xShmLock_signature, xShmLock_signatures[xShmLock_apndShmLock_enum], sizeof(pReal->pMethods->xShmLock_signature)) == 0) {
      return apndShmLock(pReal, ofst, n, flags);
    }
  else
    if (memcmp(pReal->pMethods->xShmLock_signature, xShmLock_signatures[xShmLock_recoverVfsShmLock_enum], sizeof(pReal->pMethods->xShmLock_signature)) == 0) {
      return recoverVfsShmLock(pReal, ofst, n, flags);
    }
  else
    if (memcmp(pReal->pMethods->xShmLock_signature, xShmLock_signatures[xShmLock_unixShmLock_enum], sizeof(pReal->pMethods->xShmLock_signature)) == 0) {
      return unixShmLock(pReal, ofst, n, flags);
    }
}
void cfShmBarrier(sqlite3_file *pFile){
  sqlite3_file *pReal = ((CrashFile*)pFile)->pRealFile;
  if (memcmp(pReal->pMethods->xShmBarrier_signature, xShmBarrier_signatures[xShmBarrier_0_enum], sizeof(pReal->pMethods->xShmBarrier_signature)) == 0) {
    0;
  }
  else
    if (memcmp(pReal->pMethods->xShmBarrier_signature, xShmBarrier_signatures[xShmBarrier_apndShmBarrier_enum], sizeof(pReal->pMethods->xShmBarrier_signature)) == 0) {
      apndShmBarrier(pReal);
    }
  else
    if (memcmp(pReal->pMethods->xShmBarrier_signature, xShmBarrier_signatures[xShmBarrier_recoverVfsShmBarrier_enum], sizeof(pReal->pMethods->xShmBarrier_signature)) == 0) {
      recoverVfsShmBarrier(pReal);
    }
  else
    if (memcmp(pReal->pMethods->xShmBarrier_signature, xShmBarrier_signatures[xShmBarrier_unixShmBarrier_enum], sizeof(pReal->pMethods->xShmBarrier_signature)) == 0) {
      unixShmBarrier(pReal);
    }
}
int cfShmUnmap(sqlite3_file *pFile, int delFlag){
  sqlite3_file *pReal = ((CrashFile*)pFile)->pRealFile;
  if (memcmp(pReal->pMethods->xShmUnmap_signature, xShmUnmap_signatures[xShmUnmap_0_enum], sizeof(pReal->pMethods->xShmUnmap_signature)) == 0) {
    return 0;
  }
  else
    if (memcmp(pReal->pMethods->xShmUnmap_signature, xShmUnmap_signatures[xShmUnmap_apndShmUnmap_enum], sizeof(pReal->pMethods->xShmUnmap_signature)) == 0) {
      return apndShmUnmap(pReal, delFlag);
    }
  else
    if (memcmp(pReal->pMethods->xShmUnmap_signature, xShmUnmap_signatures[xShmUnmap_recoverVfsShmUnmap_enum], sizeof(pReal->pMethods->xShmUnmap_signature)) == 0) {
      return recoverVfsShmUnmap(pReal, delFlag);
    }
  else
    if (memcmp(pReal->pMethods->xShmUnmap_signature, xShmUnmap_signatures[xShmUnmap_unixShmUnmap_enum], sizeof(pReal->pMethods->xShmUnmap_signature)) == 0) {
      return unixShmUnmap(pReal, delFlag);
    }
}
int cfShmMap(
  ...
  sqlite3_file *pReal = ((CrashFile*)pFile)->pRealFile;
  if (memcmp(pReal->pMethods->xShmMap_signature, xShmMap_signatures[xShmMap_0_enum], sizeof(pReal->pMethods->xShmMap_signature)) == 0) {
    return 0;
  }
  else
    if (memcmp(pReal->pMethods->xShmMap_signature, xShmMap_signatures[xShmMap_apndShmMap_enum], sizeof(pReal->pMethods->xShmMap_signature)) == 0) {
      return apndShmMap(pReal, iRegion, sz, w, pp);
    }
  else
    if (memcmp(pReal->pMethods->xShmMap_signature, xShmMap_signatures[xShmMap_recoverVfsShmMap_enum], sizeof(pReal->pMethods->xShmMap_signature)) == 0) {
      return recoverVfsShmMap(pReal, iRegion, sz, w, pp);
    }
  else
    if (memcmp(pReal->pMethods->xShmMap_signature, xShmMap_signatures[xShmMap_unixShmMap_enum], sizeof(pReal->pMethods->xShmMap_signature)) == 0) {
      return unixShmMap(pReal, iRegion, sz, w, pp);
    }
}
...
,
  .xClose_signature = xClose_signatures[xClose_cfClose_enum],
  .xRead_signature = xRead_signatures[xRead_cfRead_enum],
  .xWrite_signature = xWrite_signatures[xWrite_cfWrite_enum],
  .xTruncate_signature = xTruncate_signatures[xTruncate_cfTruncate_enum],
  .xSync_signature = xSync_signatures[xSync_cfSync_enum],
  .xFileSize_signature = xFileSize_signatures[xFileSize_cfFileSize_enum],
  .xLock_signature = xLock_signatures[xLock_cfLock_enum],
  .xUnlock_signature = xUnlock_signatures[xUnlock_cfUnlock_enum],
  .xCheckReservedLock_signature = xCheckReservedLock_signatures[xCheckReservedLock_cfCheckReservedLock_enum],
  .xFileControl_signature = xFileControl_signatures[xFileControl_cfFileControl_enum],
  .xSectorSize_signature = xSectorSize_signatures[xSectorSize_cfSectorSize_enum],
  .xDeviceCharacteristics_signature = xDeviceCharacteristics_signatures[xDeviceCharacteristics_cfDeviceCharacteristics_enum],
  .xShmMap_signature = xShmMap_signatures[xShmMap_cfShmMap_enum],
  .xShmLock_signature = xShmLock_signatures[xShmLock_cfShmLock_enum],
  .xShmBarrier_signature = xShmBarrier_signatures[xShmBarrier_cfShmBarrier_enum],
  .xShmUnmap_signature = xShmUnmap_signatures[xShmUnmap_cfShmUnmap_enum]
};
...
int cfCurrentTime(sqlite3_vfs *pCfVfs, double *pTimeOut){
  ...
  if (memcmp(pVfs->xCurrentTime_signature, xCurrentTime_signatures[xCurrentTime_0_enum], sizeof(pVfs->xCurrentTime_signature)) == 0) {
    ...
    if (memcmp(pVfs->xCurrentTime_signature, xCurrentTime_signatures[xCurrentTime_apndCurrentTime_enum], sizeof(pVfs->xCurrentTime_signature)) == 0) {
      return apndCurrentTime(pVfs, pTimeOut);
    }
  else
    if (memcmp(pVfs->xCurrentTime_signature, xCurrentTime_signatures[xCurrentTime_vfstraceCurrentTime_enum], sizeof(pVfs->xCurrentTime_signature)) == 0) {
      return vfstraceCurrentTime(pVfs, pTimeOut);
    }
  else
    if (memcmp(pVfs->xCurrentTime_signature, xCurrentTime_signatures[xCurrentTime_unixCurrentTime_enum], sizeof(pVfs->xCurrentTime_signature)) == 0) {
      return unixCurrentTime(pVfs, pTimeOut);
    }
}
int cfGetLastError(sqlite3_vfs *pCfVfs, int n, char *z){
  ...
  if (memcmp(pVfs->xGetLastError_signature, xGetLastError_signatures[xGetLastError_0_enum], sizeof(pVfs->xGetLastError_signature)) == 0) {
    ...
    if (memcmp(pVfs->xGetLastError_signature, xGetLastError_signatures[xGetLastError_apndGetLastError_enum], sizeof(pVfs->xGetLastError_signature)) == 0) {
      return apndGetLastError(pVfs, n, z);
    }
  else
    if (memcmp(pVfs->xGetLastError_signature, xGetLastError_signatures[xGetLastError_memdbGetLastError_enum], sizeof(pVfs->xGetLastError_signature)) == 0) {
      return memdbGetLastError(pVfs, n, z);
    }
  else
    if (memcmp(pVfs->xGetLastError_signature, xGetLastError_signatures[xGetLastError_unixGetLastError_enum], sizeof(pVfs->xGetLastError_signature)) == 0) {
      return unixGetLastError(pVfs, n, z);
    }
}
...
static int SQLITE_TCLAPI crashEnableCmd(
  ...
  static sqlite3_vfs crashVfs = {
    ...
    0,                    /* xCurrentTimeInt64 */
  ,
  .xOpen_signature = xOpen_signatures[xOpen_cfOpen_enum],
  .xDelete_signature = xDelete_signatures[xDelete_cfDelete_enum],
  .xAccess_signature = xAccess_signatures[xAccess_cfAccess_enum],
  .xFullPathname_signature = xFullPathname_signatures[xFullPathname_cfFullPathname_enum],
  .xDlOpen_signature = xDlOpen_signatures[xDlOpen_cfDlOpen_enum],
  .xDlError_signature = xDlError_signatures[xDlError_cfDlError_enum],
  .xDlSym_signature = xDlSym_signatures[xDlSym_cfDlSym_enum],
  .xDlClose_signature = xDlClose_signatures[xDlClose_cfDlClose_enum],
  .xRandomness_signature = xRandomness_signatures[xRandomness_cfRandomness_enum],
  .xSleep_signature = xSleep_signatures[xSleep_cfSleep_enum],
  .xCurrentTime_signature = xCurrentTime_signatures[xCurrentTime_cfCurrentTime_enum],
  .xGetLastError_signature = xGetLastError_signatures[xGetLastError_cfGetLastError_enum]
};

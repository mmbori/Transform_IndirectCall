...
void installTestPCache(
  ...
  .xInit_signature = xInit_signatures[xInit_testpcacheInit_enum],
  .xShutdown_signature = xShutdown_signatures[xShutdown_testpcacheShutdown_enum],
  .xCreate_signature = xCreate_signatures[xCreate_testpcacheCreate_enum],
  .xCachesize_signature = xCachesize_signatures[xCachesize_testpcacheCachesize_enum],
  .xPagecount_signature = xPagecount_signatures[xPagecount_testpcachePagecount_enum],
  .xFetch_signature = xFetch_signatures[xFetch_testpcacheFetch_enum],
  .xUnpin_signature = xUnpin_signatures[xUnpin_testpcacheUnpin_enum],
  .xRekey_signature = xRekey_signatures[xRekey_testpcacheRekey_enum],
  .xTruncate_signature = xTruncate_signatures[xTruncate_testpcacheTruncate_enum],
  .xDestroy_signature = xDestroy_signatures[xDestroy_testpcacheDestroy_enum]
};

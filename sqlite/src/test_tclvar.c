...
static sqlite3_module tclvarModule = {
  ...
  0                            /* xIntegrity */
,
  .xCreate_signature = xCreate_signatures[xCreate_tclvarConnect_enum],
  .xConnect_signature = xConnect_signatures[xConnect_tclvarConnect_enum],
  .xBestIndex_signature = xBestIndex_signatures[xBestIndex_tclvarBestIndex_enum],
  .xDisconnect_signature = xDisconnect_signatures[xDisconnect_tclvarDisconnect_enum],
  .xDestroy_signature = xDestroy_signatures[xDestroy_tclvarDisconnect_enum],
  .xOpen_signature = xOpen_signatures[xOpen_tclvarOpen_enum],
  .xClose_signature = xClose_signatures[xClose_tclvarClose_enum],
  .xFilter_signature = xFilter_signatures[xFilter_tclvarFilter_enum],
  .xNext_signature = xNext_signatures[xNext_tclvarNext_enum],
  .xEof_signature = xEof_signatures[xEof_tclvarEof_enum],
  .xColumn_signature = xColumn_signatures[xColumn_tclvarColumn_enum],
  .xRowid_signature = xRowid_signatures[xRowid_tclvarRowid_enum],
  .xUpdate_signature = xUpdate_signatures[xUpdate_tclvarUpdate_enum]
};

...
static sqlite3_module schemaModule = {
  ...
  0                            /* xIntegrity */
,
  .xCreate_signature = xCreate_signatures[xCreate_schemaCreate_enum],
  .xConnect_signature = xConnect_signatures[xConnect_schemaCreate_enum],
  .xBestIndex_signature = xBestIndex_signatures[xBestIndex_schemaBestIndex_enum],
  .xDisconnect_signature = xDisconnect_signatures[xDisconnect_schemaDestroy_enum],
  .xDestroy_signature = xDestroy_signatures[xDestroy_schemaDestroy_enum],
  .xOpen_signature = xOpen_signatures[xOpen_schemaOpen_enum],
  .xClose_signature = xClose_signatures[xClose_schemaClose_enum],
  .xFilter_signature = xFilter_signatures[xFilter_schemaFilter_enum],
  .xNext_signature = xNext_signatures[xNext_schemaNext_enum],
  .xEof_signature = xEof_signatures[xEof_schemaEof_enum],
  .xColumn_signature = xColumn_signatures[xColumn_schemaColumn_enum],
  .xRowid_signature = xRowid_signatures[xRowid_schemaRowid_enum]
};

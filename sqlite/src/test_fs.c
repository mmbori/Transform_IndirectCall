...
static sqlite3_module fsModule = {
  ...
  0                            /* xIntegrity */
,
  .xCreate_signature = xCreate_signatures[xCreate_fsConnect_enum],
  .xConnect_signature = xConnect_signatures[xConnect_fsConnect_enum],
  .xBestIndex_signature = xBestIndex_signatures[xBestIndex_fsBestIndex_enum],
  .xDisconnect_signature = xDisconnect_signatures[xDisconnect_fsDisconnect_enum],
  .xDestroy_signature = xDestroy_signatures[xDestroy_fsDisconnect_enum],
  .xOpen_signature = xOpen_signatures[xOpen_fsOpen_enum],
  .xClose_signature = xClose_signatures[xClose_fsClose_enum],
  .xFilter_signature = xFilter_signatures[xFilter_fsFilter_enum],
  .xNext_signature = xNext_signatures[xNext_fsNext_enum],
  .xEof_signature = xEof_signatures[xEof_fsEof_enum],
  .xColumn_signature = xColumn_signatures[xColumn_fsColumn_enum],
  .xRowid_signature = xRowid_signatures[xRowid_fsRowid_enum]
};
...
static sqlite3_module fsdirModule = {
  ...
  0                               /* xIntegrity */
,
  .xCreate_signature = xCreate_signatures[xCreate_fsdirConnect_enum],
  ...
  .xDestroy_signature = xDestroy_signatures[xDestroy_fsdirDisconnect_enum],
...
static sqlite3_module fstreeModule = {
  ...
  0                               /* xIntegrity */
,
  .xCreate_signature = xCreate_signatures[xCreate_fstreeConnect_enum],
  .xConnect_signature = xConnect_signatures[xConnect_fstreeConnect_enum],
  .xBestIndex_signature = xBestIndex_signatures[xBestIndex_fstreeBestIndex_enum],
  .xDisconnect_signature = xDisconnect_signatures[xDisconnect_fstreeDisconnect_enum],
  .xDestroy_signature = xDestroy_signatures[xDestroy_fstreeDisconnect_enum],
  .xOpen_signature = xOpen_signatures[xOpen_fstreeOpen_enum],
  .xClose_signature = xClose_signatures[xClose_fstreeClose_enum],
  .xFilter_signature = xFilter_signatures[xFilter_fstreeFilter_enum],
  .xNext_signature = xNext_signatures[xNext_fstreeNext_enum],
  .xEof_signature = xEof_signatures[xEof_fstreeEof_enum],
  .xColumn_signature = xColumn_signatures[xColumn_fstreeColumn_enum],
  .xRowid_signature = xRowid_signatures[xRowid_fstreeRowid_enum]
};

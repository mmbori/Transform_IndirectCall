  ...
  *rc = multiplexSubFilename(pGroup, iChunk);
  if( (*rc)==SQLITE_OK && (pSubOpen = pGroup->aReal[iChunk].p)==0 ){
    ...
    if( createFlag ){
      ...
      if (memcmp(pOrigVfs->xAccess_signature, xAccess_signatures[xAccess_apndAccess_enum], sizeof(pOrigVfs->xAccess_signature)) == 0) {
        *rc = apndAccess(pOrigVfs, pGroup->aReal[iChunk].z,
                         SQLITE_ACCESS_EXISTS, &bExists);
      }
      else
        if (memcmp(pOrigVfs->xAccess_signature, xAccess_signatures[xAccess_memdbAccess_enum], sizeof(pOrigVfs->xAccess_signature)) == 0) {
          *rc = memdbAccess(pOrigVfs, pGroup->aReal[iChunk].z,
                            SQLITE_ACCESS_EXISTS, &bExists);
        }
      else
        if (memcmp(pOrigVfs->xAccess_signature, xAccess_signatures[xAccess_vfstraceAccess_enum], sizeof(pOrigVfs->xAccess_signature)) == 0) {
          *rc = vfstraceAccess(pOrigVfs, pGroup->aReal[iChunk].z,
                               SQLITE_ACCESS_EXISTS, &bExists);
        }
     else
        if (memcmp(pOrigVfs->xAccess_signature, xAccess_signatures[xAccess_unixAccess_enum], sizeof(pOrigVfs->xAccess_signature)) == 0) {
          *rc = unixAccess(pOrigVfs, pGroup->aReal[iChunk].z,
                           SQLITE_ACCESS_EXISTS, &bExists);
        }
     if( *rc || !bExists ){
        if( *rc ){
...
sqlite3_int64 multiplexSubSize(
  ...
  if( pSub==0 ) return 0;
  if (memcmp(pSub->pMethods->xFileSize_signature, xFileSize_signatures[xFileSize_apndFileSize_enum], sizeof(pSub->pMethods->xFileSize_signature)) == 0) {
    *rc = apndFileSize(pSub, &sz);
  }
  else
    if (memcmp(pSub->pMethods->xFileSize_signature, xFileSize_signatures[xFileSize_memdbFileSize_enum], sizeof(pSub->pMethods->xFileSize_signature)) == 0) {
      *rc = memdbFileSize(pSub, &sz);
    }
  else
    if (memcmp(pSub->pMethods->xFileSize_signature, xFileSize_signatures[xFileSize_memjrnlFileSize_enum], sizeof(pSub->pMethods->xFileSize_signature)) == 0) {
      *rc = memjrnlFileSize(pSub, &sz);
    }
  else
    if (memcmp(pSub->pMethods->xFileSize_signature, xFileSize_signatures[xFileSize_recoverVfsFileSize_enum], sizeof(pSub->pMethods->xFileSize_signature)) == 0) {
      *rc = recoverVfsFileSize(pSub, &sz);
    }
  else
    if (memcmp(pSub->pMethods->xFileSize_signature, xFileSize_signatures[xFileSize_vfstraceFileSize_enum], sizeof(pSub->pMethods->xFileSize_signature)) == 0) {
      *rc = vfstraceFileSize(pSub, &sz);
    }
  else
    if (memcmp(pSub->pMethods->xFileSize_signature, xFileSize_signatures[xFileSize_unixFileSize_enum], sizeof(pSub->pMethods->xFileSize_signature)) == 0) {
      *rc = unixFileSize(pSub, &sz);
    }
  return sz;
}  
    ...
    if( pOrigVfs && pGroup->aReal[iChunk].z ){
      if (memcmp(pOrigVfs->xDelete_signature, xDelete_signatures[xDelete_0_enum], sizeof(pOrigVfs->xDelete_signature)) == 0) {
        ...
        if (memcmp(pOrigVfs->xDelete_signature, xDelete_signatures[xDelete_apndDelete_enum], sizeof(pOrigVfs->xDelete_signature)) == 0) {
          apndDelete(pOrigVfs, pGroup->aReal[iChunk].z, 0);
        }
      else
        if (memcmp(pOrigVfs->xDelete_signature, xDelete_signatures[xDelete_f5tOrigintextDelete_enum], sizeof(pOrigVfs->xDelete_signature)) == 0) {
          f5tOrigintextDelete(pOrigVfs, pGroup->aReal[iChunk].z, 0);
        }
      else
    ...
    if( rc==SQLITE_OK ){
      ...
      if (memcmp(pSubOpen->pMethods->xFileSize_signature, xFileSize_signatures[xFileSize_apndFileSize_enum], sizeof(pSubOpen->pMethods->xFileSize_signature)) == 0) {
        ...
        if (memcmp(pSubOpen->pMethods->xFileSize_signature, xFileSize_signatures[xFileSize_memdbFileSize_enum], sizeof(pSubOpen->pMethods->xFileSize_signature)) == 0) {
          rc = memdbFileSize(pSubOpen, &sz64);
        }
      else
        if (memcmp(pSubOpen->pMethods->xFileSize_signature, xFileSize_signatures[xFileSize_memjrnlFileSize_enum], sizeof(pSubOpen->pMethods->xFileSize_signature)) == 0) {
          rc = memjrnlFileSize(pSubOpen, &sz64);
        }
      else
        if (memcmp(pSubOpen->pMethods->xFileSize_signature, xFileSize_signatures[xFileSize_recoverVfsFileSize_enum], sizeof(pSubOpen->pMethods->xFileSize_signature)) == 0) {
          rc = recoverVfsFileSize(pSubOpen, &sz64);
        }
      else
        if (memcmp(pSubOpen->pMethods->xFileSize_signature, xFileSize_signatures[xFileSize_vfstraceFileSize_enum], sizeof(pSubOpen->pMethods->xFileSize_signature)) == 0) {
          rc = vfstraceFileSize(pSubOpen, &sz64);
        }
      else
      ...
      if( rc==SQLITE_OK && bExists ){
              if (memcmp(pOrigVfs->xDelete_signature, xDelete_signatures[xDelete_0_enum], sizeof(pOrigVfs->xDelete_signature)) == 0) {
                ...
                if (memcmp(pOrigVfs->xDelete_signature, xDelete_signatures[xDelete_apndDelete_enum], sizeof(pOrigVfs->xDelete_signature)) == 0) {
                        rc = apndDelete(pOrigVfs, pGroup->aReal[iChunk].z, 0);
                }
              else
                if (memcmp(pOrigVfs->xDelete_signature, xDelete_signatures[xDelete_f5tOrigintextDelete_enum], sizeof(pOrigVfs->xDelete_signature)) == 0) {
                        rc = f5tOrigintextDelete(pOrigVfs,
                                                 pGroup->aReal[iChunk].z, 0);
                }
              else
                if (memcmp(pOrigVfs->xDelete_signature, xDelete_signatures[xDelete_f5tTokenizerDelete_enum], sizeof(pOrigVfs->xDelete_signature)) == 0) {
                        rc = f5tTokenizerDelete(pOrigVfs,
                                                pGroup->aReal[iChunk].z, 0);
                }
              else
                if (memcmp(pOrigVfs->xDelete_signature, xDelete_signatures[xDelete_kvstorageDelete_enum], sizeof(pOrigVfs->xDelete_signature)) == 0) {
                        rc = kvstorageDelete(pOrigVfs,
                                             pGroup->aReal[iChunk].z, 0);
                }
              else
                if (memcmp(pOrigVfs->xDelete_signature, xDelete_signatures[xDelete_vfstraceDelete_enum], sizeof(pOrigVfs->xDelete_signature)) == 0) {
                        rc = vfstraceDelete(pOrigVfs, pGroup->aReal[iChunk].z,
                                            0);
                }
              else
                if (memcmp(pOrigVfs->xDelete_signature, xDelete_signatures[xDelete_unixDelete_enum], sizeof(pOrigVfs->xDelete_signature)) == 0) {
                        rc = unixDelete(pOrigVfs, pGroup->aReal[iChunk].z, 0);
                }
              if( rc==SQLITE_OK ){
                rc = multiplexSubFilename(pGroup, ++iChunk);
              }
          ...
          */
          if (memcmp(pOrigVfs->xAccess_signature, xAccess_signatures[xAccess_apndAccess_enum], sizeof(pOrigVfs->xAccess_signature)) == 0) {
          rc = apndAccess(pOrigVfs, pGroup->aReal[1].z, SQLITE_ACCESS_EXISTS,
                          &bExists);
          }
          else
          if (memcmp(pOrigVfs->xAccess_signature, xAccess_signatures[xAccess_memdbAccess_enum], sizeof(pOrigVfs->xAccess_signature)) == 0) {
            rc = memdbAccess(pOrigVfs, pGroup->aReal[1].z,
                             SQLITE_ACCESS_EXISTS, &bExists);
          }
          else
          if (memcmp(pOrigVfs->xAccess_signature, xAccess_signatures[xAccess_vfstraceAccess_enum], sizeof(pOrigVfs->xAccess_signature)) == 0) {
            rc = vfstraceAccess(pOrigVfs, pGroup->aReal[1].z,
                                SQLITE_ACCESS_EXISTS, &bExists);
            }
          else
            if (memcmp(pOrigVfs->xAccess_signature, xAccess_signatures[xAccess_unixAccess_enum], sizeof(pOrigVfs->xAccess_signature)) == 0) {
            rc = unixAccess(pOrigVfs, pGroup->aReal[1].z,
                            SQLITE_ACCESS_EXISTS, &bExists);
            }
    ...
    */
    ...
    if( z==0 ){
      ...
      do{
        ...
        if (memcmp(pOrigVfs->xAccess_signature, xAccess_signatures[xAccess_apndAccess_enum], sizeof(pOrigVfs->xAccess_signature)) == 0) {
          rc = apndAccess(pOrigVfs, z, SQLITE_ACCESS_EXISTS, &bExists);
        }
        else
          if (memcmp(pOrigVfs->xAccess_signature, xAccess_signatures[xAccess_memdbAccess_enum], sizeof(pOrigVfs->xAccess_signature)) == 0) {
            rc = memdbAccess(pOrigVfs, z, SQLITE_ACCESS_EXISTS, &bExists);
          }
        else
          if (memcmp(pOrigVfs->xAccess_signature, xAccess_signatures[xAccess_vfstraceAccess_enum], sizeof(pOrigVfs->xAccess_signature)) == 0) {
            rc = vfstraceAccess(pOrigVfs, z, SQLITE_ACCESS_EXISTS, &bExists);
          }
        else
          if (memcmp(pOrigVfs->xAccess_signature, xAccess_signatures[xAccess_unixAccess_enum], sizeof(pOrigVfs->xAccess_signature)) == 0) {
            rc = unixAccess(pOrigVfs, z, SQLITE_ACCESS_EXISTS, &bExists);
          }
      }while( rc==SQLITE_OK && bExists );
      while( rc==SQLITE_OK && iChunk>1 ){
        ...
        if (memcmp(pOrigVfs->xDelete_signature, xDelete_signatures[xDelete_0_enum], sizeof(pOrigVfs->xDelete_signature)) == 0) {
          ...
          if (memcmp(pOrigVfs->xDelete_signature, xDelete_signatures[xDelete_apndDelete_enum], sizeof(pOrigVfs->xDelete_signature)) == 0) {
            rc = apndDelete(pOrigVfs, z, syncDir);
          }
        else
          if (memcmp(pOrigVfs->xDelete_signature, xDelete_signatures[xDelete_f5tOrigintextDelete_enum], sizeof(pOrigVfs->xDelete_signature)) == 0) {
            rc = f5tOrigintextDelete(pOrigVfs, z, syncDir);
          }
        else
          if (memcmp(pOrigVfs->xDelete_signature, xDelete_signatures[xDelete_f5tTokenizerDelete_enum], sizeof(pOrigVfs->xDelete_signature)) == 0) {
            rc = f5tTokenizerDelete(pOrigVfs, z, syncDir);
          }
        else
          if (memcmp(pOrigVfs->xDelete_signature, xDelete_signatures[xDelete_kvstorageDelete_enum], sizeof(pOrigVfs->xDelete_signature)) == 0) {
            rc = kvstorageDelete(pOrigVfs, z, syncDir);
          }
        else
          if (memcmp(pOrigVfs->xDelete_signature, xDelete_signatures[xDelete_vfstraceDelete_enum], sizeof(pOrigVfs->xDelete_signature)) == 0) {
            rc = vfstraceDelete(pOrigVfs, z, syncDir);
          }
        else
          if (memcmp(pOrigVfs->xDelete_signature, xDelete_signatures[xDelete_unixDelete_enum], sizeof(pOrigVfs->xDelete_signature)) == 0) {
            rc = unixDelete(pOrigVfs, z, syncDir);
          }
      }
      if( rc==SQLITE_OK ){
        iChunk = 0;
...
int multiplexAccess(sqlite3_vfs *a, const char *b, int c, int *d){
  if (memcmp(gMultiplex.pOrigVfs->xAccess_signature, xAccess_signatures[xAccess_apndAccess_enum], sizeof(gMultiplex.pOrigVfs->xAccess_signature)) == 0) {
    return apndAccess(gMultiplex.pOrigVfs, b, c, d);
  }
  else
    if (memcmp(gMultiplex.pOrigVfs->xAccess_signature, xAccess_signatures[xAccess_memdbAccess_enum], sizeof(gMultiplex.pOrigVfs->xAccess_signature)) == 0) {
      return memdbAccess(gMultiplex.pOrigVfs, b, c, d);
    }
  else
    if (memcmp(gMultiplex.pOrigVfs->xAccess_signature, xAccess_signatures[xAccess_vfstraceAccess_enum], sizeof(gMultiplex.pOrigVfs->xAccess_signature)) == 0) {
      return vfstraceAccess(gMultiplex.pOrigVfs, b, c, d);
    }
  else
    if (memcmp(gMultiplex.pOrigVfs->xAccess_signature, xAccess_signatures[xAccess_unixAccess_enum], sizeof(gMultiplex.pOrigVfs->xAccess_signature)) == 0) {
      return unixAccess(gMultiplex.pOrigVfs, b, c, d);
    }
}
int multiplexFullPathname(sqlite3_vfs *a, const char *b, int c, char *d){
  if (memcmp(gMultiplex.pOrigVfs->xFullPathname_signature, xFullPathname_signatures[xFullPathname_apndFullPathname_enum], sizeof(gMultiplex.pOrigVfs->xFullPathname_signature)) == 0) {
    return apndFullPathname(gMultiplex.pOrigVfs, b, c, d);
  }
  else
    if (memcmp(gMultiplex.pOrigVfs->xFullPathname_signature, xFullPathname_signatures[xFullPathname_memdbFullPathname_enum], sizeof(gMultiplex.pOrigVfs->xFullPathname_signature)) == 0) {
      return memdbFullPathname(gMultiplex.pOrigVfs, b, c, d);
    }
  else
    if (memcmp(gMultiplex.pOrigVfs->xFullPathname_signature, xFullPathname_signatures[xFullPathname_vfstraceFullPathname_enum], sizeof(gMultiplex.pOrigVfs->xFullPathname_signature)) == 0) {
      return vfstraceFullPathname(gMultiplex.pOrigVfs, b, c, d);
    }
  else
    if (memcmp(gMultiplex.pOrigVfs->xFullPathname_signature, xFullPathname_signatures[xFullPathname_unixFullPathname_enum], sizeof(gMultiplex.pOrigVfs->xFullPathname_signature)) == 0) {
      return unixFullPathname(gMultiplex.pOrigVfs, b, c, d);
    }
}
void *multiplexDlOpen(sqlite3_vfs *a, const char *b){
  if (memcmp(gMultiplex.pOrigVfs->xDlOpen_signature, xDlOpen_signatures[xDlOpen_apndDlOpen_enum], sizeof(gMultiplex.pOrigVfs->xDlOpen_signature)) == 0) {
    return apndDlOpen(gMultiplex.pOrigVfs, b);
  }
  else
    if (memcmp(gMultiplex.pOrigVfs->xDlOpen_signature, xDlOpen_signatures[xDlOpen_memdbDlOpen_enum], sizeof(gMultiplex.pOrigVfs->xDlOpen_signature)) == 0) {
      return memdbDlOpen(gMultiplex.pOrigVfs, b);
    }
  else
    if (memcmp(gMultiplex.pOrigVfs->xDlOpen_signature, xDlOpen_signatures[xDlOpen_unixDlOpen_enum], sizeof(gMultiplex.pOrigVfs->xDlOpen_signature)) == 0) {
      return unixDlOpen(gMultiplex.pOrigVfs, b);
    }
}
void multiplexDlError(sqlite3_vfs *a, int b, char *c){
  if (memcmp(gMultiplex.pOrigVfs->xDlError_signature, xDlError_signatures[xDlError_0_enum], sizeof(gMultiplex.pOrigVfs->xDlError_signature)) == 0) {
    0;
  }
  else
    if (memcmp(gMultiplex.pOrigVfs->xDlError_signature, xDlError_signatures[xDlError_apndDlError_enum], sizeof(gMultiplex.pOrigVfs->xDlError_signature)) == 0) {
      apndDlError(gMultiplex.pOrigVfs, b, c);
    }
  else
    if (memcmp(gMultiplex.pOrigVfs->xDlError_signature, xDlError_signatures[xDlError_memdbDlError_enum], sizeof(gMultiplex.pOrigVfs->xDlError_signature)) == 0) {
      memdbDlError(gMultiplex.pOrigVfs, b, c);
    }
  else
    if (memcmp(gMultiplex.pOrigVfs->xDlError_signature, xDlError_signatures[xDlError_unixDlError_enum], sizeof(gMultiplex.pOrigVfs->xDlError_signature)) == 0) {
      unixDlError(gMultiplex.pOrigVfs, b, c);
    }
}
...
void multiplexDlClose(sqlite3_vfs *a, void *b){
  if (memcmp(gMultiplex.pOrigVfs->xDlClose_signature, xDlClose_signatures[xDlClose_0_enum], sizeof(gMultiplex.pOrigVfs->xDlClose_signature)) == 0) {
    0;
  }
  else
    if (memcmp(gMultiplex.pOrigVfs->xDlClose_signature, xDlClose_signatures[xDlClose_apndDlClose_enum], sizeof(gMultiplex.pOrigVfs->xDlClose_signature)) == 0) {
      apndDlClose(gMultiplex.pOrigVfs, b);
    }
  else
    if (memcmp(gMultiplex.pOrigVfs->xDlClose_signature, xDlClose_signatures[xDlClose_memdbDlClose_enum], sizeof(gMultiplex.pOrigVfs->xDlClose_signature)) == 0) {
      memdbDlClose(gMultiplex.pOrigVfs, b);
    }
  else
    if (memcmp(gMultiplex.pOrigVfs->xDlClose_signature, xDlClose_signatures[xDlClose_unixDlClose_enum], sizeof(gMultiplex.pOrigVfs->xDlClose_signature)) == 0) {
      unixDlClose(gMultiplex.pOrigVfs, b);
    }
}
int multiplexRandomness(sqlite3_vfs *a, int b, char *c){
  if (memcmp(gMultiplex.pOrigVfs->xRandomness_signature, xRandomness_signatures[xRandomness_apndRandomness_enum], sizeof(gMultiplex.pOrigVfs->xRandomness_signature)) == 0) {
    return apndRandomness(gMultiplex.pOrigVfs, b, c);
  }
  else
    if (memcmp(gMultiplex.pOrigVfs->xRandomness_signature, xRandomness_signatures[xRandomness_memdbRandomness_enum], sizeof(gMultiplex.pOrigVfs->xRandomness_signature)) == 0) {
      return memdbRandomness(gMultiplex.pOrigVfs, b, c);
    }
  else
    if (memcmp(gMultiplex.pOrigVfs->xRandomness_signature, xRandomness_signatures[xRandomness_vfstraceRandomness_enum], sizeof(gMultiplex.pOrigVfs->xRandomness_signature)) == 0) {
      return vfstraceRandomness(gMultiplex.pOrigVfs, b, c);
    }
  else
    if (memcmp(gMultiplex.pOrigVfs->xRandomness_signature, xRandomness_signatures[xRandomness_unixRandomness_enum], sizeof(gMultiplex.pOrigVfs->xRandomness_signature)) == 0) {
      return unixRandomness(gMultiplex.pOrigVfs, b, c);
    }
}
int multiplexSleep(sqlite3_vfs *a, int b){
  if (memcmp(gMultiplex.pOrigVfs->xSleep_signature, xSleep_signatures[xSleep_0_enum], sizeof(gMultiplex.pOrigVfs->xSleep_signature)) == 0) {
    return 0;
  }
  else
    if (memcmp(gMultiplex.pOrigVfs->xSleep_signature, xSleep_signatures[xSleep_apndSleep_enum], sizeof(gMultiplex.pOrigVfs->xSleep_signature)) == 0) {
      return apndSleep(gMultiplex.pOrigVfs, b);
    }
  else
    if (memcmp(gMultiplex.pOrigVfs->xSleep_signature, xSleep_signatures[xSleep_memdbSleep_enum], sizeof(gMultiplex.pOrigVfs->xSleep_signature)) == 0) {
      return memdbSleep(gMultiplex.pOrigVfs, b);
    }
  else
    if (memcmp(gMultiplex.pOrigVfs->xSleep_signature, xSleep_signatures[xSleep_vfstraceSleep_enum], sizeof(gMultiplex.pOrigVfs->xSleep_signature)) == 0) {
      return vfstraceSleep(gMultiplex.pOrigVfs, b);
    }
  else
    if (memcmp(gMultiplex.pOrigVfs->xSleep_signature, xSleep_signatures[xSleep_unixSleep_enum], sizeof(gMultiplex.pOrigVfs->xSleep_signature)) == 0) {
      return unixSleep(gMultiplex.pOrigVfs, b);
    }
}
int multiplexCurrentTime(sqlite3_vfs *a, double *b){
  if (memcmp(gMultiplex.pOrigVfs->xCurrentTime_signature, xCurrentTime_signatures[xCurrentTime_0_enum], sizeof(gMultiplex.pOrigVfs->xCurrentTime_signature)) == 0) {
    return 0;
  }
  else
    if (memcmp(gMultiplex.pOrigVfs->xCurrentTime_signature, xCurrentTime_signatures[xCurrentTime_apndCurrentTime_enum], sizeof(gMultiplex.pOrigVfs->xCurrentTime_signature)) == 0) {
      return apndCurrentTime(gMultiplex.pOrigVfs, b);
    }
  else
    if (memcmp(gMultiplex.pOrigVfs->xCurrentTime_signature, xCurrentTime_signatures[xCurrentTime_vfstraceCurrentTime_enum], sizeof(gMultiplex.pOrigVfs->xCurrentTime_signature)) == 0) {
      return vfstraceCurrentTime(gMultiplex.pOrigVfs, b);
    }
  else
    if (memcmp(gMultiplex.pOrigVfs->xCurrentTime_signature, xCurrentTime_signatures[xCurrentTime_unixCurrentTime_enum], sizeof(gMultiplex.pOrigVfs->xCurrentTime_signature)) == 0) {
      return unixCurrentTime(gMultiplex.pOrigVfs, b);
    }
}
int multiplexGetLastError(sqlite3_vfs *a, int b, char *c){
  if( gMultiplex.pOrigVfs->xGetLastError ){
    if (memcmp(gMultiplex.pOrigVfs->xGetLastError_signature, xGetLastError_signatures[xGetLastError_0_enum], sizeof(gMultiplex.pOrigVfs->xGetLastError_signature)) == 0) {
      return 0;
    }
    else
      if (memcmp(gMultiplex.pOrigVfs->xGetLastError_signature, xGetLastError_signatures[xGetLastError_apndGetLastError_enum], sizeof(gMultiplex.pOrigVfs->xGetLastError_signature)) == 0) {
        return apndGetLastError(gMultiplex.pOrigVfs, b, c);
      }
    else
      if (memcmp(gMultiplex.pOrigVfs->xGetLastError_signature, xGetLastError_signatures[xGetLastError_memdbGetLastError_enum], sizeof(gMultiplex.pOrigVfs->xGetLastError_signature)) == 0) {
        return memdbGetLastError(gMultiplex.pOrigVfs, b, c);
      }
    else
      if (memcmp(gMultiplex.pOrigVfs->xGetLastError_signature, xGetLastError_signatures[xGetLastError_unixGetLastError_enum], sizeof(gMultiplex.pOrigVfs->xGetLastError_signature)) == 0) {
        return unixGetLastError(gMultiplex.pOrigVfs, b, c);
      }
  }else{
    return 0;
  }
...
int multiplexCurrentTimeInt64(sqlite3_vfs *a, sqlite3_int64 *b){
  if (memcmp(gMultiplex.pOrigVfs->xCurrentTimeInt64_signature, xCurrentTimeInt64_signatures[xCurrentTimeInt64_0_enum], sizeof(gMultiplex.pOrigVfs->xCurrentTimeInt64_signature)) == 0) {
    return 0;
  }
  else
    if (memcmp(gMultiplex.pOrigVfs->xCurrentTimeInt64_signature, xCurrentTimeInt64_signatures[xCurrentTimeInt64_apndCurrentTimeInt64_enum], sizeof(gMultiplex.pOrigVfs->xCurrentTimeInt64_signature)) == 0) {
      return apndCurrentTimeInt64(gMultiplex.pOrigVfs, b);
    }
  else
    if (memcmp(gMultiplex.pOrigVfs->xCurrentTimeInt64_signature, xCurrentTimeInt64_signatures[xCurrentTimeInt64_memdbCurrentTimeInt64_enum], sizeof(gMultiplex.pOrigVfs->xCurrentTimeInt64_signature)) == 0) {
      return memdbCurrentTimeInt64(gMultiplex.pOrigVfs, b);
    }
  else
    if (memcmp(gMultiplex.pOrigVfs->xCurrentTimeInt64_signature, xCurrentTimeInt64_signatures[xCurrentTimeInt64_unixCurrentTimeInt64_enum], sizeof(gMultiplex.pOrigVfs->xCurrentTimeInt64_signature)) == 0) {
      return unixCurrentTimeInt64(gMultiplex.pOrigVfs, b);
    }
}
  ...
  if( !pGroup->bEnabled ){
    ...
    if( pSubOpen==0 ){
      ...
      if (memcmp(pSubOpen->pMethods->xRead_signature, xRead_signatures[xRead_apndRead_enum], sizeof(pSubOpen->pMethods->xRead_signature)) == 0) {
        rc = apndRead(pSubOpen, pBuf, iAmt, iOfst);
      }
      else
        if (memcmp(pSubOpen->pMethods->xRead_signature, xRead_signatures[xRead_memdbRead_enum], sizeof(pSubOpen->pMethods->xRead_signature)) == 0) {
          rc = memdbRead(pSubOpen, pBuf, iAmt, iOfst);
        }
      else
        if (memcmp(pSubOpen->pMethods->xRead_signature, xRead_signatures[xRead_memjrnlRead_enum], sizeof(pSubOpen->pMethods->xRead_signature)) == 0) {
          rc = memjrnlRead(pSubOpen, pBuf, iAmt, iOfst);
        }
      else
        if (memcmp(pSubOpen->pMethods->xRead_signature, xRead_signatures[xRead_recoverVfsRead_enum], sizeof(pSubOpen->pMethods->xRead_signature)) == 0) {
          rc = recoverVfsRead(pSubOpen, pBuf, iAmt, iOfst);
        }
      else
        if (memcmp(pSubOpen->pMethods->xRead_signature, xRead_signatures[xRead_vfstraceRead_enum], sizeof(pSubOpen->pMethods->xRead_signature)) == 0) {
          rc = vfstraceRead(pSubOpen, pBuf, iAmt, iOfst);
        }
      else
        if (memcmp(pSubOpen->pMethods->xRead_signature, xRead_signatures[xRead_unixRead_enum], sizeof(pSubOpen->pMethods->xRead_signature)) == 0) {
          rc = unixRead(pSubOpen, pBuf, iAmt, iOfst);
        }
    }
  }else{
    while( iAmt > 0 ){
      ...
      if( pSubOpen ){
        ...
        iAmt -= extra;
        if (memcmp(pSubOpen->pMethods->xRead_signature, xRead_signatures[xRead_apndRead_enum], sizeof(pSubOpen->pMethods->xRead_signature)) == 0) {
          rc = apndRead(pSubOpen, pBuf, iAmt, iOfst % pGroup->szChunk);
        }
        else
          if (memcmp(pSubOpen->pMethods->xRead_signature, xRead_signatures[xRead_memdbRead_enum], sizeof(pSubOpen->pMethods->xRead_signature)) == 0) {
            rc = memdbRead(pSubOpen, pBuf, iAmt, iOfst % pGroup->szChunk);
          }
        else
          if (memcmp(pSubOpen->pMethods->xRead_signature, xRead_signatures[xRead_memjrnlRead_enum], sizeof(pSubOpen->pMethods->xRead_signature)) == 0) {
            rc = memjrnlRead(pSubOpen, pBuf, iAmt, iOfst % pGroup->szChunk);
          }
        else
          if (memcmp(pSubOpen->pMethods->xRead_signature, xRead_signatures[xRead_recoverVfsRead_enum], sizeof(pSubOpen->pMethods->xRead_signature)) == 0) {
            rc = recoverVfsRead(pSubOpen, pBuf, iAmt, iOfst % pGroup->szChunk);
          }
        else
          if (memcmp(pSubOpen->pMethods->xRead_signature, xRead_signatures[xRead_vfstraceRead_enum], sizeof(pSubOpen->pMethods->xRead_signature)) == 0) {
            rc = vfstraceRead(pSubOpen, pBuf, iAmt, iOfst % pGroup->szChunk);
          }
        else
          if (memcmp(pSubOpen->pMethods->xRead_signature, xRead_signatures[xRead_unixRead_enum], sizeof(pSubOpen->pMethods->xRead_signature)) == 0) {
            rc = unixRead(pSubOpen, pBuf, iAmt, iOfst % pGroup->szChunk);
          }
  ...
  if( !pGroup->bEnabled ){
    ...
    if( pSubOpen==0 ){
      ...
      if (memcmp(pSubOpen->pMethods->xWrite_signature, xWrite_signatures[xWrite_apndWrite_enum], sizeof(pSubOpen->pMethods->xWrite_signature)) == 0) {
        rc = apndWrite(pSubOpen, pBuf, iAmt, iOfst);
      }
      else
        if (memcmp(pSubOpen->pMethods->xWrite_signature, xWrite_signatures[xWrite_kvstorageWrite_enum], sizeof(pSubOpen->pMethods->xWrite_signature)) == 0) {
          rc = kvstorageWrite(pSubOpen, pBuf, iAmt, iOfst);
        }
      else
        if (memcmp(pSubOpen->pMethods->xWrite_signature, xWrite_signatures[xWrite_memdbWrite_enum], sizeof(pSubOpen->pMethods->xWrite_signature)) == 0) {
          rc = memdbWrite(pSubOpen, pBuf, iAmt, iOfst);
        }
      else
        if (memcmp(pSubOpen->pMethods->xWrite_signature, xWrite_signatures[xWrite_memjrnlWrite_enum], sizeof(pSubOpen->pMethods->xWrite_signature)) == 0) {
          rc = memjrnlWrite(pSubOpen, pBuf, iAmt, iOfst);
        }
      else
        if (memcmp(pSubOpen->pMethods->xWrite_signature, xWrite_signatures[xWrite_recoverVfsWrite_enum], sizeof(pSubOpen->pMethods->xWrite_signature)) == 0) {
          rc = recoverVfsWrite(pSubOpen, pBuf, iAmt, iOfst);
        }
      else
        if (memcmp(pSubOpen->pMethods->xWrite_signature, xWrite_signatures[xWrite_vfstraceWrite_enum], sizeof(pSubOpen->pMethods->xWrite_signature)) == 0) {
          rc = vfstraceWrite(pSubOpen, pBuf, iAmt, iOfst);
        }
      else
        if (memcmp(pSubOpen->pMethods->xWrite_signature, xWrite_signatures[xWrite_unixWrite_enum], sizeof(pSubOpen->pMethods->xWrite_signature)) == 0) {
          rc = unixWrite(pSubOpen, pBuf, iAmt, iOfst);
        }
    }
  }else{
    while( rc==SQLITE_OK && iAmt>0 ){
      ...
      if( pSubOpen ){
        ...
        iAmt -= extra;
        if (memcmp(pSubOpen->pMethods->xWrite_signature, xWrite_signatures[xWrite_apndWrite_enum], sizeof(pSubOpen->pMethods->xWrite_signature)) == 0) {
        	rc = apndWrite(pSubOpen, pBuf, iAmt, iOfst % pGroup->szChunk);
        }
        else
        	if (memcmp(pSubOpen->pMethods->xWrite_signature, xWrite_signatures[xWrite_kvstorageWrite_enum], sizeof(pSubOpen->pMethods->xWrite_signature)) == 0) {
        		rc = kvstorageWrite(pSubOpen, pBuf, iAmt,
                                            iOfst % pGroup->szChunk);
        	}
        else
        	if (memcmp(pSubOpen->pMethods->xWrite_signature, xWrite_signatures[xWrite_memdbWrite_enum], sizeof(pSubOpen->pMethods->xWrite_signature)) == 0) {
        		rc = memdbWrite(pSubOpen, pBuf, iAmt,
                                        iOfst % pGroup->szChunk);
        	}
        else
        	if (memcmp(pSubOpen->pMethods->xWrite_signature, xWrite_signatures[xWrite_memjrnlWrite_enum], sizeof(pSubOpen->pMethods->xWrite_signature)) == 0) {
        		rc = memjrnlWrite(pSubOpen, pBuf, iAmt,
                                          iOfst % pGroup->szChunk);
        	}
        else
        	if (memcmp(pSubOpen->pMethods->xWrite_signature, xWrite_signatures[xWrite_recoverVfsWrite_enum], sizeof(pSubOpen->pMethods->xWrite_signature)) == 0) {
        		rc = recoverVfsWrite(pSubOpen, pBuf, iAmt,
                                             iOfst % pGroup->szChunk);
        	}
        else
        	if (memcmp(pSubOpen->pMethods->xWrite_signature, xWrite_signatures[xWrite_vfstraceWrite_enum], sizeof(pSubOpen->pMethods->xWrite_signature)) == 0) {
        		rc = vfstraceWrite(pSubOpen, pBuf, iAmt,
                                           iOfst % pGroup->szChunk);
        	}
        else
        	if (memcmp(pSubOpen->pMethods->xWrite_signature, xWrite_signatures[xWrite_unixWrite_enum], sizeof(pSubOpen->pMethods->xWrite_signature)) == 0) {
        		rc = unixWrite(pSubOpen, pBuf, iAmt,
                                       iOfst % pGroup->szChunk);
        	}
        pBuf = (char *)pBuf + iAmt;
        iOfst += iAmt;
...
int multiplexTruncate(sqlite3_file *pConn, sqlite3_int64 size){
  ...
  if( !pGroup->bEnabled ){
    ...
    if( pSubOpen==0 ){
      ...
      if (memcmp(pSubOpen->pMethods->xTruncate_signature, xTruncate_signatures[xTruncate_apndTruncate_enum], sizeof(pSubOpen->pMethods->xTruncate_signature)) == 0) {
        rc = apndTruncate(pSubOpen, size);
      }
      else
        if (memcmp(pSubOpen->pMethods->xTruncate_signature, xTruncate_signatures[xTruncate_memdbTruncate_enum], sizeof(pSubOpen->pMethods->xTruncate_signature)) == 0) {
          rc = memdbTruncate(pSubOpen, size);
        }
      else
        if (memcmp(pSubOpen->pMethods->xTruncate_signature, xTruncate_signatures[xTruncate_memjrnlTruncate_enum], sizeof(pSubOpen->pMethods->xTruncate_signature)) == 0) {
          rc = memjrnlTruncate(pSubOpen, size);
        }
      else
        if (memcmp(pSubOpen->pMethods->xTruncate_signature, xTruncate_signatures[xTruncate_pcache1Truncate_enum], sizeof(pSubOpen->pMethods->xTruncate_signature)) == 0) {
          rc = pcache1Truncate(pSubOpen, size);
        }
      else
        if (memcmp(pSubOpen->pMethods->xTruncate_signature, xTruncate_signatures[xTruncate_pcachetraceTruncate_enum], sizeof(pSubOpen->pMethods->xTruncate_signature)) == 0) {
          rc = pcachetraceTruncate(pSubOpen, size);
        }
      else
        if (memcmp(pSubOpen->pMethods->xTruncate_signature, xTruncate_signatures[xTruncate_recoverVfsTruncate_enum], sizeof(pSubOpen->pMethods->xTruncate_signature)) == 0) {
          rc = recoverVfsTruncate(pSubOpen, size);
        }
      else
        if (memcmp(pSubOpen->pMethods->xTruncate_signature, xTruncate_signatures[xTruncate_vfstraceTruncate_enum], sizeof(pSubOpen->pMethods->xTruncate_signature)) == 0) {
          rc = vfstraceTruncate(pSubOpen, size);
        }
      else
        if (memcmp(pSubOpen->pMethods->xTruncate_signature, xTruncate_signatures[xTruncate_unixTruncate_enum], sizeof(pSubOpen->pMethods->xTruncate_signature)) == 0) {
          rc = unixTruncate(pSubOpen, size);
        }
    }
  }else{
    int i;
    ...
    for(i = pGroup->nReal-1; i>iBaseGroup && rc==SQLITE_OK; i--){
      if( pGroup->bTruncate ){
        ...
        if( pSubOpen ){
          if (memcmp(pSubOpen->pMethods->xTruncate_signature, xTruncate_signatures[xTruncate_apndTruncate_enum], sizeof(pSubOpen->pMethods->xTruncate_signature)) == 0) {
            rc = apndTruncate(pSubOpen, 0);
          }
          else
            if (memcmp(pSubOpen->pMethods->xTruncate_signature, xTruncate_signatures[xTruncate_memdbTruncate_enum], sizeof(pSubOpen->pMethods->xTruncate_signature)) == 0) {
              rc = memdbTruncate(pSubOpen, 0);
            }
          else
            if (memcmp(pSubOpen->pMethods->xTruncate_signature, xTruncate_signatures[xTruncate_memjrnlTruncate_enum], sizeof(pSubOpen->pMethods->xTruncate_signature)) == 0) {
              rc = memjrnlTruncate(pSubOpen, 0);
            }
          else
            if (memcmp(pSubOpen->pMethods->xTruncate_signature, xTruncate_signatures[xTruncate_pcache1Truncate_enum], sizeof(pSubOpen->pMethods->xTruncate_signature)) == 0) {
              rc = pcache1Truncate(pSubOpen, 0);
            }
          else
            if (memcmp(pSubOpen->pMethods->xTruncate_signature, xTruncate_signatures[xTruncate_pcachetraceTruncate_enum], sizeof(pSubOpen->pMethods->xTruncate_signature)) == 0) {
              rc = pcachetraceTruncate(pSubOpen, 0);
            }
          else
            if (memcmp(pSubOpen->pMethods->xTruncate_signature, xTruncate_signatures[xTruncate_recoverVfsTruncate_enum], sizeof(pSubOpen->pMethods->xTruncate_signature)) == 0) {
              rc = recoverVfsTruncate(pSubOpen, 0);
            }
          else
            if (memcmp(pSubOpen->pMethods->xTruncate_signature, xTruncate_signatures[xTruncate_vfstraceTruncate_enum], sizeof(pSubOpen->pMethods->xTruncate_signature)) == 0) {
              rc = vfstraceTruncate(pSubOpen, 0);
            }
          else
            if (memcmp(pSubOpen->pMethods->xTruncate_signature, xTruncate_signatures[xTruncate_unixTruncate_enum], sizeof(pSubOpen->pMethods->xTruncate_signature)) == 0) {
              rc = unixTruncate(pSubOpen, 0);
            }
        }
      }
    }
    if( rc==SQLITE_OK ){
      ...
      if( pSubOpen ){
        if (memcmp(pSubOpen->pMethods->xTruncate_signature, xTruncate_signatures[xTruncate_apndTruncate_enum], sizeof(pSubOpen->pMethods->xTruncate_signature)) == 0) {
          rc = apndTruncate(pSubOpen, size % pGroup->szChunk);
        }
        else
          if (memcmp(pSubOpen->pMethods->xTruncate_signature, xTruncate_signatures[xTruncate_memdbTruncate_enum], sizeof(pSubOpen->pMethods->xTruncate_signature)) == 0) {
            rc = memdbTruncate(pSubOpen, size % pGroup->szChunk);
          }
        else
          if (memcmp(pSubOpen->pMethods->xTruncate_signature, xTruncate_signatures[xTruncate_memjrnlTruncate_enum], sizeof(pSubOpen->pMethods->xTruncate_signature)) == 0) {
            rc = memjrnlTruncate(pSubOpen, size % pGroup->szChunk);
          }
        else
          if (memcmp(pSubOpen->pMethods->xTruncate_signature, xTruncate_signatures[xTruncate_pcache1Truncate_enum], sizeof(pSubOpen->pMethods->xTruncate_signature)) == 0) {
            rc = pcache1Truncate(pSubOpen, size % pGroup->szChunk);
          }
        else
          if (memcmp(pSubOpen->pMethods->xTruncate_signature, xTruncate_signatures[xTruncate_pcachetraceTruncate_enum], sizeof(pSubOpen->pMethods->xTruncate_signature)) == 0) {
            rc = pcachetraceTruncate(pSubOpen, size % pGroup->szChunk);
          }
        else
          if (memcmp(pSubOpen->pMethods->xTruncate_signature, xTruncate_signatures[xTruncate_recoverVfsTruncate_enum], sizeof(pSubOpen->pMethods->xTruncate_signature)) == 0) {
            rc = recoverVfsTruncate(pSubOpen, size % pGroup->szChunk);
          }
        else
          if (memcmp(pSubOpen->pMethods->xTruncate_signature, xTruncate_signatures[xTruncate_vfstraceTruncate_enum], sizeof(pSubOpen->pMethods->xTruncate_signature)) == 0) {
            rc = vfstraceTruncate(pSubOpen, size % pGroup->szChunk);
          }
        else
          if (memcmp(pSubOpen->pMethods->xTruncate_signature, xTruncate_signatures[xTruncate_unixTruncate_enum], sizeof(pSubOpen->pMethods->xTruncate_signature)) == 0) {
            rc = unixTruncate(pSubOpen, size % pGroup->szChunk);
          }
      }
    }
...
int multiplexFileSize(sqlite3_file *pConn, sqlite3_int64 *pSize){
  ...
  if( !pGroup->bEnabled ){
    ...
    if( pSubOpen==0 ){
      ...
      if (memcmp(pSubOpen->pMethods->xFileSize_signature, xFileSize_signatures[xFileSize_apndFileSize_enum], sizeof(pSubOpen->pMethods->xFileSize_signature)) == 0) {
        rc = apndFileSize(pSubOpen, pSize);
      }
      else
        if (memcmp(pSubOpen->pMethods->xFileSize_signature, xFileSize_signatures[xFileSize_memdbFileSize_enum], sizeof(pSubOpen->pMethods->xFileSize_signature)) == 0) {
          rc = memdbFileSize(pSubOpen, pSize);
        }
      else
        if (memcmp(pSubOpen->pMethods->xFileSize_signature, xFileSize_signatures[xFileSize_memjrnlFileSize_enum], sizeof(pSubOpen->pMethods->xFileSize_signature)) == 0) {
          rc = memjrnlFileSize(pSubOpen, pSize);
        }
      else
        if (memcmp(pSubOpen->pMethods->xFileSize_signature, xFileSize_signatures[xFileSize_recoverVfsFileSize_enum], sizeof(pSubOpen->pMethods->xFileSize_signature)) == 0) {
          rc = recoverVfsFileSize(pSubOpen, pSize);
        }
      else
        if (memcmp(pSubOpen->pMethods->xFileSize_signature, xFileSize_signatures[xFileSize_vfstraceFileSize_enum], sizeof(pSubOpen->pMethods->xFileSize_signature)) == 0) {
          rc = vfstraceFileSize(pSubOpen, pSize);
        }
      else
        if (memcmp(pSubOpen->pMethods->xFileSize_signature, xFileSize_signatures[xFileSize_unixFileSize_enum], sizeof(pSubOpen->pMethods->xFileSize_signature)) == 0) {
          rc = unixFileSize(pSubOpen, pSize);
        }
    }
  }else{
    *pSize = 0;
...
int multiplexFileControl(sqlite3_file *pConn, int op, void *pArg){
  ...
  switch( op ){
    ...
    default:
      ...
      if( pSubOpen ){
        if (memcmp(pSubOpen->pMethods->xFileControl_signature, xFileControl_signatures[xFileControl_0_enum], sizeof(pSubOpen->pMethods->xFileControl_signature)) == 0) {
        rc = 0;
        }
        else
        if (memcmp(pSubOpen->pMethods->xFileControl_signature, xFileControl_signatures[xFileControl_apndFileControl_enum], sizeof(pSubOpen->pMethods->xFileControl_signature)) == 0) {
          rc = apndFileControl(pSubOpen, op, pArg);
        }
        else
        if (memcmp(pSubOpen->pMethods->xFileControl_signature, xFileControl_signatures[xFileControl_memdbFileControl_enum], sizeof(pSubOpen->pMethods->xFileControl_signature)) == 0) {
          rc = memdbFileControl(pSubOpen, op, pArg);
        }
        else
        if (memcmp(pSubOpen->pMethods->xFileControl_signature, xFileControl_signatures[xFileControl_recoverVfsFileControl_enum], sizeof(pSubOpen->pMethods->xFileControl_signature)) == 0) {
          rc = recoverVfsFileControl(pSubOpen, op, pArg);
         }
        else
         if (memcmp(pSubOpen->pMethods->xFileControl_signature, xFileControl_signatures[xFileControl_vfstraceFileControl_enum], sizeof(pSubOpen->pMethods->xFileControl_signature)) == 0) {
          rc = vfstraceFileControl(pSubOpen, op, pArg);
         }
        else
         if (memcmp(pSubOpen->pMethods->xFileControl_signature, xFileControl_signatures[xFileControl_unixFileControl_enum], sizeof(pSubOpen->pMethods->xFileControl_signature)) == 0) {
          rc = unixFileControl(pSubOpen, op, pArg);
         }

...
SQLITE_NOINLINE int sqlite3VdbeMemGrow(Mem *pMem, int n, int bPreserve){
  ...
  ** contain a valid string or blob value.  */
  ...
  if( (pMem->flags&MEM_Dyn)!=0 ){
    ...
    // if (memcmp(pMem->xDel_signature, xDel_signatures[xDel_0_enum], sizeof(pMem->xDel_signature)) == 0) {
    //     0;
    // }
    // else
    //     if (memcmp(pMem->xDel_signature, xDel_signatures[xDel_sqlite3RowSetDelete_enum], sizeof(pMem->xDel_signature)) == 0) {
    //       sqlite3RowSetDelete((void *)(pMem->z));
    //     }
    // else
    //     if (memcmp(pMem->xDel_signature, xDel_signatures[xDel_sqlite3VdbeFrameMemDel_enum], sizeof(pMem->xDel_signature)) == 0) {
    //       sqlite3VdbeFrameMemDel((void *)(pMem->z));
    //     }
    // else
    //     if (memcmp(pMem->xDel_signature, xDel_signatures[xDel_sqlite3_free_enum], sizeof(pMem->xDel_signature)) == 0) {

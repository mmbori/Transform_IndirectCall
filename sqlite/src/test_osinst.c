...
void *vfslogDlOpen(sqlite3_vfs*, const char *zFilename);
void vfslogDlError(sqlite3_vfs*, int nByte, char *zErrMsg);
void (*vfslogDlSym(sqlite3_vfs *pVfs, void *p, const char*zSym))(void);
...
,
  .xOpen_signature = xOpen_signatures[xOpen_vfslogOpen_enum],
  .xDelete_signature = xDelete_signatures[xDelete_vfslogDelete_enum],
  .xAccess_signature = xAccess_signatures[xAccess_vfslogAccess_enum],
  .xFullPathname_signature = xFullPathname_signatures[xFullPathname_vfslogFullPathname_enum],
  .xDlOpen_signature = xDlOpen_signatures[xDlOpen_vfslogDlOpen_enum],
  .xDlError_signature = xDlError_signatures[xDlError_vfslogDlError_enum],
  .xDlSym_signature = xDlSym_signatures[xDlSym_vfslogDlSym_enum],
  .xDlClose_signature = xDlClose_signatures[xDlClose_vfslogDlClose_enum],
  .xRandomness_signature = xRandomness_signatures[xRandomness_vfslogRandomness_enum],
  .xSleep_signature = xSleep_signatures[xSleep_vfslogSleep_enum],
  .xCurrentTime_signature = xCurrentTime_signatures[xCurrentTime_vfslogCurrentTime_enum],
  .xGetLastError_signature = xGetLastError_signatures[xGetLastError_vfslogGetLastError_enum],
  .xCurrentTimeInt64_signature = xCurrentTimeInt64_signatures[xCurrentTimeInt64_vfslogCurrentTimeInt64_enum]
};
...
,
  .xClose_signature = xClose_signatures[xClose_vfslogClose_enum],
  .xRead_signature = xRead_signatures[xRead_vfslogRead_enum],
  .xWrite_signature = xWrite_signatures[xWrite_vfslogWrite_enum],
  .xTruncate_signature = xTruncate_signatures[xTruncate_vfslogTruncate_enum],
  .xSync_signature = xSync_signatures[xSync_vfslogSync_enum],
  .xFileSize_signature = xFileSize_signatures[xFileSize_vfslogFileSize_enum],
  .xLock_signature = xLock_signatures[xLock_vfslogLock_enum],
  .xUnlock_signature = xUnlock_signatures[xUnlock_vfslogUnlock_enum],
  .xCheckReservedLock_signature = xCheckReservedLock_signatures[xCheckReservedLock_vfslogCheckReservedLock_enum],
  .xFileControl_signature = xFileControl_signatures[xFileControl_vfslogFileControl_enum],
  .xSectorSize_signature = xSectorSize_signatures[xSectorSize_vfslogSectorSize_enum],
  .xDeviceCharacteristics_signature = xDeviceCharacteristics_signatures[xDeviceCharacteristics_vfslogDeviceCharacteristics_enum],
  .xShmMap_signature = xShmMap_signatures[xShmMap_vfslogShmMap_enum],
  .xShmLock_signature = xShmLock_signatures[xShmLock_vfslogShmLock_enum],
  .xShmBarrier_signature = xShmBarrier_signatures[xShmBarrier_vfslogShmBarrier_enum],
  .xShmUnmap_signature = xShmUnmap_signatures[xShmUnmap_vfslogShmUnmap_enum]
};
...
*/
int vfslogClose(sqlite3_file *pFile){
  sqlite3_uint64 t;
  int rc = SQLITE_OK;
...
*/
int vfslogTruncate(sqlite3_file *pFile, sqlite_int64 size){
  int rc;
  sqlite3_uint64 t;
  VfslogFile *p = (VfslogFile *)pFile;
  t = vfslog_time();
...
** Sync an vfslog-file.
*/
int vfslogSync(sqlite3_file *pFile, int flags){
  int rc;
  sqlite3_uint64 t;
  VfslogFile *p = (VfslogFile *)pFile;
  t = vfslog_time();
...
*/
int vfslogFileSize(sqlite3_file *pFile, sqlite_int64 *pSize){
  int rc;
  sqlite3_uint64 t;
  VfslogFile *p = (VfslogFile *)pFile;
  t = vfslog_time();
...
** Lock an vfslog-file.
*/
int vfslogLock(sqlite3_file *pFile, int eLock){
  int rc;
  sqlite3_uint64 t;
  VfslogFile *p = (VfslogFile *)pFile;
  t = vfslog_time();
...
*/
int vfslogUnlock(sqlite3_file *pFile, int eLock){
  int rc;
  sqlite3_uint64 t;
  VfslogFile *p = (VfslogFile *)pFile;
  t = vfslog_time();
...
*/
int vfslogCheckReservedLock(sqlite3_file *pFile, int *pResOut){
  int rc;
  sqlite3_uint64 t;
  VfslogFile *p = (VfslogFile *)pFile;
  t = vfslog_time();
...
*/
int vfslogFileControl(sqlite3_file *pFile, int op, void *pArg){
  VfslogFile *p = (VfslogFile *)pFile;
...
*/
int vfslogSectorSize(sqlite3_file *pFile){
  int rc;
  sqlite3_uint64 t;
  VfslogFile *p = (VfslogFile *)pFile;
  t = vfslog_time();
...
*/
int vfslogDeviceCharacteristics(sqlite3_file *pFile){
  int rc;
  sqlite3_uint64 t;
  VfslogFile *p = (VfslogFile *)pFile;
  t = vfslog_time();
...
void vfslogShmBarrier(sqlite3_file *pFile){
  sqlite3_uint64 t;
  VfslogFile *p = (VfslogFile *)pFile;
  t = vfslog_time();
...
** returning.
*/
int vfslogDelete(sqlite3_vfs *pVfs, const char *zPath, int dirSync){
  int rc;
  sqlite3_uint64 t;
  t = vfslog_time();
...
*/
void *vfslogDlOpen(sqlite3_vfs *pVfs, const char *zPath){
...
*/
void vfslogDlError(sqlite3_vfs *pVfs, int nByte, char *zErrMsg){
...
*/
void vfslogDlClose(sqlite3_vfs *pVfs, void *pHandle){
...
** random data.
*/
int vfslogRandomness(sqlite3_vfs *pVfs, int nByte, char *zBufOut){
...
** actually slept.
*/
int vfslogSleep(sqlite3_vfs *pVfs, int nMicro){
...
*/
int vfslogCurrentTime(sqlite3_vfs *pVfs, double *pTimeOut){
  return REALVFS(pVfs)->xCurrentTime(REALVFS(pVfs), pTimeOut);
}

int vfslogGetLastError(sqlite3_vfs *pVfs, int a, char *b){
  return REALVFS(pVfs)->xGetLastError(REALVFS(pVfs), a, b);
}
int vfslogCurrentTimeInt64(sqlite3_vfs *pVfs, sqlite3_int64 *p){
...
*/
int vlogOpen(sqlite3_vtab *pVTab, sqlite3_vtab_cursor **ppCursor){
...
*/
int vlogClose(sqlite3_vtab_cursor *pCursor){
...
int sqlite3_vfslog_register(sqlite3 *db){
  static sqlite3_module vfslog_module = {
    ...
    0                             /* xIntegrity */
 ,
  .xCreate_signature = xCreate_signatures[xCreate_vlogConnect_enum],
  .xConnect_signature = xConnect_signatures[xConnect_vlogConnect_enum],
  .xBestIndex_signature = xBestIndex_signatures[xBestIndex_vlogBestIndex_enum],
  .xDisconnect_signature = xDisconnect_signatures[xDisconnect_vlogDisconnect_enum],
  .xDestroy_signature = xDestroy_signatures[xDestroy_vlogDisconnect_enum],
  .xOpen_signature = xOpen_signatures[xOpen_vlogOpen_enum],
  .xClose_signature = xClose_signatures[xClose_vlogClose_enum],
  .xFilter_signature = xFilter_signatures[xFilter_vlogFilter_enum],
  .xNext_signature = xNext_signatures[xNext_vlogNext_enum],
  .xEof_signature = xEof_signatures[xEof_vlogEof_enum],
  .xColumn_signature = xColumn_signatures[xColumn_vlogColumn_enum],
  .xRowid_signature = xRowid_signatures[xRowid_vlogRowid_enum]
};

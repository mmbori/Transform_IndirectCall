...
static int SQLITE_TCLAPI test_syscall_install(
  ...
  for(i=0; i<(int)nElem; i++){
    ...
    if( aSyscall[iCall].xOrig==0 ){
      if (memcmp(pVfs->xGetSystemCall_signature, xGetSystemCall_signatures[xGetSystemCall_0_enum], sizeof(pVfs->xGetSystemCall_signature)) == 0) {
        aSyscall[iCall].xOrig = 0;
      }
      else
        if (memcmp(pVfs->xGetSystemCall_signature, xGetSystemCall_signatures[xGetSystemCall_apndGetSystemCall_enum], sizeof(pVfs->xGetSystemCall_signature)) == 0) {
          aSyscall[iCall].xOrig = apndGetSystemCall(pVfs,
                                                    aSyscall[iCall].zName);
        }
      else
        if (memcmp(pVfs->xGetSystemCall_signature, xGetSystemCall_signatures[xGetSystemCall_unixGetSystemCall_enum], sizeof(pVfs->xGetSystemCall_signature)) == 0) {
          aSyscall[iCall].xOrig = unixGetSystemCall(pVfs,
                                                    aSyscall[iCall].zName);
        }
      if (memcmp(pVfs->xSetSystemCall_signature, xSetSystemCall_signatures[xSetSystemCall_0_enum], sizeof(pVfs->xSetSystemCall_signature)) == 0) {
        0;
      }
      else
        if (memcmp(pVfs->xSetSystemCall_signature, xSetSystemCall_signatures[xSetSystemCall_apndSetSystemCall_enum], sizeof(pVfs->xSetSystemCall_signature)) == 0) {
          apndSetSystemCall(pVfs, aSyscall[iCall].zName,
                            aSyscall[iCall].xTest);
        }
      else
        if (memcmp(pVfs->xSetSystemCall_signature, xSetSystemCall_signatures[xSetSystemCall_devsymSleep_enum], sizeof(pVfs->xSetSystemCall_signature)) == 0) {
          devsymSleep(pVfs, aSyscall[iCall].zName, aSyscall[iCall].xTest);
        }
      else
        if (memcmp(pVfs->xSetSystemCall_signature, xSetSystemCall_signatures[xSetSystemCall_rbuVfsSleep_enum], sizeof(pVfs->xSetSystemCall_signature)) == 0) {
          rbuVfsSleep(pVfs, aSyscall[iCall].zName, aSyscall[iCall].xTest);
        }
      else
        if (memcmp(pVfs->xSetSystemCall_signature, xSetSystemCall_signatures[xSetSystemCall_tvfsSleep_enum], sizeof(pVfs->xSetSystemCall_signature)) == 0) {
          tvfsSleep(pVfs, aSyscall[iCall].zName, aSyscall[iCall].xTest);
        }
      else
        if (memcmp(pVfs->xSetSystemCall_signature, xSetSystemCall_signatures[xSetSystemCall_unixSetSystemCall_enum], sizeof(pVfs->xSetSystemCall_signature)) == 0) {
          unixSetSystemCall(pVfs, aSyscall[iCall].zName,
                            aSyscall[iCall].xTest);
        }
    }
  ...
  for(i=0; aSyscall[i].zName; i++){
    if( aSyscall[i].xOrig ){
      if (memcmp(pVfs->xSetSystemCall_signature, xSetSystemCall_signatures[xSetSystemCall_0_enum], sizeof(pVfs->xSetSystemCall_signature)) == 0) {
        ...
        if (memcmp(pVfs->xSetSystemCall_signature, xSetSystemCall_signatures[xSetSystemCall_apndSetSystemCall_enum], sizeof(pVfs->xSetSystemCall_signature)) == 0) {
          apndSetSystemCall(pVfs, aSyscall[i].zName, 0);
        }
      else
        if (memcmp(pVfs->xSetSystemCall_signature, xSetSystemCall_signatures[xSetSystemCall_devsymSleep_enum], sizeof(pVfs->xSetSystemCall_signature)) == 0) {
          devsymSleep(pVfs, aSyscall[i].zName, 0);
        }
      else
        if (memcmp(pVfs->xSetSystemCall_signature, xSetSystemCall_signatures[xSetSystemCall_rbuVfsSleep_enum], sizeof(pVfs->xSetSystemCall_signature)) == 0) {
          rbuVfsSleep(pVfs, aSyscall[i].zName, 0);
        }
      else
        if (memcmp(pVfs->xSetSystemCall_signature, xSetSystemCall_signatures[xSetSystemCall_tvfsSleep_enum], sizeof(pVfs->xSetSystemCall_signature)) == 0) {
          tvfsSleep(pVfs, aSyscall[i].zName, 0);
        }
      else
        if (memcmp(pVfs->xSetSystemCall_signature, xSetSystemCall_signatures[xSetSystemCall_unixSetSystemCall_enum], sizeof(pVfs->xSetSystemCall_signature)) == 0) {
          unixSetSystemCall(pVfs, aSyscall[i].zName, 0);
        }
      aSyscall[i].xOrig = 0;
    }
  }
...
static int SQLITE_TCLAPI test_syscall_reset(
  ...
  if( objc==2 ){
    if (memcmp(pVfs->xSetSystemCall_signature, xSetSystemCall_signatures[xSetSystemCall_0_enum], sizeof(pVfs->xSetSystemCall_signature)) == 0) {
      ...
      if (memcmp(pVfs->xSetSystemCall_signature, xSetSystemCall_signatures[xSetSystemCall_apndSetSystemCall_enum], sizeof(pVfs->xSetSystemCall_signature)) == 0) {
        rc = apndSetSystemCall(pVfs, 0, 0);
      }
    else
      if (memcmp(pVfs->xSetSystemCall_signature, xSetSystemCall_signatures[xSetSystemCall_devsymSleep_enum], sizeof(pVfs->xSetSystemCall_signature)) == 0) {
        rc = devsymSleep(pVfs, 0, 0);
      }
    else
      if (memcmp(pVfs->xSetSystemCall_signature, xSetSystemCall_signatures[xSetSystemCall_rbuVfsSleep_enum], sizeof(pVfs->xSetSystemCall_signature)) == 0) {
        rc = rbuVfsSleep(pVfs, 0, 0);
      }
    else
      if (memcmp(pVfs->xSetSystemCall_signature, xSetSystemCall_signatures[xSetSystemCall_tvfsSleep_enum], sizeof(pVfs->xSetSystemCall_signature)) == 0) {
        rc = tvfsSleep(pVfs, 0, 0);
      }
    else
      if (memcmp(pVfs->xSetSystemCall_signature, xSetSystemCall_signatures[xSetSystemCall_unixSetSystemCall_enum], sizeof(pVfs->xSetSystemCall_signature)) == 0) {
        rc = unixSetSystemCall(pVfs, 0, 0);
      }
    ...
    if (memcmp(pVfs->xSetSystemCall_signature, xSetSystemCall_signatures[xSetSystemCall_0_enum], sizeof(pVfs->xSetSystemCall_signature)) == 0) {
      ...
      if (memcmp(pVfs->xSetSystemCall_signature, xSetSystemCall_signatures[xSetSystemCall_apndSetSystemCall_enum], sizeof(pVfs->xSetSystemCall_signature)) == 0) {
        rc = apndSetSystemCall(pVfs, Tcl_GetString(objv[2]), 0);
      }
    else
      if (memcmp(pVfs->xSetSystemCall_signature, xSetSystemCall_signatures[xSetSystemCall_devsymSleep_enum], sizeof(pVfs->xSetSystemCall_signature)) == 0) {
        rc = devsymSleep(pVfs, Tcl_GetString(objv[2]), 0);
      }
    else
      if (memcmp(pVfs->xSetSystemCall_signature, xSetSystemCall_signatures[xSetSystemCall_rbuVfsSleep_enum], sizeof(pVfs->xSetSystemCall_signature)) == 0) {
        rc = rbuVfsSleep(pVfs, Tcl_GetString(objv[2]), 0);
      }
    else
      if (memcmp(pVfs->xSetSystemCall_signature, xSetSystemCall_signatures[xSetSystemCall_tvfsSleep_enum], sizeof(pVfs->xSetSystemCall_signature)) == 0) {
        rc = tvfsSleep(pVfs, Tcl_GetString(objv[2]), 0);
      }
    else
      if (memcmp(pVfs->xSetSystemCall_signature, xSetSystemCall_signatures[xSetSystemCall_unixSetSystemCall_enum], sizeof(pVfs->xSetSystemCall_signature)) == 0) {
        rc = unixSetSystemCall(pVfs, Tcl_GetString(objv[2]), 0);
      }
...
static int SQLITE_TCLAPI test_syscall_exists(
  ...
  if (memcmp(pVfs->xGetSystemCall_signature, xGetSystemCall_signatures[xGetSystemCall_0_enum], sizeof(pVfs->xGetSystemCall_signature)) == 0) {
    ...
    if (memcmp(pVfs->xGetSystemCall_signature, xGetSystemCall_signatures[xGetSystemCall_apndGetSystemCall_enum], sizeof(pVfs->xGetSystemCall_signature)) == 0) {
      x = apndGetSystemCall(pVfs, Tcl_GetString(objv[2]));
    }
  else
    if (memcmp(pVfs->xGetSystemCall_signature, xGetSystemCall_signatures[xGetSystemCall_unixGetSystemCall_enum], sizeof(pVfs->xGetSystemCall_signature)) == 0) {
      x = unixGetSystemCall(pVfs, Tcl_GetString(objv[2]));
    }
  ...
  if( pgsz<0 ){
    if( gSyscall.orig_getpagesize ){
      if (memcmp(pVfs->xSetSystemCall_signature, xSetSystemCall_signatures[xSetSystemCall_0_enum], sizeof(pVfs->xSetSystemCall_signature)) == 0) {
        ...
        if (memcmp(pVfs->xSetSystemCall_signature, xSetSystemCall_signatures[xSetSystemCall_apndSetSystemCall_enum], sizeof(pVfs->xSetSystemCall_signature)) == 0) {
          apndSetSystemCall(pVfs, "getpagesize", gSyscall.orig_getpagesize);
        }
      else
        if (memcmp(pVfs->xSetSystemCall_signature, xSetSystemCall_signatures[xSetSystemCall_devsymSleep_enum], sizeof(pVfs->xSetSystemCall_signature)) == 0) {
          devsymSleep(pVfs, "getpagesize", gSyscall.orig_getpagesize);
        }
      else
        if (memcmp(pVfs->xSetSystemCall_signature, xSetSystemCall_signatures[xSetSystemCall_rbuVfsSleep_enum], sizeof(pVfs->xSetSystemCall_signature)) == 0) {
          rbuVfsSleep(pVfs, "getpagesize", gSyscall.orig_getpagesize);
        }
      else
        if (memcmp(pVfs->xSetSystemCall_signature, xSetSystemCall_signatures[xSetSystemCall_tvfsSleep_enum], sizeof(pVfs->xSetSystemCall_signature)) == 0) {
          tvfsSleep(pVfs, "getpagesize", gSyscall.orig_getpagesize);
        }
      else
        if (memcmp(pVfs->xSetSystemCall_signature, xSetSystemCall_signatures[xSetSystemCall_unixSetSystemCall_enum], sizeof(pVfs->xSetSystemCall_signature)) == 0) {
          unixSetSystemCall(pVfs, "getpagesize", gSyscall.orig_getpagesize);
        }
    }
  }else{
    ...
    if (memcmp(pVfs->xGetSystemCall_signature, xGetSystemCall_signatures[xGetSystemCall_0_enum], sizeof(pVfs->xGetSystemCall_signature)) == 0) {
      gSyscall.orig_getpagesize = 0;
    }
    else
      if (memcmp(pVfs->xGetSystemCall_signature, xGetSystemCall_signatures[xGetSystemCall_apndGetSystemCall_enum], sizeof(pVfs->xGetSystemCall_signature)) == 0) {
        gSyscall.orig_getpagesize = apndGetSystemCall(pVfs, "getpagesize");
      }
    else
      if (memcmp(pVfs->xGetSystemCall_signature, xGetSystemCall_signatures[xGetSystemCall_unixGetSystemCall_enum], sizeof(pVfs->xGetSystemCall_signature)) == 0) {
        gSyscall.orig_getpagesize = unixGetSystemCall(pVfs, "getpagesize");
      }
    gSyscall.pgsz = pgsz;
    if (memcmp(pVfs->xSetSystemCall_signature, xSetSystemCall_signatures[xSetSystemCall_0_enum], sizeof(pVfs->xSetSystemCall_signature)) == 0) {
      0;
      ...
      if (memcmp(pVfs->xSetSystemCall_signature, xSetSystemCall_signatures[xSetSystemCall_apndSetSystemCall_enum], sizeof(pVfs->xSetSystemCall_signature)) == 0) {
        apndSetSystemCall(pVfs, "getpagesize",
                          (sqlite3_syscall_ptr)ts_getpagesize);
      }
    else
      if (memcmp(pVfs->xSetSystemCall_signature, xSetSystemCall_signatures[xSetSystemCall_devsymSleep_enum], sizeof(pVfs->xSetSystemCall_signature)) == 0) {
        devsymSleep(pVfs, "getpagesize", (sqlite3_syscall_ptr)ts_getpagesize);
      }
    else
      if (memcmp(pVfs->xSetSystemCall_signature, xSetSystemCall_signatures[xSetSystemCall_rbuVfsSleep_enum], sizeof(pVfs->xSetSystemCall_signature)) == 0) {
        rbuVfsSleep(pVfs, "getpagesize", (sqlite3_syscall_ptr)ts_getpagesize);
      }
    else
      if (memcmp(pVfs->xSetSystemCall_signature, xSetSystemCall_signatures[xSetSystemCall_tvfsSleep_enum], sizeof(pVfs->xSetSystemCall_signature)) == 0) {
        tvfsSleep(pVfs, "getpagesize", (sqlite3_syscall_ptr)ts_getpagesize);
      }
    else
      if (memcmp(pVfs->xSetSystemCall_signature, xSetSystemCall_signatures[xSetSystemCall_unixSetSystemCall_enum], sizeof(pVfs->xSetSystemCall_signature)) == 0) {
        unixSetSystemCall(pVfs, "getpagesize",
                          (sqlite3_syscall_ptr)ts_getpagesize);
      }
  }

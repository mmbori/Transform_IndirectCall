...
int fts3DisconnectMethod(sqlite3_vtab *pVtab){
  ...
  if (memcmp(p->pTokenizer->pModule->xDestroy_signature, xDestroy_signatures[xDestroy_0_enum], sizeof(p->pTokenizer->pModule->xDestroy_signature)) == 0) {
    ...
    if (memcmp(p->pTokenizer->pModule->xDestroy_signature, xDestroy_signatures[xDestroy_expertDisconnect_enum], sizeof(p->pTokenizer->pModule->xDestroy_signature)) == 0) {
      expertDisconnect(p->pTokenizer);
    }
  else
    ...
    if (memcmp(p->pTokenizer->pModule->xDestroy_signature, xDestroy_signatures[xDestroy_fts3DestroyMethod_enum], sizeof(p->pTokenizer->pModule->xDestroy_signature)) == 0) {
      fts3DestroyMethod(p->pTokenizer);
    }
  else
    if (memcmp(p->pTokenizer->pModule->xDestroy_signature, xDestroy_signatures[xDestroy_fts3auxDisconnectMethod_enum], sizeof(p->pTokenizer->pModule->xDestroy_signature)) == 0) {
      fts3auxDisconnectMethod(p->pTokenizer);
    }
  else
    ...
    if (memcmp(p->pTokenizer->pModule->xDestroy_signature, xDestroy_signatures[xDestroy_pcachetraceDestroy_enum], sizeof(p->pTokenizer->pModule->xDestroy_signature)) == 0) {
      pcachetraceDestroy(p->pTokenizer);
    }
  else
    if (memcmp(p->pTokenizer->pModule->xDestroy_signature, xDestroy_signatures[xDestroy_porterDestroy_enum], sizeof(p->pTokenizer->pModule->xDestroy_signature)) == 0) {
      porterDestroy(p->pTokenizer);
    }
  else
    ...
    if (memcmp(p->pTokenizer->pModule->xDestroy_signature, xDestroy_signatures[xDestroy_zipfileDisconnect_enum], sizeof(p->pTokenizer->pModule->xDestroy_signature)) == 0) {
      zipfileDisconnect(p->pTokenizer);
    }
    ...
    if( p ){
      ...
      if (memcmp(pTokenizer->pModule->xDestroy_signature, xDestroy_signatures[xDestroy_0_enum], sizeof(pTokenizer->pModule->xDestroy_signature)) == 0) {
        ...
        if (memcmp(pTokenizer->pModule->xDestroy_signature, xDestroy_signatures[xDestroy_fts3auxDisconnectMethod_enum], sizeof(pTokenizer->pModule->xDestroy_signature)) == 0) {
          fts3auxDisconnectMethod(pTokenizer);
        }
      else

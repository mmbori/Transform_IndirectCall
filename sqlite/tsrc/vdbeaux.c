    ...
    if( (iOp<0)
     || (pAux->iAuxOp==iOp
      ...
      if( pAux->xDeleteAux ){
        ...
        // if (memcmp(pAux->xDeleteAux_signature, xDelete_signatures[xDelete_0_enum], sizeof(pAux->xDeleteAux_signature)) == 0) {
        //   0;
        // }
        // else
        //   if (memcmp(pAux->xDelete_signature, xDelete_signatures[xDelete_apndDelete_enum], sizeof(pAux->xDelete_signature)) == 0) {
        //     apndDelete(pAux->pAux);
        //   }
        // else
        //   if (memcmp(pAux->xDeleteAux_signature, xDelete_signatures[xDelete_f5tOrigintextDelete_enum], sizeof(pAux->xDeleteAux_signature)) == 0) {
        //     f5tOrigintextDelete(pAux->pAux);
        //   }
        // else
        //   if (memcmp(pAux->xDeleteAux_signature, xDelete_signatures[xDelete_f5tTokenizerDelete_enum], sizeof(pAux->xDeleteAux_signature)) == 0) {
        //     f5tTokenizerDelete(pAux->pAux);
        //   }
        // else
        //   if (memcmp(pAux->xDelete_signature, xDelete_signatures[xDelete_kvstorageDelete_enum], sizeof(pAux->xDeleteAux_signature)) == 0) {
        //     kvstorageDelete(pAux->pAux);
        //   }
        // else
        //   if (memcmp(pAux->xDelete_signature, xDelete_signatures[xDelete_vfstraceDelete_enum], sizeof(pAux->xDeleteAux_signature)) == 0) {
        //     vfstraceDelete(pAux->pAux);
        //   }
        // else
        //   if (memcmp(pAux->xDelete_signature, xDelete_signatures[xDelete_unixDelete_enum], sizeof(pAux->xDeleteAux_signature)) == 0) {
        //     unixDelete(pAux->pAux);
        //   }
      }
      *pp = pAux->pNextAux;

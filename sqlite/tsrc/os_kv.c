...
static sqlite3_int64 kvvfsReadFileSize(KVVfsFile *pFile){
  char zData[50];
  zData[0] = 0;
  if (memcmp(sqlite3KvvfsMethods.xRead_signature, xRead_signatures[xRead_apndRead_enum], sizeof(sqlite3KvvfsMethods.xRead_signature)) == 0) {
    apndRead(pFile->zClass, "sz", zData, sizeof(zData) - 1);
  }
  else
...
static int kvvfsWriteFileSize(KVVfsFile *pFile, sqlite3_int64 sz){
  ...
  if (memcmp(sqlite3KvvfsMethods.xWrite_signature, xWrite_signatures[xWrite_apndWrite_enum], sizeof(sqlite3KvvfsMethods.xWrite_signature)) == 0) {
    return apndWrite(pFile->zClass, "sz", zData);
  }
  else
...
int kvvfsReadDb(
  ...
  if (memcmp(sqlite3KvvfsMethods.xRead_signature, xRead_signatures[xRead_apndRead_enum], sizeof(sqlite3KvvfsMethods.xRead_signature)) == 0) {
    got = apndRead(pFile->zClass, zKey, aData, SQLITE_KVOS_SZ - 1);
  }
  else
    if (memcmp(sqlite3KvvfsMethods.xRead_signature, xRead_signatures[xRead_memdbRead_enum], sizeof(sqlite3KvvfsMethods.xRead_signature)) == 0) {
...
int kvvfsTruncateJrnl(sqlite3_file *pProtoFile, sqlite_int64 size){
  ...
  if (memcmp(sqlite3KvvfsMethods.xDelete_signature, xDelete_signatures[xDelete_0_enum], sizeof(sqlite3KvvfsMethods.xDelete_signature)) == 0) {
    ...
    if (memcmp(sqlite3KvvfsMethods.xDelete_signature, xDelete_signatures[xDelete_apndDelete_enum], sizeof(sqlite3KvvfsMethods.xDelete_signature)) == 0) {
      apndDelete(pFile->zClass, "jrnl");
    }
  else
...
int kvvfsSyncJrnl(sqlite3_file *pProtoFile, int flags){
  ...
  if (memcmp(sqlite3KvvfsMethods.xWrite_signature, xWrite_signatures[xWrite_apndWrite_enum], sizeof(sqlite3KvvfsMethods.xWrite_signature)) == 0) {
    i = apndWrite(pFile->zClass, "jrnl", zOut);
  }
  else
    if (memcmp(sqlite3KvvfsMethods.xWrite_signature, xWrite_signatures[xWrite_kvstorageWrite_enum], sizeof(sqlite3KvvfsMethods.xWrite_signature)) == 0) {

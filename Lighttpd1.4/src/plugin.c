...
handler_t mod_simple_vhost_docroot(request_st * const r, void *p_data);

// plugins_call_handle_request_done
extern handler_t mod_status_account(request_st *r, void *p_d);
extern handler_t log_access_write(request_st *r, void *p_d);

// plugins_call_fn_srv_data_all
handler_t mod_auth_periodic(server *srv, void *p_d);
handler_t cgi_trigger_cb(server *srv, void *p_d);
handler_t mod_status_trigger(server *srv, void *p_d);
handler_t log_access_periodic_flush(server *srv, void *p_d);

// plugins_call_handle_connection_accept
handler_t mod_extforward_handle_con_accept(connection *con, void *p_d);

// plugins_call_handle_connection_close
handler_t mod_extforward_handle_con_close(connection *con, void *p_d);

// plugins_call_handle_request_env
handler_t mod_extforward_handle_request_env(request_st *r, void *p_d);
handler_t mod_setenv_handle_request_env(request_st *r, void *p_d);

// plugins_call_handle_request_reset
handler_t mod_dirlisting_reset(request_st *r, void *p_d);
handler_t mod_deflate_cleanup(request_st * const r, void *p_d);
handler_t cgi_connection_close_callback(request_st * const r, void *p_d);
handler_t mod_setenv_handle_request_reset(request_st *r, void *p_d);
handler_t mod_extforward_restore(request_st *r, void *p_d);

// plugins_call_handle_response_start
handler_t mod_setenv_handle_response_start(request_st *r, void *p_d);
handler_t mod_expire_handler(request_st *r, void *p_d);
handler_t mod_deflate_handle_response_start(request_st *r, void *p_d);

// //plugins_call_handle_uri_clean
handler_t mod_extforward_uri_handler(request_st *r, void *p_d);
handler_t mod_auth_uri_handler(request_st * const r, void *p_d);
handler_t mod_setenv_uri_handler(request_st *r, void *p_d);
handler_t mod_access_uri_handler(request_st *r, void *p_d);
handler_t mod_status_handler(request_st * const r, void *p_d);

//plugins_call_handle_subrequest_start
handler_t mod_indexfile_subrequest(request_st *r, void *p_d);
handler_t cgi_is_handled(request_st *r, void *p_d);
handler_t mod_dirlisting_subrequest_start(request_st *r, void *p_d);
handler_t mod_staticfile_subrequest(request_st *r, void *p_d);

// plugins_call_cleanup
void mod_extforward_free(void *p_d);
void mod_auth_free(void *p_d);
void mod_expire_free(void *p_d);
void mod_simple_vhost_free(void *p_d);
void mod_cgi_free(void *p_d);
void mod_deflate_free(void *p_d);
void mod_accesslog_free(void *p_d);
void mod_dirlisting_free(void *p_d);

// plugins_call_set_defaults
handler_t mod_indexfile_set_defaults(server *srv, void *p_d);
handler_t mod_extforward_set_defaults(server *srv, void *p_d);
handler_t mod_auth_set_defaults(server *srv, void *p_d);
handler_t mod_authn_file_set_defaults(server *srv, void *p_d);
handler_t mod_setenv_set_defaults(server *srv, void *p_d);
handler_t mod_access_set_defaults(server *srv, void *p_d);
handler_t mod_expire_set_defaults(server *srv, void *p_d);
handler_t mod_simple_vhost_set_defaults(server *srv, void *p_d);
handler_t mod_cgi_set_defaults(server *srv, void *p_d);
handler_t mod_status_set_defaults(server *srv, void *p_d);
handler_t mod_deflate_set_defaults(server *srv, void *p_d);
handler_t mod_accesslog_set_defaults(server *srv, void *p_d);
handler_t mod_dirlisting_set_defaults(server *srv, void *p_d);
handler_t mod_staticfile_set_defaults(server *srv, void *p_d);

// plugins_call_handle_waitpid
handler_t cgi_waitpid_cb(server *srv, void *p_d, pid_t pid, int status);

// plugins_call_init
void *mod_indexfile_init(void);
void *mod_extforward_init(void);
void *mod_auth_init(void);
void *mod_authn_file_init(void);
void *mod_setenv_init(void);
void *mod_access_init(void);
void *mod_expire_init(void);
void *mod_simple_vhost_init(void);
void *mod_cgi_init(void);
void *mod_status_init(void);
void *mod_deflate_init(void);
void *mod_accesslog_init(void);
void *mod_dirlisting_init(void);
void *mod_staticfile_init(void);
...
static handler_t plugins_call_fn_srv_data(server * const srv, const int e) {
    ...
    //     ++plfd;
	// transfer start
	if (plfd->fn && (rc = mod_indexfile_set_defaults(srv,plfd->data)) == HANDLER_GO_ON) {
		++plfd;
	} else {
		return rc;
	}
	if (plfd->fn && (rc = mod_extforward_set_defaults(srv,plfd->data)) == HANDLER_GO_ON) {
		++plfd;
	} else {
		return rc;
	}
	if (plfd->fn && (rc = mod_auth_set_defaults(srv,plfd->data)) == HANDLER_GO_ON) {
		++plfd;
	} else {
		return rc;
	}
	if (plfd->fn && (rc = mod_authn_file_set_defaults(srv,plfd->data)) == HANDLER_GO_ON) {
		++plfd;
	} else {
		return rc;
	}
	if (plfd->fn && (rc = mod_setenv_set_defaults(srv,plfd->data)) == HANDLER_GO_ON) {
		++plfd;
	} else {
		return rc;
	}
	if (plfd->fn && (rc = mod_access_set_defaults(srv,plfd->data)) == HANDLER_GO_ON) {
		++plfd;
	} else {
		return rc;
	}
	if (plfd->fn && (rc = mod_expire_set_defaults(srv,plfd->data)) == HANDLER_GO_ON) {
		++plfd;
	} else {
		return rc;
	}
	if (plfd->fn && (rc = mod_simple_vhost_set_defaults(srv,plfd->data)) == HANDLER_GO_ON) {
		++plfd;
	} else {
		return rc;
	}
	if (plfd->fn && (rc = mod_cgi_set_defaults(srv,plfd->data)) == HANDLER_GO_ON) {
		++plfd;
	} else {
		return rc;
	}
	if (plfd->fn && (rc = mod_status_set_defaults(srv,plfd->data)) == HANDLER_GO_ON) {
		++plfd;
	} else {
		return rc;
	}
	if (plfd->fn && (rc = mod_deflate_set_defaults(srv,plfd->data)) == HANDLER_GO_ON) {
		++plfd;
	} else {
		return rc;
	}
	if (plfd->fn && (rc = mod_accesslog_set_defaults(srv,plfd->data)) == HANDLER_GO_ON) {
		++plfd;
	} else {
		return rc;
	}
	if (plfd->fn && (rc = mod_dirlisting_set_defaults(srv,plfd->data)) == HANDLER_GO_ON) {
		++plfd;
	} else {
		return rc;
	}
	if (plfd->fn && (rc = mod_staticfile_set_defaults(srv,plfd->data)) == HANDLER_GO_ON) {
		++plfd;
	} else {
		return rc;
	}
...
static void plugins_call_fn_srv_data_all(server * const srv, const int e) {
	...
	// transfer start
	if (plfd->fn) {
		mod_auth_periodic(srv, plfd->data);
	}
	++plfd;
	if (plfd->fn) {
		cgi_trigger_cb(srv, plfd->data);
	}
	++plfd;
	if (plfd->fn) {
		mod_status_trigger(srv, plfd->data);
	}
	++plfd;
	if (plfd->fn) {
		log_access_periodic_flush(srv, plfd->data);
	}
	++plfd;
	// transfer end
}
...
handler_t plugins_call_handle_uri_clean(request_st * const r) {
	const int e = PLUGIN_FUNC_HANDLE_URI_CLEAN;
	const void * const plugin_slots = r->con->plugin_slots;
    const uint32_t offset = ((const uint16_t *)plugin_slots)[e];
    if (0 == offset) return HANDLER_GO_ON;
    const plugin_fn_req_data *plfd = (const plugin_fn_req_data *)
	...
	// 	++plfd;
	// transfer start
	if (plfd->fn && (rc = mod_extforward_uri_handler(r, plfd->data)) == HANDLER_GO_ON) {
		++plfd;
	} else {
		return rc;
	}
	if (plfd->fn && (rc = mod_auth_uri_handler(r, plfd->data)) == HANDLER_GO_ON) {
		++plfd;
	} else {
		return rc;
	}
	if (plfd->fn && (rc = mod_setenv_uri_handler(r, plfd->data)) == HANDLER_GO_ON) {
		++plfd;
	} else {
		return rc;
	}
	if (plfd->fn && (rc = mod_access_uri_handler(r, plfd->data)) == HANDLER_GO_ON) {
		++plfd;
	} else {
		return rc;
	}
	if (plfd->fn && (rc = mod_status_handler(r, plfd->data)) == HANDLER_GO_ON) {
		++plfd;
	} else {
		return rc;
	}
...
handler_t plugins_call_handle_docroot(request_st * const r) {
	const int e = PLUGIN_FUNC_HANDLE_DOCROOT;
	const void * const plugin_slots = r->con->plugin_slots;
	const unsigned int offset = ((const unsigned short *)plugin_slots)[e];
	if (0 == offset)
		return HANDLER_GO_ON;
	const plugin_fn_req_data *plfd = (const plugin_fn_req_data *)(((unsigned long)plugin_slots) + offset);
	handler_t rc = HANDLER_GO_ON;
	// while (plfd->fn && (rc = plfd->fn(r, plfd->data)) == HANDLER_GO_ON)
	// 	++plfd;
	// transfer start
	if (plfd->fn && (rc = mod_simple_vhost_docroot(r, plfd->data)) == HANDLER_GO_ON) {
		++plfd;
	}
	// transfer end
	return rc;
...
handler_t plugins_call_handle_subrequest_start(request_st * const r) {
	const int e = PLUGIN_FUNC_HANDLE_SUBREQUEST_START;
	const void * const plugin_slots = r->con->plugin_slots;
	const unsigned int offset = ((const unsigned short *)plugin_slots)[e];
	if (0 == offset)
		return HANDLER_GO_ON;
	...
	// 	++plfd;
	// transfer start
	if (plfd->fn && (rc = mod_indexfile_subrequest(r, plfd->data)) == HANDLER_GO_ON) {
		++plfd;
	}
	if (plfd->fn && (rc = mod_access_uri_handler(r, plfd->data)) == HANDLER_GO_ON) {
		++plfd;
	}
	if (plfd->fn && (rc = cgi_is_handled(r, plfd->data)) == HANDLER_GO_ON) {
		++plfd;
	}
	if (plfd->fn && (rc = mod_dirlisting_subrequest_start(r, plfd->data)) == HANDLER_GO_ON) {
		++plfd;
	}
	if (plfd->fn && (rc = mod_staticfile_subrequest(r, plfd->data)) == HANDLER_GO_ON) {
		++plfd;
	}
	// transfer end
	return rc;
...
handler_t plugins_call_handle_response_start(request_st * const r) {
	const int e = PLUGIN_FUNC_HANDLE_RESPONSE_START;
	const void * const plugin_slots = r->con->plugin_slots;
	const unsigned int offset = ((const unsigned short *)plugin_slots)[e];
	if (0 == offset)
		return HANDLER_GO_ON;
	...
	// 	++plfd;
	// transfer start
	if (plfd->fn && (rc = mod_setenv_handle_response_start(r, plfd->data)) == HANDLER_GO_ON) {
		++plfd;
	}
	if (plfd->fn && (rc = mod_expire_handler(r, plfd->data)) == HANDLER_GO_ON) {
		++plfd;
	}
	if (plfd->fn && (rc = mod_deflate_handle_response_start(r, plfd->data)) == HANDLER_GO_ON) {
		++plfd;
	}
	// transfer end
	return rc;
...
handler_t plugins_call_handle_request_done(request_st * const r) {
	const int e = PLUGIN_FUNC_HANDLE_REQUEST_DONE;
	const void * const plugin_slots = r->con->plugin_slots;
	const unsigned int offset = ((const unsigned short *)plugin_slots)[e];
	if (0 == offset)
		return HANDLER_GO_ON;
	...
	// 	++plfd;
	// transfer start
	if (plfd->fn && (rc = mod_status_account(r, plfd->data)) == HANDLER_GO_ON) {
		++plfd;
	}
	if (plfd->fn && (rc = log_access_write(r, plfd->data)) == HANDLER_GO_ON) {
		++plfd;
	}
	// transfer end
	return rc;
...
handler_t plugins_call_handle_request_reset(request_st * const r) {
	const int e = PLUGIN_FUNC_HANDLE_REQUEST_RESET;
	const void * const plugin_slots = r->con->plugin_slots;
	const unsigned int offset = ((const unsigned short *)plugin_slots)[e];
	if (0 == offset)
		return HANDLER_GO_ON;
	...
	// 	++plfd;
	// transfer start
	if (plfd->fn && (rc = mod_dirlisting_reset(r, plfd->data)) == HANDLER_GO_ON) {
		++plfd;
	}
	if (plfd->fn && (rc = mod_deflate_cleanup(r, plfd->data)) == HANDLER_GO_ON) {
		++plfd;
	}
	if (plfd->fn && (rc = cgi_connection_close_callback(r, plfd->data)) == HANDLER_GO_ON) {
		++plfd;
	}
	if (plfd->fn && (rc = mod_setenv_handle_request_reset(r, plfd->data)) == HANDLER_GO_ON) {
		++plfd;
	}
	if (plfd->fn && (rc = mod_extforward_restore(r, plfd->data)) == HANDLER_GO_ON) {
		++plfd;
	}
	// transfer end
	return rc;
...
handler_t plugins_call_handle_request_env(request_st * const r) {
	const int e = PLUGIN_FUNC_HANDLE_REQUEST_ENV;
	const void * const plugin_slots = r->con->plugin_slots;
	const unsigned int offset = ((const unsigned short *)plugin_slots)[e];
	if (0 == offset)
		return HANDLER_GO_ON;
	...
	// 	++plfd;
	// transfer start
	if (plfd->fn && (rc = mod_extforward_handle_request_env(r, plfd->data)) == HANDLER_GO_ON) {
		++plfd;
	}
	if (plfd->fn && (rc = mod_setenv_handle_request_env(r, plfd->data)) == HANDLER_GO_ON) {
		++plfd;
	}
	// transfer end
	return rc;
...
handler_t plugins_call_handle_connection_accept(connection *con) {
	const int e = PLUGIN_FUNC_HANDLE_CONNECTION_ACCEPT;
	const void * const plugin_slots = con->plugin_slots;
	const unsigned int offset = ((const unsigned short *)plugin_slots)[e];
	if (0 == offset)
		return HANDLER_GO_ON;
	const plugin_fn_con_data *plfd = (const plugin_fn_con_data *)(((unsigned long)plugin_slots) + offset);
	handler_t rc = HANDLER_GO_ON;
	// while (plfd->fn && (rc = plfd->fn(con, plfd->data)) == HANDLER_GO_ON)
	// 	++plfd;
	// transfer start
	if (plfd->fn && (rc = mod_extforward_handle_con_accept(con, plfd->data)) == HANDLER_GO_ON) {
		++plfd;
	}
	// transfer end
	return rc;
...
handler_t plugins_call_handle_connection_close(connection *con) {
	const int e = PLUGIN_FUNC_HANDLE_CONNECTION_CLOSE;
	const void * const plugin_slots = con->plugin_slots;
	const unsigned int offset = ((const unsigned short *)plugin_slots)[e];
	if (0 == offset)
		return HANDLER_GO_ON;
	...
	// 	++plfd;
	// transfer start
	if (plfd->fn && (rc = mod_extforward_handle_con_close(con, plfd->data)) == HANDLER_GO_ON) {
		++plfd;
	}
	// transfer end
	return rc;
...
handler_t plugins_call_handle_waitpid(server *srv, pid_t pid, int status) {
    ...
    //     ++plfd;
	// transfer start
	if (plfd->fn&&(rc=cgi_waitpid_cb(srv,plfd->data,pid,status))==HANDLER_GO_ON) {
		++plfd;
	}
	// transfer end
    return rc;
...
handler_t plugins_call_init(server *srv) {
	...
	if (i < srv->plugins.used) {
		...
		if (p->init) {
			if (NULL == (p->data = mod_indexfile_init())) {
				log_error(srv->errh, __FILE__, __LINE__,
				  "plugin-init failed for mod_%s", p->name);
				return HANDLER_ERROR;
			}
	...
	if (i < srv->plugins.used) {
		...
		if (p->init) {
			if (NULL == (p->data = mod_extforward_init())) {
				log_error(srv->errh, __FILE__, __LINE__,
				  "plugin-init failed for mod_%s", p->name);
				return HANDLER_ERROR;
			}
	...
	if (i < srv->plugins.used) {
		...
		if (p->init) {
			if (NULL == (p->data = mod_authn_file_init())) {
				log_error(srv->errh, __FILE__, __LINE__,
				  "plugin-init failed for mod_%s", p->name);
				return HANDLER_ERROR;
			}
	...
	if (i < srv->plugins.used) {
		...
		if (p->init) {
			if (NULL == (p->data = mod_setenv_init())) {
				log_error(srv->errh, __FILE__, __LINE__,
				  "plugin-init failed for mod_%s", p->name);
				return HANDLER_ERROR;
			}
	...
	if (i < srv->plugins.used) {
		...
		if (p->init) {
			if (NULL == (p->data = mod_access_init())) {
				log_error(srv->errh, __FILE__, __LINE__,
				  "plugin-init failed for mod_%s", p->name);
				return HANDLER_ERROR;
			}
	...
	if (i < srv->plugins.used) {
		...
		if (p->init) {
			if (NULL == (p->data = mod_expire_init())) {
				log_error(srv->errh, __FILE__, __LINE__,
				  "plugin-init failed for mod_%s", p->name);
				return HANDLER_ERROR;
			}
	...
	if (i < srv->plugins.used) {
		...
		if (p->init) {
			if (NULL == (p->data = mod_simple_vhost_init())) {
				log_error(srv->errh, __FILE__, __LINE__,
				  "plugin-init failed for mod_%s", p->name);
				return HANDLER_ERROR;
			}
	...
	if (i < srv->plugins.used) {
		...
		if (p->init) {
			if (NULL == (p->data = mod_status_init())) {
				log_error(srv->errh, __FILE__, __LINE__,
				  "plugin-init failed for mod_%s", p->name);
				return HANDLER_ERROR;
			}
	...
	if (i < srv->plugins.used) {
		...
		if (p->init) {
			if (NULL == (p->data = mod_deflate_init())) {
				log_error(srv->errh, __FILE__, __LINE__,
				  "plugin-init failed for mod_%s", p->name);
				return HANDLER_ERROR;
			}
	...
	if (i < srv->plugins.used) {
		...
		if (p->init) {
			if (NULL == (p->data = mod_accesslog_init())) {
				log_error(srv->errh, __FILE__, __LINE__,
				  "plugin-init failed for mod_%s", p->name);
				return HANDLER_ERROR;
			}
	...
	if (i < srv->plugins.used) {
		...
		if (p->init) {
			if (NULL == (p->data = mod_dirlisting_init())) {
				log_error(srv->errh, __FILE__, __LINE__,
				  "plugin-init failed for mod_%s", p->name);
				return HANDLER_ERROR;
			}
	...
	if (i < srv->plugins.used) {
		...
		if (p->init) {
			if (NULL == (p->data = mod_staticfile_init())) {
				log_error(srv->errh, __FILE__, __LINE__,
				  "plugin-init failed for mod_%s", p->name);
				return HANDLER_ERROR;
			}

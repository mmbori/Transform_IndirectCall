...
int sqlite3_quota_initialize(const char *zOrigVfsName, int makeDefault){
  ...
  memcpy(gQuota.sIoMethodsV1.xRead_signature,
         xRead_signatures[xRead_quotaRead_enum],
         sizeof(gQuota.sIoMethodsV1.xRead_signature));
  memcpy(gQuota.sIoMethodsV1.xWrite_signature,
         xWrite_signatures[xWrite_quotaWrite_enum],
         sizeof(gQuota.sIoMethodsV1.xWrite_signature));

...
int sqlite3_multiplex_initialize(const char *zOrigVfsName, int makeDefault){
  ...
  memcpy(gMultiplex.sIoMethodsV1.xRead_signature,
         xRead_signatures[xRead_multiplexRead_enum],
         sizeof(gMultiplex.sIoMethodsV1.xRead_signature));
  memcpy(gMultiplex.sIoMethodsV1.xWrite_signature,
         xWrite_signatures[xWrite_multiplexWrite_enum],
         sizeof(gMultiplex.sIoMethodsV1.xWrite_signature));

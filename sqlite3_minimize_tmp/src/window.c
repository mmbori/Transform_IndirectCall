...
static void selectWindowRewriteEList(
  ...
  memcpy(sWalker.xExprCallback_signature,
         xExprCallback_signatures[xExprCallback_selectWindowRewriteExprCb_enum],
         sizeof(sWalker.xExprCallback_signature));
  memcpy(sWalker.xSelectCallback_signature,
         xSelectCallback_signatures[xSelectCallback_selectWindowRewriteSelectCb_enum],
   ...
   && ALWAYS(!IN_RENAME_OBJECT)
    ...
    if( (p->selFlags & SF_Aggregate)==0 ){
      memcpy(w.xExprCallback_signature,
             xExprCallback_signatures[xExprCallback_disallowAggregatesInOrderByCb_enum],
    ...
    if( p->pSrc==0 ){
      ...
      if( pTab2==0 ){
        ...
        ** the correct error message regardless. */
        ...
        memset(&w, 0, sizeof(w));
        memcpy(w.xExprCallback_signature,
               xExprCallback_signatures[xExprCallback_sqlite3WindowExtraAggFuncDepth_enum],
               sizeof(w.xExprCallback_signature));
